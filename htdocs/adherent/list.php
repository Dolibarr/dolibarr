...
$diroutputmassaction = $conf->adherent->dir_output.'/temp/massgeneration/'.$user->id;
...
$newcardbutton .= dolGetButtonTitle($langs->trans('NewMember'), '', 'fa fa-plus-circle', DOL_URL_ROOT.'/adherent/card.php?action=create', '', $user->hasRight('adherent', 'creer'));
