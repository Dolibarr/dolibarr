...
/**
 *	    \file       htdocs/adherent/stats/index.php
 *      \ingroup    member
...
require_once DOL_DOCUMENT_ROOT.'/adherent/class/adherentstats.class.php';
...
foreach ($data as $val) {
	...
	print '<tr class="oddeven" height="24">';
	print '<td class="center">';
	print '<a href="'.DOL_URL_ROOT.'/adherent/subscription/list.php?date_select='.((int) $year).'">'.$year.'</a>';
	print '</td>';
