...
/**
 *      \file       htdocs/adherent/subscription/info.php
 *      \ingroup    member
...
$linkback = '<a href="'.DOL_URL_ROOT.'/adherent/subscription/list.php?restore_lastsearch_values=1">'.$langs->trans("BackToList").'</a>';
