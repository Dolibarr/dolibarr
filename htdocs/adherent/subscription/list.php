...
/**
 *      \file       htdocs/adherent/subscription/list.php
 *      \ingroup    member
...
if ($num == 1 && getDolGlobalString('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".DOL_URL_ROOT.'/adherent/subscription/card.php?id='.$id);
	exit;
}
...
if ($user->hasRight('adherent', 'cotisation', 'creer')) {
	...
	$newcardbutton .= dolGetButtonTitle($langs->trans('NewSubscription'), '', 'fa fa-plus-circle', DOL_URL_ROOT.'/adherent/list.php?status=-1,1');
}
