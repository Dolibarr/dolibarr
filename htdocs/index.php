...
if (empty($user->societe_id))
{
    ...
    if (empty($reshook))
    {
	    ...
	    ! empty($conf->employee->enabled) && $user->rights->employee->lire && empty($conf->global->SOCIETE_DISABLE_EMPLOYEES_STATS),
      ! empty($conf->adherent->enabled) && $user->rights->adherent->lire,
	    ...
	    DOL_DOCUMENT_ROOT."/employees/class/employee.class.php",
      ...
      DOL_URL_ROOT.'/employees/liste.php?statut=1&mainmenu=employees',
