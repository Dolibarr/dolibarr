...
if (empty($user->societe_id))
{
    ...
    if (empty($reshook))
    {
	    ...
	    $links=array(
    	    ...
    	    DOL_URL_ROOT.'/contrat/list.php?mainmenu=commercial',
    	    DOL_URL_ROOT.'/fichinter/list.php?mainmenu=commercial',
    	    DOL_URL_ROOT.'/fourn/commande/list.php?mainmenu=commercial',
	        DOL_URL_ROOT.'/fourn/facture/list.php?mainmenu=accountancy',
	        DOL_URL_ROOT.'/supplier_proposal/list.php?mainmenu=commercial',
