 ...
 */
class modEnlaceKeme extends DolibarrModules
{
    /**
    ...
    function __construct($db)
    {
        ...
        $this->description = "Enlace contable con Keme-Contabilidad";
        ...
        $this->config_page_url = array("admin.php@enlacekeme");
        ...
        */
        ...
        $this->menu = array(
            array(
                ...
                'type' => 'left',
                'titre' => 'Enlace contable',
                'url' => '/enlacekeme/wizard.php',
                'enabled' => '$conf->enlacekeme->enabled',
                'perms' => '$user->rights->enlacekeme->export',
                'user' => 0
            )
    ...
    function init($options='')
    {
        ...
        $result=$this->_load_tables('/enlacekeme/sql/');
