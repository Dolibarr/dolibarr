...
/**
 * \file 		htdocs/accounting/customer/lines.php
 * \ingroup 	Accounting
...
if (is_array($changeaccount) && count($changeaccount) > 0) {
	...
	if (! $error)
	{
		...
		dol_syslog('accounting/customer/lines.php::changeaccount sql= ' . $sql1);
...
dol_syslog("/accounting/customer/lines.php", LOG_DEBUG);
$result = $db->query($sql);
if ($result) {
