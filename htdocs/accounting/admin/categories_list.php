...
/**
 *	    \file       htdocs/accounting/admin/categories_list.php
 *		\ingroup    setup
        ...
        if ($num)
        {
            ...
            while ($i < $num)
            {
                ...
                else
                {
                    ...
                    {
                        print '<a href="'.DOL_URL_ROOT.'/accounting/admin/categories.php?action=display&save_lastsearch_values=1&account_category='.$obj->rowid.'">';
