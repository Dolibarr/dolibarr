...
/**
 * \file 		htdocs/accounting/expensereport/list.php
 * \ingroup 	Accounting
    ...
    if (! empty($mesCasesCochees)) {
        ...
        foreach ($mesCasesCochees as $maLigneCochee) {
            ...
            else
            {
                ...
                dol_syslog('accounting/expensereport/list.php:: sql=' . $sql, LOG_DEBUG);
                if ($db->query($sql)) {
...
dol_syslog('accounting/expensereport/list.php');
$result = $db->query($sql);
if ($result) {
