...
/**
 * \file		htdocs/accounting/journal/purchasesjournal.php
 * \ingroup		Accounting
...
dol_syslog('accounting/journal/purchasesjournal.php', LOG_DEBUG);
$result = $db->query($sql);
if ($result) {
	$tabfac = array ();
	$tabht = array ();
...
if ($action == 'exportcsv') {		// ISO and not UTF8 !
	...
	$filename = 'journal';
	$type_export = 'journal';
	include DOL_DOCUMENT_ROOT . '/accounting/tpl/export_journal.tpl.php';
