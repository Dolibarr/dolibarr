...
/**
 * \file 		htdocs/accounting/bookkeeping/listbyaccount.php
 * \ingroup 	Accounting
...
require_once DOL_DOCUMENT_ROOT . '/accounting/class/bookkeeping.class.php';
...
$viewflat = ' <a class="nohover marginrightonly" href="'.DOL_URL_ROOT.'/accounting/bookkeeping/list.php?'.$param.'">' . $langs->trans("ViewFlatList") . '</a>';
...
while ($i < min($num, $limit))
{
	...
	print '<a href="'.DOL_URL_ROOT.'/accounting/bookkeeping/card.php?piece_num=' . $line->piece_num . '">' . img_edit() . '</a>&nbsp;';
