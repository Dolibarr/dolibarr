...
{  
  ...
  if (substr($result,0,2) == "OK")
    {
      if ($verbose)
	dolibarr_syslog("Resiliation réussie ligne ".$ligne_num." id client ".$id_person." $result\n");
    ...
    {
      dolibarr_syslog("Resiliation échouée ligne ".$ligne_num." id client ".$id_person." $result\n");
