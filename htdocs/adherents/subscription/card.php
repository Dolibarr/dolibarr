...
if ($user->rights->adherent->cotisation->creer && $action == 'update' && empty($cancel))
{
	// Charge objet actuel
...
if ($action == 'confirm_delete' && $_REQUEST["confirm"] == 'yes' && $user->rights->adherent->cotisation->creer)
{
