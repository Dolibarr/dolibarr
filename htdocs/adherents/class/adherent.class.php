...
class Adherent extends CommonObject
{
	...
	function update($user,$notrigger=0,$nosyncuser=0,$nosyncuserpass=0,$nosyncthirdparty=0,$action='update')
	{
		...
		if ($this->datefin)   $sql.= ", datefin='".$this->db->idate($this->datefin)."'";		// Ne doit etre modifie que par effacement subscription
	 ...
	 *	@param	int		$need_subscription		1 si type adherent avec subscription, 0 sinon
