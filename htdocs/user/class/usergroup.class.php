...
class UserGroup extends CommonObject
{
     ...
     */
    public function fetch($id='', $groupname='')
    {
        global $conf;
     ...
     */
    public function listUsersForGroup($excludefilter='')
    {
        global $conf, $user;
     ...
     */
    public function addrights($rid,$allmodule='',$allperms='')
    {
        global $conf;
     ...
     */
    public function delrights($rid,$allmodule='',$allperms='')
    {
        global $conf;
