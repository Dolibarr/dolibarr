...
class User extends CommonObject
{
     ...
     */
    public function fetch($id='', $login='',$sid='',$loadpersonalconf=1)
    {
        global $conf, $user;
     ...
     */
    public function addrights($rid, $allmodule='', $allperms='', $entity='')
    {
        global $conf;
     ...
     */
    public function delrights($rid, $allmodule='', $allperms='', $entity='')
    {
        global $conf;
     ...
     */
    public function update($user,$notrigger=0,$nosyncmember=0,$nosyncmemberpass=0)
    {
     ...
     */
    public function getNbOfUsers($limitTo='active', $all=false)
    {
        global $conf;
     ...
     */
    public function get_full_tree($markafterid=0)
    {
        $this->users = array();
     ...
     *	@return		void
     */
    public function build_path_from_id_user($id_user,$protection=1000)
    {
