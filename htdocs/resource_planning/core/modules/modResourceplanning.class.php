 ...
 */
class modResourcePlanning extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->rights_class = 'resource_planning';
		...
		$this->langfiles = array("resource_planning@resource_planning"); // langfiles@resource
		// Constants
		...
		$this->rights[$r][0] = 1101121;
		$this->rights[$r][1] = 'See planning';
		$this->rights[$r][3] = 0;
		...
		$this->menu[$r]=array(
			...
			'mainmenu'=>'tools',
			'leftmenu'=> '',
			'url'=> '/resource_planning/resource_planning.php',
			'langs'=> 'resource_planning@resource_planning',
			'position'=> 101,
			'enabled'=> '1',
			'perms'=> '$user->rights->resource_planning->read',
			'user'=> 0
		);
		$r++;
