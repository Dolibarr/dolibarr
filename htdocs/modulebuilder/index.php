					...
					try {
						...
						if (!empty($tmpobject)) {
							...
							if (!empty($properties)) {
								...
								print '<tr><td><span class="warning">'.$langs->trans('Property %s not found in the class. The class was probably not generated by modulebuilder.', $propertykey).'</warning></td></tr>';
							}
							print '</table>';
							print '</div>';
