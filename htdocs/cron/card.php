...
if (($action == "create") || ($action == "edit")) {
	...
	print $langs->trans('CronDtStart')."</td><td>";
	if (!empty($object->datestart)) {
		print dol_print_date($object->datestart, 'dayhoursec');
	}
	print "</td></tr>";
	...
	print $langs->trans('CronDtEnd')."</td><td>";
	if (!empty($object->dateend)) {
		print dol_print_date($object->dateend, 'dayhoursec');
	}
	print "</td></tr>";
	...
	if (!$object->status) {
		...
		print img_picto('', 'object_calendarday').' '.dol_print_date($object->datenextrun, 'dayhoursec');
	} else {
	...
	if (!empty($object->datelastrun)) {
		print dol_print_date($object->datelastrun, 'dayhoursec');
	} else {
		print $langs->trans('CronNone');
	}
	print "</td></tr>";
	...
	if (!empty($object->datelastresult)) {
		print dol_print_date($object->datelastresult, 'dayhoursec');
	} else {
		print $langs->trans('CronNone');
	}
	print "</td></tr>";
