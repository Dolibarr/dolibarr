 ...
 */
class Cron extends DolibarrApi
{
	/**
	 ...
	 * @param	int<-1,2>	$status		Filter on status (-1=no filter, 0=disabled, 1=enabled, 2=archived)
	 ...
	 *
	 * @param	int		$id				Cron job ID
	 * @param	string	$securitykey	Security key, mandatory only if the CRON_KEY global constant is set
	 *
	 * @url	POST	{id}/run
	 *
	 * @return	Object
