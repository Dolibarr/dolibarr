...
class Cronjob extends CommonObject
{
    ...
    public $ref; //Use for prevnext_ref
    public $jobtype;
    public $tms='';
    public $datec='';
    public $label;
     ...
     *  @return int          			<0 if KO, >0 if OK
     */
    public function fetch_all($sortorder='DESC', $sortfield='t.rowid', $limit=0, $offset=0, $status=1, $filter='')
    {
        global $langs;
        $sql = "SELECT";
        $sql.= " t.rowid,";
     ...
     *
     */
    public function reprogram_jobs($userlogin)
    {
        global $langs, $conf;
