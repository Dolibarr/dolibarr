...
if (count($object->lines) > 0) {
    ...
    foreach($object->lines as $line) {
        ...
        print '<td>';
        if (!empty($line->datestart)) {
            print dol_print_date($line->datestart,'dayhour');
        } else {
            print $langs->trans('CronNone');
        }
        print '</td>';
        ...
        print '<td>';
        if (!empty($line->dateend)) {
            print dol_print_date($line->dateend,'dayhour');
        } else {
            print $langs->trans('CronNone');
        }
        print '</td>';
        ...
        print '<td>';
        if (!empty($line->datelastrun)) {
            print dol_print_date($line->datelastrun,'dayhour');
        } else {
            print $langs->trans('CronNone');
        }
        print '</td>';
        ...
        print '<td>';
        if (!empty($line->datenextrun)) {
            print dol_print_date($line->datenextrun,'dayhour');
        } else {
            print $langs->trans('CronNone');
        }
        print '</td>';
