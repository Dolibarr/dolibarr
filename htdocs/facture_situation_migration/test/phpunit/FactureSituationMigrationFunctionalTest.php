...
/**
 * \file    test/phpunit/FactureSituationMigrationFunctionalTest.php
...
/**
 * Class FactureSituationMigrationFunctionalTest
 *
 ...
 *
 * @package Testfacturesituationmigration
 */
class FactureSituationMigrationFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modFactureSituationMigration')->click();
		} else {
			// Disable the module
			$this->byHref('modFactureSituationMigration')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/facturesituationmigration/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('facturesituationmigration/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/facturesituationmigration/admin/about.php');
		$this->authenticate();
		return $this->assertContains('facturesituationmigration/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('facturesituationmigrationwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modFactureSituationMigration_FactureSituationMigrationTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modFactureSituationMigration_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
