...
foreach ($search as $key => $val) {
	...
	$mode_search = ((array_key_exists($key, $object->fields) && $object->isInt($object->fields[$key]) || $object->isFloat($object->fields[$key])) ? 1 : 0);
	if ($search[$key] != '') {
...
if (array_key_exists($object->table_element, $extrafields->attributes) && array_key_exists('computed', $extrafields->attributes[$object->table_element]) && is_array($extrafields->attributes[$object->table_element]['computed']) && count($extrafields->attributes[$object->table_element]['computed']) > 0) {
