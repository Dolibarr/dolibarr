...
if ($_GET["propalid"] > 0)
{
    ...
    */
    ...
    $sql.= ' x.firstname, x.name, x.fax, x.phone, x.email, p.fk_user_author, p.fk_user_valid, p.fk_user_cloture, p.datec, p.date_valid, p.date_cloture, fk_cond_reglement, fk_mode_reglement';
