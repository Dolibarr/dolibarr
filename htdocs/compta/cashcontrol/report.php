...
if ($resql) {
	...
	if (!$summaryonly && $object->status == $object::STATUS_VALIDATED && price($cheque) != price($object->cheque)) {
	...
	if (!$summaryonly && $object->status == $object::STATUS_VALIDATED && price($bank) != price($object->card)) {
