...
if ($action == 'builddoc' && $permissiontoread) {
	...
	if ($rap->write_file($dir, GETPOSTINT("remonth"), GETPOSTINT("reyear"), $outputlangs, GETPOSTINT("reday")) > 0) {
