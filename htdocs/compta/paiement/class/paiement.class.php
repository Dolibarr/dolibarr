...
class Paiement extends CommonObject
{
	...
	public function create($user, $closepaidinvoices = 0, $thirdparty = null)
	{
		...
		$sql .= " VALUES (".$invoice->entity.", '".$this->db->escape($this->ref)."', '".$this->db->escape($this->ref_ext)."', '".$this->db->idate($now)."', '".$this->db->idate($this->datepaye)."', ".$total.", ".$mtotal.", ".$this->paiementid.", ";
