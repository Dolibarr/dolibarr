...
class Facture extends CommonInvoice
{
    ...
    public $modelpdf;
    public $products=array();	// deprecated
    public $lines=array();
    public $line;
     ...
     */
    public function create($user,$notrigger=0,$forceduedate=0)
    {
     ...
     *	@return		int						<0 if KO, >0 if OK
     */
    public function createFromCurrent($user,$invertdetail=0)
    {
     ...
     */
    public function createFromOrder($object)
    {
     ...
     * @return int    <0 if KO, >0 if OK
     */
    public function validate($user, $force_number='', $idwarehouse=0)
    {
        global $conf,$langs;
        require_once DOL_DOCUMENT_ROOT.'/core/lib/files.lib.php';
        ...
        if ($force_number) {
            $num = $force_number;
        } elseif (preg_match('/^[\(]?PROV/i', $this->ref)) {
     ...
     */
    public function addline($facid, $desc, $pu_ht, $qty, $txtva, $txlocaltax1=0, $txlocaltax2=0, $fk_product=0, $remise_percent=0, $date_start='', $date_end='', $ventil=0, $info_bits=0, $fk_remise_except='', $price_base_type='HT', $pu_ttc=0, $type=0, $rang=-1, $special_code=0, $origin='', $origin_id=0, $fk_parent_line=0, $fk_fournprice=null, $pa_ht=0, $label='',$array_option=0)
    {
     ...
     *  @return    	int             				< 0 if KO, > 0 if OK
     */
    public function updateline($rowid, $desc, $pu, $qty, $remise_percent, $date_start, $date_end, $txtva, $txlocaltax1=0, $txlocaltax2=0, $price_base_type='HT', $info_bits=0, $type=0, $fk_parent_line=0, $skip_update_total=0, $fk_fournprice=null, $pa_ht=0, $label='', $special_code=0, $array_option=0)
    {
        include_once DOL_DOCUMENT_ROOT.'/core/lib/price.lib.php';
    ...
    public function is_erasable()
    {
        ...
        } elseif ($this->statut == 0 && $facref == 'PROV') { // Si facture brouillon et provisoire
     ...
     *	@return     int         		<0 if KO, >0 if OK
     */
    public function demande_prelevement($user)
    {
     ...
     *  @return	int					<0 if OK, >0 if KO
     */
    public function demande_prelevement_delete($user, $did)
    {
