...
if ($action == 'create')
{
	...
	if ($action == 'canceled') {
		...
		if ($objectidnext && $statusreplacement == 0) {
			...
			$formconfirm = $form->formconfirm($_SERVER['PHP_SELF'].'?facid='.$object->id, $langs->trans('CancelBill'), $langs->trans('ConfirmCancelBill', $object->ref), 'confirm_canceled', $formquestion, "no", 1, 250);
		}
	}
