...
$arrayfields = array(
	...
	'total_pa' => array('label' => ((isset($conf->global->MARGIN_TYPE) && getDolGlobalString('MARGIN_TYPE') == '1') ? 'BuyingPrice' : 'CostPrice'), 'checked' => 0, 'position' => 300, 'enabled' => (!isModEnabled('margin') || empty($user->rights->margins->liretous) ? 0 : 1)),
