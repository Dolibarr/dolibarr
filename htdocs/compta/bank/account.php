		...
		while ($i < $num)
		{
			...
			if ($i >= ($viewline * (($totalPages-$page)-1)))
			{
				...
				if ($objp->fk_type == 'CHQ' && $objp->fk_bordereau > 0) {
					...
					$label .= ' '.$bordereaustatic->getNameUrl(2);
				}
				print $label;
				print "</td>\n";
				...
				foreach($links as $key=>$val)
				{
					if ($links[$key]['type']=='payment')
					{
						...
						print ' '.$paymentstatic->getNameUrl(2);
					}
					elseif ($links[$key]['type']=='payment_supplier')
					{
						$paymentsupplierstatic->id=$links[$key]['url_id'];
						$paymentsupplierstatic->ref=$links[$key]['url_id'];
						print ' '.$paymentsupplierstatic->getNameUrl(2);
					}
					...
					elseif ($links[$key]['type']=='payment_vat')
					{
						...
						print ' '.$paymentvatstatic->getNameUrl(2);
					}
					elseif ($links[$key]['type']=='payment_salary')
					{
						$paymentsalstatic->id=$links[$key]['url_id'];
						$paymentsalstatic->ref=$links[$key]['url_id'];
						print ' '.$paymentsalstatic->getNameUrl(2);
					}
				...
				foreach($links as $key=>$val)
				{
					if ($links[$key]['type']=='company')
					{
						...
						print $societestatic->getNameUrl(1,'',16);
					}
					...
					else if ($links[$key]['type']=='sc')
					{
						...
						print $chargestatic->getNameUrl(1,16);
					}
					else if ($links[$key]['type']=='member')
					{
						$memberstatic->id=$links[$key]['url_id'];
						$memberstatic->ref=$links[$key]['label'];
						print $memberstatic->getNameUrl(1,16,'card');
					}
				}
				print '</td>';
