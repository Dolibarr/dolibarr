...
$search_datep_start = dol_mktime(0, 0, 0, GETPOSTSESSIONINT('search_date_startmonth'), GETPOSTSESSIONINT('search_date_startday'), GETPOSTSESSIONINT('search_date_startyear'));
$search_datep_end = dol_mktime(23, 59, 59, GETPOSTSESSIONINT('search_date_endmonth'), GETPOSTSESSIONINT('search_date_endday'), GETPOSTSESSIONINT('search_date_endyear'));
