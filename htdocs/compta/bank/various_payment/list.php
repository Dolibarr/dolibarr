...
$search_datep_start = dol_mktime(0, 0, 0, SESSIONGETPOSTINT('search_date_startmonth'), SESSIONGETPOSTINT('search_date_startday'), SESSIONGETPOSTINT('search_date_startyear'));
$search_datep_end = dol_mktime(23, 59, 59, SESSIONGETPOSTINT('search_date_endmonth'), SESSIONGETPOSTINT('search_date_endday'), SESSIONGETPOSTINT('search_date_endyear'));
