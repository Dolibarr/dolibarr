...
$search_accountancy_account = GETPOST("search_accountancy_account", 'alpha');
if ($search_accountancy_account == - 1) $search_accountancy_account = '';
$search_accountancy_subledger = GETPOST("search_accountancy_subledger", 'alpha');
...
if ($result)
{
	...
	print '<td class="liste_total nowrap right">'.price($totalarray['totaldeb'])."</td>";
	print '<td class="liste_total nowrap right">'.price($totalarray['totalcred'])."</td>";
	print '<td></td>';
	print '</tr>';
