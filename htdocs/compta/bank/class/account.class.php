...
// InfraS add end
	...
	public function create($user, $notrigger = 0)
	{
		...
		$sql .= ", domiciliation";
		$sql .= ", pti_in_ctti";
		$sql .= ", ctgypurp"; // InfraS add
		$sql .= ", lclinstrm"; // InfraS add
		$sql .= ", proprio";
		$sql .= ", owner_address";
		$sql .= ", owner_zip";
		$sql .= ", owner_town";
		...
		$sql .= ", '".$this->db->escape($this->ctgypurp)."'";// InfraS add
		$sql .= ", '".$this->db->escape($this->lclinstrm)."'";// InfraS add
	...
	public function update($user, $notrigger = 0)
	{
		...
		$sql .= ",ctgypurp='".$this->db->escape($this->ctgypurp)."'"; // InfraS add
		$sql .= ",lclinstrm='".$this->db->escape($this->lclinstrm)."'"; // InfraS add
	...
	public function fetch($id, $ref = '')
	{
		...
		$sql .= " ba.domiciliation as address, ba.pti_in_ctti, ba.ctgypurp, ba.lclinstrm, ba.proprio as owner_name, ba.owner_address, ba.owner_zip, ba.owner_town, ba.owner_country_id, ba.state_id, ba.fk_pays as country_id,";	// InfraS change
		...
		if ($result) {
			if ($this->db->num_rows($result)) {
				...
				$this->ctgypurp   	 = $obj->ctgypurp; // InfraS add
				$this->lclinstrm   	 = $obj->lclinstrm; // InfraS add
