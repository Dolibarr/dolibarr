...
class BonPrelevement extends CommonObject
{
     ...
     */
    public function Create($banque=0, $agence=0, $mode='real')
    {
        global $conf,$langs;
     ...
     *	@return	void
     */
    public function EnregDestinataire($rowid, $client_nom, $rib_banque, $rib_guichet, $rib_number, $amount, $facnumber, $facid)
    {
        fputs($this->file, "06");
