	...
	if ($result)
	{
		...
		if ($num)
		{
			while ($i < $num)
			{
				...
				print "<td>".$langs->trans("Donation")." <a href=\"".DOL_URL_ROOT."/donations/list.php?search_company=".$obj->name."&search_name=".$obj->firstname." ".$obj->lastname."\">".$obj->name. " ".$obj->firstname." ".$obj->lastname."</a></td>\n";
