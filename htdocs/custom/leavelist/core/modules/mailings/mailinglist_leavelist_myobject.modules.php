...
dol_include_once("/leavelist/class/myobject.class.php");


/**
 * mailing_mailinglist_leavelist
 */
class mailing_mailinglist_leavelist_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_leavelist_myobject';
