...
/**
 * \file    maillinkgenerator/css/maillinkgenerator.css.php
 * \ingroup maillinkgenerator
 * \brief   CSS file for module MailLinkGenerator.
 */
...
div.mainmenu.maillinkgenerator::before {
	content: "\f249";
}
div.mainmenu.maillinkgenerator {
...
#addresses::-webkit-scrollbar-corner {
	display: none;
}
...
#mailExpButtons a.butAction {
	background-image: none;
	background-color: var(--butactionbg);
}

#addresses, #addresses:focus {
	width: 95%;
	height: 90%;
	border: none;
}
