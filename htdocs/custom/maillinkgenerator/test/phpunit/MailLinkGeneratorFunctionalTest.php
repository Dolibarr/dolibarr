...
/**
 * \file    test/phpunit/MailLinkGeneratorFunctionalTest.php
...
/**
 * Class MailLinkGeneratorFunctionalTest
 *
 ...
 *
 * @package Testmaillinkgenerator
 */
class MailLinkGeneratorFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modMailLinkGenerator')->click();
		} else {
			// Disable the module
			$this->byHref('modMailLinkGenerator')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/maillinkgenerator/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('maillinkgenerator/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/maillinkgenerator/admin/about.php');
		$this->authenticate();
		return $this->assertContains('maillinkgenerator/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('maillinkgeneratorwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMailLinkGenerator_MailLinkGeneratorTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMailLinkGenerator_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
