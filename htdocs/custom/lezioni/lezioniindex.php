...
/**
 *	\file       lezioni/lezioniindex.php
 *	\ingroup    lezioni
 *	\brief      Home page of lezioni top menu
 */
...
//restrictedArea($user, 'lezioni', 0, 'lezioni_myobject', 'myobject', '', 'rowid');
//if (empty($user->admin)) {
...
//header
print '<tr class="liste_titre">';
//<th class="wrapcolumntitle liste_titre" title="Rif."><a class="reposition" href="/business/custom/lezioni/lezione_list.php?sortfield=t.ref&amp;sortorder=asc&amp;begin=&amp;contextpage=lezionilezionelist">Rif.</a></th>
print '<th class="wrapcolumntitle liste_titre" title="Mese">Mese</a></th>';
print '<th class="wrapcolumntitle liste_titre" title="Istruttore">Istruttore</a></th>';
...
if (isModEnabled('lezioni') && $user->hasRight('lezioni', 'read')) {
	...
	$sql.= " FROM ".MAIN_DB_PREFIX."lezioni_myobject as s";
