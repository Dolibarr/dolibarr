...
/**
 *       \file       htdocs/lezioni/ajax/pagamentiesterni.php
 *       \brief      File to return Ajax response on pagamentiesterni list request
 */
...
// Security check
if (!$user->hasRight('lezioni', 'pagamentiesterni', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax lezioni/ajax/pagamentiesterni.php");
