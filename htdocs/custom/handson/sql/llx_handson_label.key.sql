...
--ALTER TABLE llx_handson_label ADD UNIQUE INDEX uk_handson_label_fieldxy(fieldx, fieldy);

--ALTER TABLE llx_handson_label ADD CONSTRAINT llx_handson_label_fk_field FOREIGN KEY (fk_field) REFERENCES llx_handson_myotherobject(rowid);
