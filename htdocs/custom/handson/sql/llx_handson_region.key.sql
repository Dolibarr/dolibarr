...
--ALTER TABLE llx_handson_region ADD UNIQUE INDEX uk_handson_region_fieldxy(fieldx, fieldy);

--ALTER TABLE llx_handson_region ADD CONSTRAINT llx_handson_region_fk_field FOREIGN KEY (fk_field) REFERENCES llx_handson_myotherobject(rowid);
