...
/**
 * \file    test/phpunit/HandsOnFunctionalTest.php
 * \ingroup handson
 ...
 * @package Testhandson
 */
class HandsOnFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/handson/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('handson/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/handson/admin/about.php');
		$this->authenticate();
		return $this->assertContains('handson/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('handsonwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modHandsOn_HandsOnTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modHandsOn_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
