...
/**
 * \file    handson/core/boxes/handsonwidget1.php
 * \ingroup handson
 * \brief   Widget provided by HandsOn
 *
 ...
 */
class handsonwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "handsonbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "handson@handson";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->handson->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/handson/class/handson.class.php");

		// Populate the head at runtime
		$text = $langs->trans("HandsOnBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_handson@handson',
