...
/**
 *	    \file       htdocs/custom/handson/liste_rp.php
 *      \ingroup    societe
 *		\brief      Page to list all contacts that are RPs
 */
...
if($search_array_options['search_options_funktion'] == null) $search_array_options['search_options_funktion'] = '5';
...
$title = ($langs->trans("ListOfVolunteers"));
