...
/**
 * \file    test/phpunit/DiensteFunctionalTest.php
 * \ingroup dienste
 ...
 * @package Testdienste
 */
class DiensteFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/dienste/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('dienste/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/dienste/admin/about.php');
		$this->authenticate();
		return $this->assertContains('dienste/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('meinebuerodienste', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDienste_DiensteTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDienste_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
