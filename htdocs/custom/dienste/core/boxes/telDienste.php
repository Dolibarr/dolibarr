 ...
 */
class telDienste extends ModeleBoxes
{
	...
	public $boxcode = "telDienste";
	public $boxlabel = 'telDienste';
	...
	public function loadBox($max = 5)
	{
		...
		$sql = "select d.ref, d.user, d.description, u.rowid from " . MAIN_DB_PREFIX . "dienste_telefon as d ";
		$sql .= "join " . MAIN_DB_PREFIX . "user as u on d.user=u.rowid ";
		$sql .= "order by d.ref asc";

		$res = $db->query($sql);

		$textHead = $langs->trans("Kommende Telefondienste");
