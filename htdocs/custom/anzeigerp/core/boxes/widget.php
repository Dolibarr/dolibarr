 ...
 */
class anzeige_rp extends ModeleBoxes
{

	public $boxcode = "anzeige_rp";
	public $boximg = "object_order";
	public $boxlabel = "AnzeigeRP";
	public $depends = array("anzeigerp");
	...
	public function __construct($db, $param)
	{
		...
		//$this->hidden = !($user->rights->anzeigerp->commande->lire);
	}
