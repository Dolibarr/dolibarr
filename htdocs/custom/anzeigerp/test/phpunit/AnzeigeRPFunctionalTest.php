...
/**
 * \file    test/phpunit/AnzeigeRPFunctionalTest.php
 * \ingroup anzeigerp
 ...
 *
 * @package Testanzeigerp
 */
class AnzeigeRPFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modAnzeigeRP')->click();
		} else {
			// Disable the module
			$this->byHref('modAnzeigeRP')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/anzeigerp/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('anzeigerp/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/anzeigerp/admin/about.php');
		$this->authenticate();
		return $this->assertContains('anzeigerp/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('anzeigerpwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modAnzeigeRP_AnzeigeRPTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modAnzeigeRP_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
