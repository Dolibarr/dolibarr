...
/**
 * \file    test/phpunit/VehicleRequestFunctionalTest.php
...
/**
 * Class VehicleRequestFunctionalTest
 *
 ...
 *
 * @package Testvehiclerequest
 */
class VehicleRequestFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modVehicleRequest')->click();
		} else {
			// Disable the module
			$this->byHref('modVehicleRequest')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/vehiclerequest/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('vehiclerequest/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/vehiclerequest/admin/about.php');
		$this->authenticate();
		return $this->assertContains('vehiclerequest/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('vehiclerequestwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modVehicleRequest_VehicleRequestTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modVehicleRequest_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
