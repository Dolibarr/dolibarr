...
/**
 * \file    vehiclerequest/core/boxes/vehiclerequestwidget1.php
 * \ingroup vehiclerequest
 * \brief   Widget provided by VehicleRequest
 *
 ...
 */
class vehiclerequestwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "vehiclerequestbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "vehiclerequest@vehiclerequest";
	 ...
	 */
	public $depends = array('vehiclerequest');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// Translations
		$langs->loadLangs(array("boxes", "vehiclerequest@vehiclerequest"));
		...
		//$this->hidden = ! ($user->rights->vehiclerequest->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		$text = $langs->trans("VehicleRequestBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_vehiclerequest@vehiclerequest',
