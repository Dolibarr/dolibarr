...
/**
 * \file    test/phpunit/DoppelungenEntdeckenFunctionalTest.php
 * \ingroup doppelungenentdecken
...
/**
 * Class DoppelungenEntdeckenFunctionalTest
 *
 ...
 *
 * @package Testdoppelungenentdecken
 */
class DoppelungenEntdeckenFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modDoppelungenEntdecken')->click();
		} else {
			// Disable the module
			$this->byHref('modDoppelungenEntdecken')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/doppelungenentdecken/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('doppelungenentdecken/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/doppelungenentdecken/admin/about.php');
		$this->authenticate();
		return $this->assertContains('doppelungenentdecken/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('doppelungenentdeckenwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDoppelungenEntdecken_DoppelungenEntdeckenTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDoppelungenEntdecken_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
