...
if ($action != 'edit') {
	...
	echo '<td class="linecoldatestart">' . $form->selectDate(strtotime(date('Y-m-01', time())), 'start', 0, 0, 0, '', 1, 0) . '</td>';
	echo '<td class="linecoldateend">' . $form->selectDate(strtotime(date('Y-m-t', time())), 'end', 0, 0, 0, '', 1, 0) . '</td>';
