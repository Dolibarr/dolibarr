...
if ($action == 'update') {
	...
	if (GETPOSTISSET('MAIN_PDF_DISPLAY_DATETEXT')) dolibarr_set_const($db, "MAIN_PDF_DISPLAY_DATETEXT", GETPOST('MAIN_PDF_DISPLAY_DATETEXT', 'alpha'), 'chaine', 0, '', $conf->entity);
