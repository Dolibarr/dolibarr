...
/**
 *	\file       htdocs/admin/invoice_emails.php
 *	\ingroup    commande
 *	\brief      Setup page of module Invoice
 */
...
$langs->loadLangs(array("admin","invoices"));
...
llxHeader("", $langs->trans("InvoicesSetup"));

$linkback='<a href="'.DOL_URL_ROOT.'/admin/modules.php?restore_lastsearch_values=1">'.$langs->trans("BackToModuleList").'</a>';
print load_fiche_titre($langs->trans("InvoicesSetup"), $linkback, 'title_setup');


$head = invoice_admin_prepare_head();

dol_fiche_head($head, 'emails', $langs->trans("Invoices"), -1, 'invoice');
