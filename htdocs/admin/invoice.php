...
if ($action == 'setdiscountrate')
{
	$discountrate = GETPOST('discountrate','alpha');

	$res = dolibarr_set_const($db, "INVOICE_SHOW_DISCOUNT_RATE",$discountrate,'chaine',0,'',$conf->entity);
...
if ($action == 'setrecoverycost')
{
	$recoverycost = GETPOST('recoverycost','alpha');

	$res = dolibarr_set_const($db, "INVOICE_SHOW_RECOVERY_COSTS",$recoverycost,'chaine',0,'',$conf->entity);
...
if ($action == 'setpenaltyrate')
{
	$penaltyrate = GETPOST('penaltyrate','alpha');

	$res = dolibarr_set_const($db, "INVOICE_SHOW_PENALTY_RATE",$penaltyrate,'chaine',0,'',$conf->entity);
...
// Discount rate
if ($mysoc->country_code == 'FR') // Only for France
{
	print '<form action="'.$_SERVER["PHP_SELF"].'" method="POST">';
	print '<input type="hidden" name="token" value="'.$_SESSION['newtoken'].'" />';
	print '<input type="hidden" name="action" value="setdiscountrate" />';
	print '<tr class="oddeven"><td>';
	print $langs->trans("DiscountRate");
	print '<br><i>'.$langs->trans("DiscountRateMentionByDefault").'</i>';
	print '</td><td width="60" align="center">';
	print $form->selectyesno("penaltyrate",$conf->global->INVOICE_SHOW_DISCOUNT_RATE,1);
	print '</td><td align="right">';
	print '<input type="submit" class="button" value="'.$langs->trans("Modify").'" />';
	print "</td></tr>\n";
	print '</form>';
...
if ($mysoc->country_code == 'FR') // Only for France
{
	print '<form action="'.$_SERVER["PHP_SELF"].'" method="POST">';
	print '<input type="hidden" name="token" value="'.$_SESSION['newtoken'].'" />';
	print '<input type="hidden" name="action" value="setpenaltyrate" />';
	print '<tr class="oddeven"><td>';
	print $langs->trans("PenaltyRate");
	print '<br><i>'.$langs->trans("PenaltyRateMentionByDefault").'</i>';
	print '</td><td width="60" align="center">';
	print $form->selectyesno("penaltyrate",$conf->global->INVOICE_SHOW_PENALTY_RATE,1);
	print '</td><td align="right">';
	print '<input type="submit" class="button" value="'.$langs->trans("Modify").'" />';
	print "</td></tr>\n";
	print '</form>';
...
if ($mysoc->country_code == 'FR') // Only for France
{
	print '<form action="'.$_SERVER["PHP_SELF"].'" method="POST">';
	print '<input type="hidden" name="token" value="'.$_SESSION['newtoken'].'" />';
	print '<input type="hidden" name="action" value="setrecoverycost" />';
	print '<tr class="oddeven"><td>';
	print $langs->trans("RecoveryCosts");
	print '<br><i>'.$langs->trans("RecoveryCostsMentionByDefault").'</i>';
	print '</td><td width="60" align="center">';
	print $form->selectyesno("recoverycost",$conf->global->INVOICE_SHOW_RECOVERY_COSTS,1);
	print '</td><td align="right">';
	print '<input type="submit" class="button" value="'.$langs->trans("Modify").'" />';
	print "</td></tr>\n";
	print '</form>';
