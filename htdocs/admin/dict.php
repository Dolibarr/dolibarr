...
$tabname[26]= MAIN_DB_PREFIX."c_employment_contract";
...
$tablib[26]= "DictionaryEmploymentContract";
...
$tabsql[26]= "SELECT e.rowid as rowid, e.code as code, e.label, fk_pays as country_id, p.code as country_code, p.libelle as country, e.active FROM ".MAIN_DB_PREFIX."c_employment_contract AS e, ".MAIN_DB_PREFIX."c_pays as p WHERE e.fk_pays=p.rowid and p.active=1";
...
$tabsqlsort[26]="country ASC, code ASC";
...
$tabfield[26]= "code,label,country_id,country";
...
$tabfieldvalue[26]= "code,label,country";
...
$tabfieldinsert[26]= "code,label,fk_pays";
...
$tabcond[25]= true;
$tabcond[26]= (! empty($conf->global->EMPLOYEE_CONTRACTDICTTOEDIT) && ! empty($conf->employee->enabled));  // Function in developement. You can set EMPLOYEE_CONTRACTDICTTOEDIT to 1 if you want to use dictionary editor.
