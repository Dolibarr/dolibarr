...
if ($action == 'update' && !$cancel) {
	...
	if (!$error) {
		...
		dolibarr_set_const($db, 'MAIN_MAIL_WITH_TO_SELECTED_CONTACT_BILLING', GETPOST('MAIN_MAIL_WITH_TO_SELECTED_CONTACT_BILLING', 'int'), 'chaine', 0, '', $conf->entity);
...
if ($action == 'edit') {
	...
	print '</td></tr>';
	print '<tr class="oddeven"><td>'.$langs->trans("MAIN_MAIL_WITH_TO_SELECTED_CONTACT_BILLING").'</td><td>';
	print $form->selectyesno('MAIN_MAIL_WITH_TO_SELECTED_CONTACT_BILLING', getDolGlobalString('MAIN_MAIL_WITH_TO_SELECTED_CONTACT_BILLING'), 1);
	print '</td></tr>';
	print '</table>';
	...
	if (empty($conf->global->MAIN_DISABLE_ALL_MAILS)) {
		...
		print '<tr class="oddeven"><td>'.$langs->trans("MAIN_MAIL_WITH_TO_SELECTED_CONTACT_BILLING").'</td><td>'.yn(!empty($conf->global->MAIN_MAIL_WITH_TO_SELECTED_CONTACT_BILLING)).'</td></tr>';
