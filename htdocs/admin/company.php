...
if ($action == 'edit' || $action == 'updateedit')
{
	...
	// Name
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td class="fieldrequired"><label for="name">'.$langs->trans("CompanyName").'</label></td><td>';
	...
	// Addresse
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td><label for="address">'.$langs->trans("CompanyAddress").'</label></td><td>';
	...
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td><label for="zipcode">'.$langs->trans("CompanyZip").'</label></td><td>';
	...
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td><label for="town">'.$langs->trans("CompanyTown").'</label></td><td>';
	...
	// Country
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td class="fieldrequired"><label for="selectcountry_id">'.$langs->trans("Country").'</label></td><td class="maxwidthonsmartphone">';
	...
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td><label for="state_id">'.$langs->trans("State").'</label></td><td class="maxwidthonsmartphone">';
	$formcompany->select_departement($conf->global->MAIN_INFO_SOCIETE_STATE,$mysoc->country_code,'state_id');
	print '</td></tr>'."\n";

	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td><label for="currency">'.$langs->trans("CompanyCurrency").'</label></td><td>';
	print $form->selectCurrency($conf->currency,"currency");
	print '</td></tr>'."\n";

	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td><label for="phone">'.$langs->trans("Phone").'</label></td><td>';
	print '<input name="tel" id="phone" value="'. $conf->global->MAIN_INFO_SOCIETE_TEL . '"></td></tr>';
	print '</td></tr>'."\n";

	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td><label for="fax">'.$langs->trans("Fax").'</label></td><td>';
	print '<input name="fax" id="fax" value="'. $conf->global->MAIN_INFO_SOCIETE_FAX . '"></td></tr>';
	print '</td></tr>'."\n";

	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td><label for="email">'.$langs->trans("EMail").'</label></td><td>';
	print '<input name="mail" id="email" size="60" value="'. $conf->global->MAIN_INFO_SOCIETE_MAIL . '"></td></tr>';
	print '</td></tr>'."\n";

	// Web
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td><label for="web">'.$langs->trans("Web").'</label></td><td>';
	...
	if (! empty($conf->barcode->enabled)) {
		$var=!$var;
		print '<tr '.$bc[$var?1:0].'><td><label for="barcode">'.$langs->trans("Gencod").'</label></td><td>';
	...
	// Note
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td valign="top"><label for="note">'.$langs->trans("Note").'</label></td><td>';
	...
	// Managing Director(s)
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td width="35%"><label for="director">'.$langs->trans("ManagingDirectors").'</label></td><td>';
	print '<input name="MAIN_INFO_SOCIETE_MANAGERS" id="director" size="80" value="' . $conf->global->MAIN_INFO_SOCIETE_MANAGERS . '"></td></tr>';

	// Capital
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td width="35%"><label for="capital">'.$langs->trans("Capital").'</label></td><td>';
	print '<input name="capital" id="capital" size="20" value="' . $conf->global->MAIN_INFO_CAPITAL . '"></td></tr>';

	// Juridical Status
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td><label for="forme_juridique_code">'.$langs->trans("JuridicalStatus").'</label></td><td>';
	...
	{
		$var=!$var;
		print '<tr '.$bc[$var?1:0].'><td width="35%"><label for="profid1">'.$langs->transcountry("ProfId1",$mysoc->country_code).'</label></td><td>';
	...
	{
		$var=!$var;
		print '<tr '.$bc[$var?1:0].'><td width="35%"><label for="profid2">'.$langs->transcountry("ProfId2",$mysoc->country_code).'</label></td><td>';
		if (! empty($mysoc->country_code))
		{
	...
	{
		$var=!$var;
		print '<tr '.$bc[$var?1:0].'><td width="35%"><label for="profid3">'.$langs->transcountry("ProfId3",$mysoc->country_code).'</label></td><td>';
		if (! empty($mysoc->country_code))
		{
	...
	{
		$var=!$var;
		print '<tr '.$bc[$var?1:0].'><td width="35%"><label for="profid4">'.$langs->transcountry("ProfId4",$mysoc->country_code).'</label></td><td>';
		if (! empty($mysoc->country_code))
		{
	...
	{
		$var=!$var;
		print '<tr '.$bc[$var?1:0].'><td width="35%"><label for="profid5">'.$langs->transcountry("ProfId5",$mysoc->country_code).'</label></td><td>';
		if (! empty($mysoc->country_code))
		{
	...
	{
		$var=!$var;
		print '<tr '.$bc[$var?1:0].'><td width="35%"><label for="profid6">'.$langs->transcountry("ProfId6",$mysoc->country_code).'</label></td><td>';
		if (! empty($mysoc->country_code))
		{
	...
	// TVA Intra
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td width="35%"><label for="intra_vat">'.$langs->trans("VATIntra").'</label></td><td>';
	print '<input name="tva" id="intra_vat" size="20" value="' . (! empty($conf->global->MAIN_INFO_TVAINTRA) ? $conf->global->MAIN_INFO_TVAINTRA : '') . '">';
	print '</td></tr>';
	
	// Object of the company
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td width="35%"><label for="object">'.$langs->trans("CompanyObject").'</label></td><td>';
	...
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td width="35%"><label for="fiscalmonthstart">'.$langs->trans("FiscalMonthStart").'</label></td><td>';
	...
	$var=!$var;
	print "<tr ".$bc[$var?1:0]."><td width=\"140\"><label><input type=\"radio\" name=\"optiontva\" id=\"use_vat\" value=\"1\"".(empty($conf->global->FACTURE_TVAOPTION)?"":" checked")."> ".$langs->trans("VATIsUsed")."</label></td>";
	print '<td colspan="2">';
	print "<table>";
	...
	$var=!$var;
	print "<tr ".$bc[$var?1:0]."><td width=\"140\"><label><input type=\"radio\" name=\"optiontva\" id=\"no_vat\" value=\"0\"".(empty($conf->global->FACTURE_TVAOPTION)?" checked":"")."> ".$langs->trans("VATIsNotUsed")."</label></td>";
	print '<td colspan="2">';
	print "<table>";
	...
	if ($mysoc->useLocalTax(1))
	{
		...
		print "<tr ".$bc[$var?1:0]."><td width=\"140\"><input type=\"radio\" name=\"optionlocaltax1\" id=\"lt1\" value=\"localtax1on\"".(($conf->global->FACTURE_LOCAL_TAX1_OPTION == '1' || $conf->global->FACTURE_LOCAL_TAX1_OPTION == "localtax1on")?" checked":"")."> ".$langs->transcountry("LocalTax1IsUsed",$mysoc->country_code)."</td>";
		print '<td colspan="2">';
		...
		$var=!$var;
		print "<tr ".$bc[$var?1:0]."><td width=\"140\"><input type=\"radio\" name=\"optionlocaltax1\" id=\"nolt1\" value=\"localtax1off\"".((empty($conf->global->FACTURE_LOCAL_TAX1_OPTION) || $conf->global->FACTURE_LOCAL_TAX1_OPTION == "localtax1off")?" checked":"")."> ".$langs->transcountry("LocalTax1IsNotUsed",$mysoc->country_code)."</td>";
		print '<td colspan="2">';
		print "<table>";
	...
	if ($mysoc->useLocalTax(2))
	{
		...
		$var=!$var;
		// Note: When option is not set, it must not appears as set on on, because there is no default value for this option
		print "<tr ".$bc[$var?1:0]."><td width=\"140\"><input type=\"radio\" name=\"optionlocaltax2\" id=\"lt2\" value=\"localtax2on\"".(($conf->global->FACTURE_LOCAL_TAX2_OPTION == '1' || $conf->global->FACTURE_LOCAL_TAX2_OPTION == "localtax2on")?" checked":"")."> ".$langs->transcountry("LocalTax2IsUsed",$mysoc->country_code)."</td>";
		print '<td colspan="2">';
		print '<table class="nobordernopadding">';
		...
		$var=!$var;
		print "<tr ".$bc[$var?1:0]."><td width=\"140\"><input type=\"radio\" name=\"optionlocaltax2\" id=\"nolt2\" value=\"localtax2off\"".((empty($conf->global->FACTURE_LOCAL_TAX2_OPTION) || $conf->global->FACTURE_LOCAL_TAX2_OPTION == "localtax2off")?" checked":"")."> ".$langs->transcountry("LocalTax2IsNotUsed",$mysoc->country_code)."</td>";
		print '<td colspan="2">';
		print "<table>";
...
else
{
	...
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td width="35%">'.$langs->trans("CompanyName").'</td><td>';
	...
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td width="35%">'.$langs->trans("CompanyAddress").'</td><td>' . nl2br(empty($conf->global->MAIN_INFO_SOCIETE_ADDRESS)?'':$conf->global->MAIN_INFO_SOCIETE_ADDRESS) . '</td></tr>';

	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td width="35%">'.$langs->trans("CompanyZip").'</td><td>' . (empty($conf->global->MAIN_INFO_SOCIETE_ZIP)?'':$conf->global->MAIN_INFO_SOCIETE_ZIP) . '</td></tr>';

	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td width="35%">'.$langs->trans("CompanyTown").'</td><td>' . (empty($conf->global->MAIN_INFO_SOCIETE_TOWN)?'':$conf->global->MAIN_INFO_SOCIETE_TOWN) . '</td></tr>';

	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td>'.$langs->trans("CompanyCountry").'</td><td>';
	if ($mysoc->country_code)
	{
	...
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td>'.$langs->trans("State").'</td><td>';
	if (! empty($conf->global->MAIN_INFO_SOCIETE_STATE)) print getState($conf->global->MAIN_INFO_SOCIETE_STATE);
	else print '&nbsp;';
	print '</td></tr>';

	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td width="35%">'.$langs->trans("CompanyCurrency").'</td><td>';
	...
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td width="35%">'.$langs->trans("Phone").'</td><td>' . dol_print_phone($conf->global->MAIN_INFO_SOCIETE_TEL,$mysoc->country_code) . '</td></tr>';

	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td width="35%">'.$langs->trans("Fax").'</td><td>' . dol_print_phone($conf->global->MAIN_INFO_SOCIETE_FAX,$mysoc->country_code) . '</td></tr>';

	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td width="35%">'.$langs->trans("Mail").'</td><td>' . dol_print_email($conf->global->MAIN_INFO_SOCIETE_MAIL,0,0,0,80) . '</td></tr>';

	// Web
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td width="35%">'.$langs->trans("Web").'</td><td>' . dol_print_url($conf->global->MAIN_INFO_SOCIETE_WEB,'_blank',80) . '</td></tr>';

	// Barcode
	if (! empty($conf->barcode->enabled))
	{
		$var=!$var;
		print '<tr '.$bc[$var?1:0].'><td width="35%">'.$langs->trans("Gencod").'</td><td>' . $conf->global->MAIN_INFO_SOCIETE_GENCOD . '</td></tr>';
	}

	// Logo
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td width="35%">'.$langs->trans("Logo").'</td><td>';
	...
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td width="35%" valign="top">'.$langs->trans("Note").'</td><td>' . (! empty($conf->global->MAIN_INFO_SOCIETE_NOTE) ? nl2br($conf->global->MAIN_INFO_SOCIETE_NOTE) : '') . '</td></tr>';
	...
	// Managing Director(s)
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td width="35%">'.$langs->trans("ManagingDirectors").'</td><td>';
	print $conf->global->MAIN_INFO_SOCIETE_MANAGERS . '</td></tr>';

	// Capital
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td width="35%">'.$langs->trans("Capital").'</td><td>';
	print $conf->global->MAIN_INFO_CAPITAL . '</td></tr>';

	// Juridical Status
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td width="35%">'.$langs->trans("JuridicalStatus").'</td><td>';
	...
	{
		$var=!$var;
		print '<tr '.$bc[$var?1:0].'><td width="35%">'.$langs->transcountry("ProfId1",$mysoc->country_code).'</td><td>';
	...
	{
		$var=!$var;
		print '<tr '.$bc[$var?1:0].'><td width="35%">'.$langs->transcountry("ProfId2",$mysoc->country_code).'</td><td>';
	...
	{
		$var=!$var;
		print '<tr '.$bc[$var?1:0].'><td width="35%">'.$langs->transcountry("ProfId3",$mysoc->country_code).'</td><td>';
	...
	{
		$var=!$var;
		print '<tr '.$bc[$var?1:0].'><td width="35%">'.$langs->transcountry("ProfId4",$mysoc->country_code).'</td><td>';
	...
	{
		$var=!$var;
		print '<tr '.$bc[$var?1:0].'><td width="35%">'.$langs->transcountry("ProfId5",$mysoc->country_code).'</td><td>';
	...
	{
		$var=!$var;
		print '<tr '.$bc[$var?1:0].'><td width="35%">'.$langs->transcountry("ProfId6",$mysoc->country_code).'</td><td>';
	...
	// VAT
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td>'.$langs->trans("VATIntra").'</td>';
	print '<td>';
	...
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td width="35%" valign="top">'.$langs->trans("CompanyObject").'</td><td>' . (! empty($conf->global->MAIN_INFO_SOCIETE_OBJECT) ? nl2br($conf->global->MAIN_INFO_SOCIETE_OBJECT) : '') . '</td></tr>';
	...
	$var=!$var;
	print '<tr '.$bc[$var?1:0].'><td width="35%">'.$langs->trans("FiscalMonthStart").'</td><td>';
	...
	$var=!$var;
	print "<tr ".$bc[$var?1:0]."><td width=\"160\"><input ".$bc[$var?1:0]." type=\"radio\" name=\"optiontva\" id=\"use_vat\" disabled value=\"1\"".(empty($conf->global->FACTURE_TVAOPTION)?"":" checked")."> ".$langs->trans("VATIsUsed")."</td>";
	print '<td colspan="2">';
	print "<table>";
	print "<tr><td><label for=\"use_vat\">".$langs->trans("VATIsUsedDesc")."</label></td></tr>";
	print "<tr><td><i>".$langs->trans("Example").': '.$langs->trans("VATIsUsedExampleFR")."</i></td></tr>\n";
	...
	$var=!$var;
	print "<tr ".$bc[$var?1:0]."><td width=\"160\"><input ".$bc[$var?1:0]." type=\"radio\" name=\"optiontva\" id=\"no_vat\" disabled value=\"0\"".(empty($conf->global->FACTURE_TVAOPTION)?" checked":"")."> ".$langs->trans("VATIsNotUsed")."</td>";
	print '<td colspan="2">';
	print "<table>";
	...
	if ($mysoc->useLocalTax(1))    // True if we found at least on vat with a setup adding a localtax 1
	{
		...
		$var=!$var;
		print "<tr ".$bc[$var?1:0]."><td width=\"160\"><input ".$bc[$var?1:0]." type=\"radio\" name=\"optionlocaltax1\" id=\"lt1\" disabled value=\"localtax1on\"".(($conf->global->FACTURE_LOCAL_TAX1_OPTION == '1' || $conf->global->FACTURE_LOCAL_TAX1_OPTION == "localtax1on")?" checked":"")."> ".$langs->transcountry("LocalTax1IsUsed",$mysoc->country_code)."</td>";
		print '<td colspan="2">';
		print "<table>";
		print "<tr><td></label for=\"lt1\">".$langs->transcountry("LocalTax1IsUsedDesc",$mysoc->country_code)."</label></td></tr>";
		$example=$langs->transcountry("LocalTax1IsUsedExample",$mysoc->country_code);
		...
		$var=!$var;
		print "<tr ".$bc[$var?1:0]."><td width=\"160\"><input ".$bc[$var?1:0]." type=\"radio\" name=\"optionlocaltax1\" id=\"nolt1\" disabled value=\"localtax1off\"".((empty($conf->global->FACTURE_LOCAL_TAX1_OPTION) || $conf->global->FACTURE_LOCAL_TAX1_OPTION == "localtax1off")?" checked":"")."> ".$langs->transcountry("LocalTax1IsNotUsed",$mysoc->country_code)."</td>";
		print '<td colspan="2">';
		print "<table>";
	...
	if ($mysoc->useLocalTax(2))    // True if we found at least on vat with a setup adding a localtax 1
	{
		...
		$var=!$var;
		print "<tr ".$bc[$var?1:0]."><td width=\"160\"><input ".$bc[$var?1:0]." type=\"radio\" name=\"optionlocaltax2\" id=\"lt2\" disabled value=\"localtax2on\"".(($conf->global->FACTURE_LOCAL_TAX2_OPTION == '1' || $conf->global->FACTURE_LOCAL_TAX2_OPTION == "localtax2on")?" checked":"")."> ".$langs->transcountry("LocalTax2IsUsed",$mysoc->country_code)."</td>";
		print '<td colspan="2">';
		print "<table>";
		print "<tr><td><label for=\"lt2\">".$langs->transcountry("LocalTax2IsUsedDesc",$mysoc->country_code)."</label></td></tr>";
		$example=$langs->transcountry("LocalTax2IsUsedExample",$mysoc->country_code);
		...
		$var=!$var;
		print "<tr ".$bc[$var?1:0]."><td width=\"160\"><input ".$bc[$var?1:0]." type=\"radio\" name=\"optionlocaltax2\" id=\"nolt2\" disabled value=\"localtax2off\"".((empty($conf->global->FACTURE_LOCAL_TAX2_OPTION) || $conf->global->FACTURE_LOCAL_TAX2_OPTION == "localtax2off")?" checked":"")."> ".$langs->transcountry("LocalTax2IsNotUsed",$mysoc->country_code)."</td>";
		print '<td colspan="2">';
		print "<table>";
		print "<tr><td><label for=\"nolt2\">".$langs->transcountry("LocalTax2IsNotUsedDesc",$mysoc->country_code)."</label></td></tr>";
		$example=$langs->transcountry("LocalTax2IsNotUsedExample",$mysoc->country_code);
