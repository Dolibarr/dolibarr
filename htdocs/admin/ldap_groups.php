...
// DN pour les groupes
$var=!$var;
print '<tr '.$bc[$var?1:0].'><td width="25%"><span class="fieldrequired">'.$langs->trans("LDAPGroupDn").'</span></td><td>';
...
$var=!$var;
print '<tr '.$bc[$var?1:0].'><td width="25%"><span class="fieldrequired">'.$langs->trans("LDAPGroupObjectClassList").'</span></td><td>';
...
// User group
$var=!$var;
print '<tr '.$bc[$var?1:0].'><td>'.$langs->trans("LDAPFieldGroupMembers").'</td><td>';
