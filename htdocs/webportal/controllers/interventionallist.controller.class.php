...
/**
 * \file        htdocs/webportal/controllers/interventionallist.controller.class.php
 * \ingroup     webportal
...
/**
 * Class for InterventionalListController
 */
class InterventionalListController extends AbstractListController
{
	/**
	...
	public function action()
	{
		...
		$context->title = $langs->trans('WebPortalInterventionalListTitle');
		$context->desc = $langs->trans('WebPortalInterventionalListDesc');
		$context->menu_active[] = 'interventional_list';

		// set form list
		$this->formList = new FormListWebPortal($this->db);
		$this->formList->init($this, 'interventional');
