...
/**
 * \file        htdocs/webportal/class/webportalinterventional.class.php
 * \ingroup     webportal
 * \brief       This file is a CRUD class file for WebPortalInterventional (Create/Read/Update/Delete)
 */
...
/**
 * Class for WebPortalInterventional
 */
class WebPortalInterventional extends Fichinter
{
	/**
	...
	const ARRAY_STATUS_LABEL = array(
		Fichinter::STATUS_DRAFT => 'InterventionalShortStatusDraft',
		Fichinter::STATUS_VALIDATED => 'InterventionalShortStatusValidated',
		Fichinter::STATUS_BILLED => 'InterventionalShortStatusBilled',
		Fichinter::STATUS_CLOSED => 'InterventionalShortStatusClosed',
	);

	/**
	 * @var Fichinter Interventional for static methods
	 */
	protected $fichinter_static = null;
	...
	public $fields = array(
		...
		'datec' => array('type' => 'datetime', 'label' => 'DateCreation', 'enabled' => 1, 'visible' => 2, 'position' => 50),
		'duree' => array('type' => 'duration', 'label' => 'Duree', 'enabled' => 1, 'visible' => 2, 'position' => 100),
		'signed_status' => array('type' => 'smallint(6)', 'label' => 'SignedStatus', 'enabled' => 1, 'notnull' => 1, 'visible' => 2, 'position' => 101, 'arrayofkeyval' => array(0 => 'NoSignature', 1 => 'SignedSender', 2 => 'SignedReceiver', 3 => 'SignedReceiverOnline', 9 => 'SignedAll')),
	 ...
	 * @return	Fichinter
	 */
	protected function getFichinterStatic()
	{
		if (!$this->fichinter_static) {
			$this->fichinter_static = new Fichinter($this->db);
		}

		return $this->fichinter_static;
	}
	...
	public function getNomUrl($withpicto = 0, $option = '', $max = 0, $short = 0, $moretitle = '', $notooltip = 0, $addlinktonotes = 0, $save_lastsearch_value = -1, $target = '')
	{
		...
		$hookmanager->initHooks(array('interventionaldao'));
