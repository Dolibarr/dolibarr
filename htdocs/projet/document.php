...
if ($object->id > 0) {
	...
	$filearray = dol_dir_list($upload_dir, "files",  !empty($conf->global->PROJECT_LIST_RECURSIVE_FILES), '', '(\.meta|_preview.*\.png)$', $sortfield, (strtolower($sortorder) == 'desc' ?SORT_DESC:SORT_ASC), 1);
	$totalsize = 0;
