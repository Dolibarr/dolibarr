...
if ($search_datee_start)             $sql .= " AND t.datee >= '".$db->idate($search_datee_start)."'";
if ($search_datee_end)               $sql .= " AND t.datee <= '".$db->idate($search_datee_end)."'";
...
if ($search_datee_start)				$param .= '&search_datee_startday='.GETPOST('search_datee_startday').'&search_datee_startmonth='.GETPOST('search_datee_startmonth').'&search_datee_startyear='.GETPOST('search_datee_startyear');
if ($search_datee_end)					$param .= '&search_datee_endday='.GETPOST('search_datee_endday').'&search_datee_endmonth='.GETPOST('search_datee_endmonth').'&search_datee_endyear='.GETPOST('search_datee_endyear');
...
if (!empty($arrayfields['t.dateo']['checked']))
{
	...
	print $form->selectDate($search_dateo_end ? $search_dateo_end : -1, 'search_dateo_end', 0, 0, 1);
	print '</div>';
	print '</td>';
}
// End date
