...
if ($id > 0 || ! empty($ref))
{
	...
	if ($object->fetch($id) >= 0)
	{
		...
		if ($withproject)
		{
			...
			if (! empty($projectstatic->thirdparty->id)) print $projectstatic->thirdparty->getObjectUrl(1);
			else print '&nbsp;';
			print '</td>';
			print '</tr>';
		...
		if (empty($withproject))
		{
			...
			if ($projectstatic->thirdparty->id) print $projectstatic->thirdparty->getObjectUrl(1);
			else print '&nbsp;';
			print '</td></tr>';
		}
