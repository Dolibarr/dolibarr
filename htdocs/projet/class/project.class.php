...
class Project extends CommonObject
{
     ...
     */
    public function getNomUrl($withpicto=0, $option='', $addlabel=0)
    {
        global $langs;
     ...
     */
    public function getProjectsAuthorizedForUser($user, $mode=0, $list=0, $socid=0)
    {
        $projects = array();
        $temp = array();
      ...
      */
    public function createFromClone($fromid,$clone_contact=false,$clone_task=true,$clone_file=false,$clone_note=true)
    {
        global $user,$langs,$conf;
     ...
     */
    public function clean_orphelins()
    {
        $nb=0;
      ...
      */
    public function select_element($Tablename)
    {
