...
class Project extends CommonObject
{
	...
	public function getKanbanView($option = '', $arraydata = null, $size = '')
	{
		...
		$return = '<div class="box-flex-item '.($size == 'small' ? 'box-flex-item-small' : '').' box-flex-grow-zero '.(GETPOST('mode') == 'kanbangroupby' ? 'kanban-draggable" data-itemid="'.$this->id.'" data-element="'.$this->element.'" data-tableelement="'.$this->table_element.'"' : '"').'>';
