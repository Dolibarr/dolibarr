...
if (! empty($project->thirdparty->id)) print $project->thirdparty->getObjectUrl(1);
else print '&nbsp;';
print '</td></tr>';
	...
	if ($qualified)
	{
		...
		if (count($elementarray)>0 && is_array($elementarray))
		{
			...
			for ($i = 0; $i < $num; $i++)
			{
				...
				// Third party
                print '<td align="left">';
                if (is_object($element->client)) print $element->client->getObjectUrl(1,'',48);
				print '</td>';
