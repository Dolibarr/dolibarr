...
'order'=>array(
	...
	'testnew'=>!empty($user->rights->commande->creer),
	'test'=>!empty($conf->commande->enabled) && $user->rights->commande->lire),
'invoice'=>array(
...
'contract'=>array(
	...
	'testnew'=>!empty($user->rights->contrat->creer),
	'test'=>!empty($conf->contrat->enabled) && $user->rights->contrat->lire),
'intervention'=>array(
	'name'=>"Interventions",
	...
	'testnew'=>!empty($user->rights->ficheinter->creer),
	'test'=>!empty($conf->ficheinter->enabled) && $user->rights->ficheinter->lire),
'shipping'=>array(
	'name'=>"Shippings",
	...
	'testnew'=>0,
	'test'=>!empty($conf->expedition->enabled) && $user->rights->expedition->lire),
'mrp'=>array(
	'name'=>"MO",
	...
	'project_field'=>'fk_project',
	'test'=>!empty($conf->mrp->enabled) && $user->rights->mrp->read),
'trip'=>array(
	...
	'lang'=>'trips',
	'buttonnew'=>'AddTrip',
	'testnew'=>!empty($user->rights->deplacement->creer),
	'test'=>!empty($conf->deplacement->enabled) && $user->rights->deplacement->lire),
'expensereport'=>array(
	'name'=>"ExpenseReports",
	'title'=>"ListExpenseReportsAssociatedProject",
	...
	'lang'=>'trips',
	'buttonnew'=>'AddTrip',
	'testnew'=>!empty($user->rights->expensereport->creer),
	'test'=>!empty($conf->expensereport->enabled) && $user->rights->expensereport->lire),
'donation'=>array(
	'name'=>"Donation",
	...
	'testnew'=>!empty($user->rights->don->creer),
	'test'=>!empty($conf->don->enabled) && $user->rights->don->lire),
'loan'=>array(
	'name'=>"Loan",
	...
	'lang'=>'loan',
	'buttonnew'=>'AddLoan',
	'testnew'=>!empty($user->rights->loan->write),
	'test'=>!empty($conf->loan->enabled) && $user->rights->loan->read),
