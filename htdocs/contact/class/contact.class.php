...
class Contact extends CommonObject
{
    ...
    public $id;
    public $civilite_id;  // In fact we store civility_code
    public $lastname;
    public $firstname;
    public $address;
    public $zip;
    ...
    public $fk_departement;		// deprecated
    ...
    public $country_id;			// Id of country
    public $country_code;			// Code of country
    public $country;				// Label of country

    public $socid;					// fk_soc
    public $status;				// 0=brouillon, 1=4=actif, 5=inactif

    public $code;
    public $email;
    public $birthday;
    public $default_lang;
    public $note_public;           // Public note
    public $note;                  // deprecated
    public $note_private;			// Private note
    public $no_email;				// 1=Don't send e-mail to this contact, 0=do

    public $ref_facturation;       // Nb de reference facture pour lequel il est contact
     ...
     *      @return     int      			   	<0 if KO, >0 if OK
     */
    public function update($id, $user=0, $notrigger=0, $action='update')
    {
     ...
     *  @return     int         			<0 if KO, >=0 if OK
     */
    public function update_perso($id, $user=0)
    {
        $error=0;
        $result=false;
