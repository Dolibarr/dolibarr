...
class Categorie
{
    ...
    public $description;
    public $socid;
    public $type;					// 0=Product, 1=Supplier, 2=Customer/Prospect, 3=Member
    public $import_key;

    public $cats=array();			// Tableau en memoire des categories
     ...
     *	@return	void
     */
    public function get_type($field,$classname,$category_table='',$object_table='')
    {
        $objs = array();
     ...
     */
    public function get_nb_categories()
    {
     ...
     * @return void
     */
    public function print_all_ways($sep = " &gt;&gt; ", $url='')
    {
        $ways = array ();
     ...
     *	@deprecated function not used ?
     */
    public function get_primary_way($id, $type="")
    {
     ...
     *	@deprecated function not used ?
     */
    public function print_primary_way($id, $sep= " &gt;&gt; ", $url="", $type="")
    {
        $primary_way = array();
     ...
     */
    public function containing($id,$typeid,$mode='object')
    {
        $cats = array();

        $table=''; $type='';
        if ($typeid == 0 || $typeid == 'product') { $typeid=0; $table='product'; $type='product'; } elseif ($typeid == 1 || $typeid == 'supplier') { $typeid=1; $table='societe'; $type='fournisseur'; } elseif ($typeid == 2 || $typeid == 'customer') { $typeid=2; $table='societe'; $type='societe'; } elseif ($typeid == 3 || $typeid == 'member') { $typeid=3; $table='member';  $type='member'; }
     ...
     *	@return		void
     */
    public function add_photo($sdir, $file, $maxWidth = 160, $maxHeight = 120)
    {
     ...
     *	@return		void
     */
    public function add_thumb($file, $maxWidth = 160, $maxHeight = 120)
    {
