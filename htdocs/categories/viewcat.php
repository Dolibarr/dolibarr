	...
	else
	{
		...
		if (count($prods) > 0)
		{
			...
			foreach ($prods as $prod)
			{
				...
				print $prod->getObjectUrl(1,'category');
				print "</td>\n";
	...
	else
	{
		...
		if (count($socs) > 0)
		{
			...
			foreach ($socs as $soc)
			{
				...
				print '<td class="nowrap" valign="top">';
				print $soc->getObjectUrl(1,'category_supplier');
				print "</td>\n";
				// Link to delete from category
				print '<td align="right">';
				$typeid=$object->type;
	...
	else
	{
		...
		if (count($socs) > 0)
		{
			...
			foreach ($socs as $key => $soc)
			{
				...
				print "\t<tr ".$bc[$var].">\n";
				print '<td class="nowrap" valign="top">';
				print $soc->getObjectUrl(1,'category');
				print "</td>\n";
				// Link to delete from category
				print '<td align="right">';
				$typeid=$object->type;
	...
	else
	{
		...
		if (count($prods) > 0)
		{
			...
			foreach ($prods as $key => $member)
			{
				...
				print $member->getObjectUrl(1,0,'category');
				print "</td>\n";
	...
	else
	{
		...
		if (count($contacts) > 0)
		{
			...
			foreach ($contacts as $key => $contact)
			{
				...
				print "\t<tr ".$bc[$var].">\n";
				print '<td class="nowrap" valign="top">';
				print $contact->getObjectUrl(1,'category');
				print "</td>\n";
				// Link to delete from category
				print '<td align="right">';
				$typeid=$object->type;
