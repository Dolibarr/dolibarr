...
if ($id > 0 && $removeelem > 0) {
	...
	} elseif ($type == Categorie::TYPE_SUPPLIER_ORDER && $user->rights->fournisseur->commande->creer) {
...
if ($elemid && $action == 'addintocategory' &&
	...
	} elseif ($type == Categorie::TYPE_INVOICE) {
		require_once DOL_DOCUMENT_ROOT.'/compta/facture/class/facture.class.php';
...
if ($type == Categorie::TYPE_SUPPLIER_INVOICE) {
	...
	if ($objects < 0) {
		...
		print_barre_liste($langs->trans("BillsSuppliers"), $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'bill', 0, $newcardbutton, '', $limit);
...
if ($type == Categorie::TYPE_SUPPLIER_ORDER) {
	...
	if ($objects < 0) {
		...
		print_barre_liste($langs->trans("OrdersSuppliers"), $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'bill', 0, $newcardbutton, '', $limit);
