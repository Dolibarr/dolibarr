...
class ProductCombination
{
    ...
    public function fetchByFkProductChild($fk_child)
    {
        ...
        $this->variation_ref_ext = $result->variation_ref_ext;
    ...
    public function fetchAllByFkProductParent($fk_product_parent)
    {
        ...
        $sql = "SELECT rowid, fk_product_parent, fk_product_child, variation_price, variation_price_percentage, variation_weight, variation_ref_ext FROM ".MAIN_DB_PREFIX."product_attribute_combination WHERE fk_product_parent = ".(int) $fk_product_parent." AND entity IN (".getEntity('product').")";
