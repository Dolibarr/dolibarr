...
/**
 *       \file       htdocs/quickmemo/ajax/memo.php
 *       \brief      File to return Ajax response on memo list request
 */
 ...
 * @var User $user
 */
dol_include_once('/quickmemo/class/memo.class.php');
...
dol_syslog("Call ajax quickmemo/ajax/memo.php");
