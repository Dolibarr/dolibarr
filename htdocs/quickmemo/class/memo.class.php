...
class Memo extends CommonObject
{
	...
	public $fields = array(
		...
		"pos_z" => array("type" => "real", "label" => "PosZ", "enabled" => "1", 'position' => 1000, 'notnull' => 1, "visible" => "0", "default" => 0, "validate" => "1"),
		"pos_y" => array("type" => "real", "label" => "PosY", "enabled" => "1", 'position' => 1000, 'notnull' => 1, "visible" => "0", "default" => 0, "validate" => "1"),
		"pos_x" => array("type" => "real", "label" => "PosX", "enabled" => "1", 'position' => 1000, 'notnull' => 1, "visible" => "0", "default" => 0, "validate" => "1"),
		"pos_w" => array("type" => "real", "label" => "PosW", "enabled" => "1", 'position' => 1000, 'notnull' => 1, "visible" => "0", "default" => 0, "validate" => "1"),
		"pos_h" => array("type" => "real", "label" => "PosH", "enabled" => "1", 'position' => 1000, 'notnull' => 1, "visible" => "0", "default" => 0, "validate" => "1"),
