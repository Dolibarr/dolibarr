...
$heightrow			 = empty($user->conf->THEME_ELDY_ENABLE_PERSONALIZED) ? (empty($conf->global->THEME_ELDY_USECOMOACTROW) ? '22px' : '50px') : (empty($conf->global->THEME_ELDY_USECOMOACTROW) ? '22px' : '50px');
