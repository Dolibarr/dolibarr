...
$heightrow			 = empty($user->conf->THEME_ELDY_ENABLE_PERSONALIZED) ? (empty($conf->global->THEME_ELDY_USECOMOACTROW) ? '300%' : '120%') : (empty($conf->global->THEME_ELDY_USECOMOACTROW) ? '300%' : '120%');
