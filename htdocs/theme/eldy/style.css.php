...
$heightrow			 = empty($user->conf->THEME_ELDY_ENABLE_PERSONALIZED) ? (empty($conf->global->THEME_ELDY_USECOMOACTROW) ? '22px' : '40px') : (empty($conf->global->THEME_ELDY_USECOMOACTROW) ? '22px' : '40px');
// Hover color
