...
if ($id > 0 || !empty($ref)) {
	$upload_dir = (!empty($conf->knowledgemanagement->multidir_output[$object->entity ?? 1]) ? $conf->knowledgemanagement->multidir_output[$object->entity ?? 1] : $conf->knowledgemanagement->dir_output)."/".$object->id;
}
