...
/**
 *  \file       knowledgemanagement/myobject_contact.php
...
dol_include_once('/knowledgemanagement/class/myobject.class.php');
dol_include_once('/knowledgemanagement/lib/knowledgemanagement_myobject.lib.php');
...
$permission = $user->rights->knowledgemanagement->myobject->write;
...
if ($object->id) {
	...
	$linkback = '<a href="'.dol_buildpath('/knowledgemanagement/myobject_list.php', 1).'?restore_lastsearch_values=1'.(!empty($socid) ? '&socid='.$socid : '').'">'.$langs->trans("BackToList").'</a>';
