...
/**
 * \file    test/phpunit/KnowledgeManagementFunctionalTest.php
...
/**
 * Class KnowledgeManagementFunctionalTest
 *
 ...
 */
class KnowledgeManagementFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modKnowledgeManagement')->click();
		} else {
			// Disable the module
			$this->byHref('modKnowledgeManagement')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/knowledgemanagement/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('knowledgemanagement/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/knowledgemanagement/admin/about.php');
		$this->authenticate();
		return $this->assertContains('knowledgemanagement/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modKnowledgeManagement_KnowledgeManagementTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modKnowledgeManagement_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
