...
$diroutputmassaction = $conf->ficheinter->multidir_output[$conf->entity].'/temp/massgeneration/'.$user->id;
...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $conf->ficheinter->multidir_output[!empty($object->entity) ? $object->entity : $conf->entity]."/".$object->id;
}
