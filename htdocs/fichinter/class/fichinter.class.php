...
class Fichinter extends CommonObject
{
    ...
    public $datem;
    public $duree;
    public $statut;		// 0=draft, 1=validated, 2=invoiced
    public $description;
    public $note_private;
    public $note_public;
    public $fk_project;
    ...
    */
     ...
     *	@return     int		<0 if ko, >0 if ok
     */
    public function set_contrat($user, $contratid)
    {
        global $conf;
     ...
     */
    public function addline($user,$fichinterid, $desc, $date_intervention, $duration)
    {
