...
/**
 *  \file       core/modules/preopportunity/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_preopportunity
 */
class pdf_standard_preopportunity extends ModelePDFPreOpportunity
{
	/**
	 ...
	 *
	 *  @param		PreOpportunity	$object				Object to generate
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		if (getDolGlobalString('MYOBJECT_DRAFT_WATERMARK') && $object->statut == $object::STATUS_OPEN) {
	 ...
	 *
	 *  @param	TCPDF		$pdf     		Object PDF
	 *  @param  PreOpportunity	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('PREOPPORTUNITY_DRAFT_WATERMARK') && $object->statut == $object::STATUS_OPEN) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('PREOPPORTUNITY_DRAFT_WATERMARK')));
		}
		...
		if ($object->statut == $object::STATUS_OPEN) {
