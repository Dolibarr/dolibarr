...
if ($num == 1 && !empty(getDolGlobalString("MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE")) && $search_all) {
...
$fieldtosortuser = empty(getDolGlobalString("MAIN_FIRSTNAME_NAME_POSITION")) ? 'firstname' : 'lastname';
