...
if (GETPOSTINT('nomassaction') || in_array($massaction, array('preunletteringauto', 'preunletteringmanual', 'predeletebookkeepingwriting', 'pregeneralledgerunletteringmanual'))) {
	$arrayofmassactions = array();
}
