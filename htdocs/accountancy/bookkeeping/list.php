...
$search_date_creation_startyear =  GETPOSTSESSIONINT('search_date_creation_startyear');
$search_date_creation_startmonth =  GETPOSTSESSIONINT('search_date_creation_startmonth');
$search_date_creation_startday =  GETPOSTSESSIONINT('search_date_creation_startday');
$search_date_creation_endyear =  GETPOSTSESSIONINT('search_date_creation_endyear');
$search_date_creation_endmonth =  GETPOSTSESSIONINT('search_date_creation_endmonth');
$search_date_creation_endday =  GETPOSTSESSIONINT('search_date_creation_endday');
...
$search_date_modification_startyear =  GETPOSTSESSIONINT('search_date_modification_startyear');
$search_date_modification_startmonth =  GETPOSTSESSIONINT('search_date_modification_startmonth');
$search_date_modification_startday =  GETPOSTSESSIONINT('search_date_modification_startday');
$search_date_modification_endyear =  GETPOSTSESSIONINT('search_date_modification_endyear');
$search_date_modification_endmonth =  GETPOSTSESSIONINT('search_date_modification_endmonth');
$search_date_modification_endday =  GETPOSTSESSIONINT('search_date_modification_endday');
