...
if (!GETPOST('confirmmassaction', 'alpha') &&
	!in_array($massaction, ['preunletteringauto', 'preunletteringmanual', 'predeletebookkeepingwriting', 'preclonebookkeepingwriting', 'preassignaccountbookkeepingwriting', 'prereturnaccountbookkeepingwriting', 'pregeneralledgerunletteringmanual'])) {
	$massaction = '';
}
...
if (GETPOSTINT('nomassaction') || in_array($massaction, array('preunletteringauto', 'preunletteringmanual', 'predeletebookkeepingwriting', 'preclonebookkeepingwriting', 'preassignaccountbookkeepingwriting', 'prereturnaccountbookkeepingwriting', 'pregeneralledgerunletteringmanual'))) {
	$arrayofmassactions = array();
}
