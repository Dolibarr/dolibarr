...
if ($type == 'sub') {
	if (getDolGlobalString('ACCOUNTANCY_COMBO_FOR_AUX')) {
		...
		$moreforfilter .= $langs->trans('From') .' '.'<input type="text" class="maxwidth150" name="search_accountancy_code_start" value="'.dol_escape_htmltag($search_accountancy_code_start).'">';
	}
} else {
...
if ($type == 'sub') {
	if (getDolGlobalString('ACCOUNTANCY_COMBO_FOR_AUX')) {
		...
		$moreforfilter .= $langs->trans('to') .' '.'<input type="text" class="maxwidth150" name="search_accountancy_code_end" value="'.dol_escape_htmltag($search_accountancy_code_end).'">';
	}
} else {
