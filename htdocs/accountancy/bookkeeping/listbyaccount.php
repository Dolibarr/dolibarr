...
if (! empty($search_label_account)) {
	...
	$param .= '&search_label_account=' . urlencode($search_label_account);
}
...
print '<td class="liste_titre" colspan="2">' . $object->select_account($search_accountancy_code_start, 'search_accountancy_code_start', 1, array (), 1, 1, '') . '</td>';
...
print '<td class="liste_titre"><input type="text" size="7" class="flat" name="search_debit" value="' . $search_debit . '"/></td>';
print '<td class="liste_titre"><input type="text" size="7" class="flat" name="search_credit" value="' . $search_credit . '"/></td>';
