...
if ($resql)
{
    ...
    print '<input type="submit" onclick="change_chart.focus();change_chart.select();" class="button" name="change_chart" id="change_chart" value="'.dol_escape_htmltag($langs->trans("ChangeAndLoad")).'">';
