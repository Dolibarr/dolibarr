...
<script>
function Save(){
	$.get( "invoice.php", { action: "<?php echo $action;?>", place: "<?php echo $place;?>", desc:$('#desc').val(), number:$('#number').val(), vat:$('#vat').val()} );
...
<?php
if ($action=="freezone"){
	echo '<input type="text" id="number" name="number" style="width:15%;font-size: 200%;" placeholder="'.$langs->trans('Price').'"> ';
	$form=new Form($db);
	print '<span style="width:10%;font-size: 200%;">'.$form->load_tva('vat','21').'</span>';
}
