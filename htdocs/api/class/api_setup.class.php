...
class Setup extends DolibarrApi
{
     ...
     * @param string    $sqlfilters SQL criteria to filter with. Syntax example "(t.unit_type:=:'weight')"
     *
     * @url     GET dictionary/mesuring_units
     *
     * @return array [List of Measuring Units]
     *
     * @throws 400 RestException
     * @throws 200 OK
     */
    public function getMesuringUnits($sortfield = "code", $sortorder = 'ASC', $limit = 100, $page = 0, $active = 1, $sqlfilters = '')
    {
        $list = array();
        
        $sql = "SELECT rowid, code, scale, label, short_label, unit_type";
