	...
	public function getCheckIntegrity($target)
	{
		...
		if ($xml) {
			...
			if (is_object($xml->dolibarr_htdocs_dir[0])) {
				...
				/** @var array{insignature:string[],missing?:array<array{filename:string,expectedmd5:string,expectedsize:string}>,updated:array<array{filename:string,expectedmd5:string,expectedsize:string,md5:string}>} $file_list */
