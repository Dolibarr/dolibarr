...
class Documents extends DolibarrApi
{
	...
	public function getDocumentsListByElement($modulepart, $id = 0, $ref = '', $sortfield = '', $sortorder = '', $limit = 100, $page = 0, $content_type = '', $pagination_data = false)
	{
		...
		if ($modulepart == 'societe' || $modulepart == 'thirdparty') {
			...
			$upload_dir = $conf->propal->multidir_output[$object->entity ?? 1]."/".get_exdir(0, 0, 0, 1, $object, 'propal');
			...
			$upload_dir = $conf->categorie->multidir_output[$object->entity ?? 1].'/'.get_exdir($object->id, 2, 0, 0, $object, 'category').$object->id."/photos/".dol_sanitizeFileName($object->ref);
			...
			$upload_dir = $conf->societe->multidir_output[$object->entity ?? 1] . "/contact/" . get_exdir(0, 0, 0, 1, $object, 'contact');
		} else {
