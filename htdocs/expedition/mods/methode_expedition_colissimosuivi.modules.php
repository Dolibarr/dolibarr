...
Class methode_expedition_colissimosuivi extends methode_expedition
{

  Function methode_expedition_colissimosuivi($db=0)
    { 
      $this->db = $db;
      $this->id = 3; // Ne pas changer cette valeur
      $this->code = "COLSUI";
