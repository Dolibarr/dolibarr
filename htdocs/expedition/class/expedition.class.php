...
class Expedition extends CommonObject
{
    ...
    public $date_expedition;	// Date delivery real
     ...
     */
    public function create_line($entrepot_id, $origin_line_id, $qty)
    {
        $error = 0;
     ...
     * @return int <0 if KO, >0 if OK
     */
    public function addline($entrepot_id, $id, $qty)
    {
        $num = count($this->lines);
     ...
     */
    public function getNomUrl($withpicto=0,$option=0,$max=0,$short=0)
    {
        global $langs;
