...
abstract class Stats
{
     ...
     */
    public function getNbByMonthWithPrevYear($endyear,$startyear)
    {
     ...
     * @return array Array of values
     */
    public function getAmountByMonthWithPrevYear($endyear,$startyear)
    {
        if ($startyear > $endyear) return -1;
     ...
     * 	@return	array
     */
    public function _getNbByYear($sql)
    {
        $result = array();
     ...
     */
    public function _getAllByYear($sql)
    {
        $result = array();
     ...
     */
    public function _getNbByMonth($year, $sql)
    {
        $result=array();
        $res=array();
     ...
     *     @return	array
     */
    public function _getAmountByMonth($year, $sql)
    {
        $result=array();
        $res=array();
     ...
     *      @return	array
     */
    public function _getAverageByMonth($year, $sql)
    {
        $result=array();
        $res=array();
