...
class CMailFile
{
    ...
    public $addr_from;    // From:        Label of sender (name but can contains an email inside <>)
    ...
    public $image_types = array('gif'  => 'image/gif',
                           'jpg'  => 'image/jpeg',
                           'jpeg' => 'image/jpeg',
                           'jpe'  => 'image/jpeg',
                           'bmp'  => 'image/bmp',
     ...
     */
    public function __construct($subject,$to,$from,$msg,
    ...
    public function encodetorfc2822($stringtoencode)
    {
        global $conf;
     ...
     */
    public function _encode_file($sourcefile)
    {
     ...
     */
    public function getValidAddress($address,$format,$encode='')
    {
        global $conf;
