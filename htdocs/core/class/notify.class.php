					...
					if (dol_strlen($obj->email)) {
						...
						switch ($notifcode) {
							...
							case 'PROPAL_VALIDATE':
								...
								$dir_output = $conf->propal->multidir_output[$object->entity ?? 1]."/".get_exdir(0, 0, 0, 1, $object, 'propal');
								$object_type = 'propal';
							...
							case 'ORDER_SUPPLIER_VALIDATE':
								...
								$dir_output = $conf->fournisseur->commande->multidir_output[$object->entity ?? 1]."/".get_exdir(0, 0, 0, 1, $object);
