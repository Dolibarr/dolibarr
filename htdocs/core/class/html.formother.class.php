...
class FormOther
{
     ...
     */
    public function select_percent($selected=0,$htmlname='percent',$disabled=0,$increment=5,$start=0,$end=100)
    {
     ...
     */
    public function select_categories($type,$selected=0,$htmlname='search_categ',$nocateg=0)
    {
        global $langs;
     ...
     *  @return string					Html combo list code
     */
    public function select_salesrepresentatives($selected,$htmlname,$user)
    {
        global $conf;
     ...
     *  @return	void
     */
    public function selectProjectTasks($selectedtask='', $projectid=0, $htmlname='task_parent', $modeproject=0, $modetask=0, $mode=0, $useempty=0)
    {
        global $user, $langs;
     ...
     * 		@deprecated
     */
    public function select_color($set_color='', $prefix='f_color', $form_name='objForm', $showcolorbox=1, $arrayofcolors='')
    {
     ...
     * 		@return	void
     */
    public function selectColor($set_color='', $prefix='f_color', $form_name='objForm', $showcolorbox=1, $arrayofcolors='', $morecss='')
    {
        global $langs,$conf;
     ...
     *    	@return	void
     */
    public function select_month($selected='',$htmlname='monthid',$useempty=0)
    {
        global $langs;
     ...
     *  @return	void
     */
    public function select_year($selected='',$htmlname='yearid',$useempty=0, $min_year=10, $max_year=5, $offset=0, $invert=0, $option='')
    {
     ...
     *  @return	void
     */
    public function selectyear($selected='',$htmlname='yearid',$useempty=0, $min_year=10, $max_year=5, $offset=0, $invert=0, $option='')
    {
        $out='';
     ...
     * @return void
     */
    public function form_address($page, $selected, $socid, $htmlname='address_id', $origin='', $originid='')
    {
        global $langs,$conf;
        global $form;
     ...
     */
    public static function printBoxesArea($user,$areacode)
    {
