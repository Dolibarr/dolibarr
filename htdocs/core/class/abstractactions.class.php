...
abstract class AbstractActions
{
	...
	{
		global $db, $langs, $conf, $object, $id, $action;
		// Set public note
...
// Delete link
	...
	function actions_lineupdown()
	{
		global $langs, $conf, $object, $action, $permissiontoedit, $hidedetails, $hidedesc, $hideref;
	...
	function actions_other1()
	{
		global $db, $user, $langs, $conf, $object, $socid, $action, $hidedetails, $hidedesc, $hideref, $confirm, $lineid, $id,
			   $usercancreate, $usercandelete, $usercanvalidate, $usercanclose, $error, $origin, $originid, $hookmanager,
			   $extrafields;
		// Action clone object
	...
	function actions_printing()
	{
		global $db, $user, $langs, $conf, $action;
// Print file
	...
	function actions_sendmails()
	{
		global $db, $user, $langs, $conf, $object, $action, $id, $hookmanager, $mysoc, $error, $paramname,
...
// $object and $uobject may be defined
	...
	function actions_other2()
	{
		global $db, $user, $langs, $conf, $object, $action, $id, $mysoc, $error, $usercancreate, $hidedetails, $hidedesc, $hideref, $extrafields, $lineid;
	...
	function actions_builddoc()
	{
		global $user, $langs, $conf, $object, $action, $id, $error, $hidedetails, $hidedesc, $hideref;
