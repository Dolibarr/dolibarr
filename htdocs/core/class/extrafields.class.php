...
class ExtraFields
{
    ...
    */
     ...
     */
    public function addExtraField($attrname, $label, $type, $pos, $size, $elementtype, $unique=0, $required=0,$default_value='', $param=0)
    {
     ...
     */
    public function update($attrname,$label,$type,$length,$elementtype,$unique=0,$required=0,$pos=0,$param='')
    {
        $table=$elementtype.'_extrafields';
     ...
     */
    public function fetch_name_optionals_label($elementtype='adherent',$forceload=false)
    {
        global $conf;
     ...
     *  @return	void
     */
    public function showInputField($key,$value,$moreparam='')
    {
        global $conf,$langs;
     ...
     */
    public function showOutputField($key,$value,$moreparam='')
    {
        global $conf,$langs;
     ...
     * @return string
     */
    public function showSeparator($key)
    {
     ...
     */
    public function setOptionalsFromPost($extralabels,&$object)
    {
        global $_POST;
        ...
        if (is_array($extralabels)) {
            ...
            foreach ($extralabels as $key => $value) {
                ...
                } elseif (in_array($key_type,array('checkbox'))) {
     ...
     * @return int   1 if array_options set / 0 if no value
     */
    public function getOptionalsFromPost($extralabels)
    {
        global $_POST;
