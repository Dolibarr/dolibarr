...
class Translate
{
    ...
    public $direction = 'ltr';				// Left to right or Right to left
    public $charset_inputfile=array();	// To store charset encoding used for language
    ...
    private function getTradFromKey($key)
    {
        ...
        } elseif (preg_match('/^Civility([0-9A-Z]+)$/i',$key,$reg)) {
     ...
     */
    public function transnoentities($key, $param1='', $param2='', $param3='', $param4='')
    {
     ...
     *  @return string      		Translated string
     */
    public function transnoentitiesnoconv($key, $param1='', $param2='', $param3='', $param4='')
    {
        global $conf;
     ...
     */
    public function getLabelFromKey($db,$key,$tablename,$fieldkey,$fieldlabel,$keyforselect='')
    {
        // If key empty
        if ($key == '') return '';
