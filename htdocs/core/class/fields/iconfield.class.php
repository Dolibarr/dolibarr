...
/**
 *    \file        htdocs/core/class/fields/iconfield.class.php
 *    \ingroup    core
 *    \brief      File of class to icon field
 */
...
class IconField extends CommonField
{
	...
	public function printInputField($fieldInfos, $key, $value, $keyPrefix = '', $keySuffix = '', $moreCss = '', $moreAttrib = '')
	{
		...
		return self::$form->inputIcon($htmlName, (string) $value, $moreCss, $moreAttrib . $placeHolder . $autoFocus);
	}
	...
	{
		return !$this->isEmptyValue($fieldInfos, $value) ? self::$form->outputIcon((string) $value) : '';
	}
