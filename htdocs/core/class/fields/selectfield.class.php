...
/**
 *    \file        htdocs/core/class/fields/selectfield.class.php
 *    \ingroup    core
 *    \brief      File of class to select field
 */
 ...
 */
class SelectField extends CommonSelectField
{
	/**
	...
	public function printInputField($fieldInfos, $key, $value, $keyPrefix = '', $keySuffix = '', $moreCss = '', $moreAttrib = '')
	{
		...
		return self::$form->selectarray($htmlName, $options, $selectedValue, 0, 0, 0, $moreAttrib . $placeHolder . $autoFocus, 0, 0, 0, '', $moreCss);
	}
	...
	public function getPostFieldValue($fieldInfos, $key, $defaultValue = null, $keyPrefix = '', $keySuffix = '')
	{
		...
		return $this->isEmptyValue($fieldInfos, $value) ? '' : $value;
	}
