...
/**
 *    \file        htdocs/core/class/fields/textfield.class.php
 *    \ingroup    core
 *    \brief      File of class to text field
 */
...
class TextField extends CommonField
{
	...
	public function printInputField($fieldInfos, $key, $value, $keyPrefix = '', $keySuffix = '', $moreCss = '', $moreAttrib = '')
	{
		...
		return self::$form->inputText($htmlName, (string) $value, $moreCss, $moreAttrib, $fieldInfos->options);
	}
