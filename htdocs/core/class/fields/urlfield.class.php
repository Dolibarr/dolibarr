...
/**
 *    \file        htdocs/core/class/fields/urlfield.class.php
 *    \ingroup    core
 *    \brief      File of class to url field
 */
 ...
 *    Class to url field
 */
class UrlField extends CommonField
{
	/**
	...
	public function printInputField($fieldInfos, $key, $value, $keyPrefix = '', $keySuffix = '', $moreCss = '', $moreAttrib = '')
	{
		...
		return self::$form->inputType('text', $htmlName, (string) $value, $htmlName, $moreCss, $moreAttrib . $autoFocus);
	}
	...
	{
		return !$this->isEmptyValue($fieldInfos, $value) ? dol_print_url((string) $value, '_blank', 32, 1) : '';
	}
