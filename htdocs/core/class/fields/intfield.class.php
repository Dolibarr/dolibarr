...
/**
 *    \file        htdocs/core/class/fields/intfield.class.php
 *    \ingroup    core
 *    \brief      File of class to int field
 */
 ...
 *    Class to int field
 */
class IntField extends CommonField
{
	/**
	...
	public function printInputField($fieldInfos, $key, $value, $keyPrefix = '', $keySuffix = '', $moreCss = '', $moreAttrib = '')
	{
		...
		return self::$form->inputType('text', $htmlName, (string) $value, $htmlName, $moreCss, $maxLength . $moreAttrib . $autoFocus);
	}
