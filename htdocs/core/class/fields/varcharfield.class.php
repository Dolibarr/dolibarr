...
/**
 *    \file        htdocs/core/class/fields/varcharfield.class.php
 *    \ingroup    core
 *    \brief      File of class to varchar field
 */
 ...
 */
class VarcharField extends CommonField
{
	/**
	...
	public function printInputField($fieldInfos, $key, $value, $keyPrefix = '', $keySuffix = '', $moreCss = '', $moreAttrib = '')
	{
		...
		return self::$form->inputType('text', $htmlName, (string) $value, $htmlName, $moreCss, $maxLength . $moreAttrib . $placeHolder . $autoFocus);
	}
	...
	{
		return !$this->isEmptyValue($fieldInfos, $value) ? dol_htmlentitiesbr((string) $value) : '';
	}
