...
class FormCompany
{
     ...
     */
    public function effectif_array($mode=0)
    {
        $effs = array();
     ...
     *   @return	void
     */
    public function select_departement($selected='',$country_codeid=0, $htmlname='departement_id')
    {
     ...
     */
    public function select_state($selected='',$country_codeid=0, $htmlname='departement_id')
    {
     ...
     *  @return	string					String with HTML select
     */
    public function select_civility($selected='',$htmlname='civilite_id')
    {
        global $conf,$langs,$user;
        $langs->load("dict");
     ...
     *    @return	string							String with HTML select
     */
    public function select_juridicalstatus($selected='', $country_codeid=0, $filter='')
    {
        global $conf,$langs,$user;
        $langs->load("dict");
     ...
     */
    public function selectCompaniesForNewContact($object, $var_id, $selected='', $htmlname='newcompany', $limitto='', $forceid=0)
    {
        global $conf, $langs;
     ...
     *  @return	void
     */
    public function selectTypeContact($object, $selected, $htmlname = 'type', $source='internal', $order='code', $showempty=0)
    {
     ...
     *    @return	void
     */
    public function select_ziptown($selected='', $htmlname='zipcode', $fields='', $fieldsize=0, $disableautocomplete=0)
    {
        global $conf;
     ...
     */
    public function get_input_id_prof($idprof,$htmlname,$preselected,$country_code)
    {
        global $conf,$langs;
