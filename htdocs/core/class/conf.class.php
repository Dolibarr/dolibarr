...
class Conf
{
	...
	function setValues($db)
	{
        ...
        //Module part to include external modules menus
        if(!empty($this->modules_parts['menuforexternal']))
        foreach($this->modules_parts['menuforexternal'] as $key=>$value) $this->global->MAIN_MODULES_FOR_EXTERNAL.=",$key";
