...
class FormHelper
{
     ...
     *
     * @param array<int,string|array<string,mixed>> $columns    Array of columns. Each column can be a string (content) or an array with 'content', 'class', 'id', and additional attributes.
     * @param string $rowClass   Optional CSS class for the row.
     * @param string $rowId      Optional ID for the row.
     * @param array<string,string> $attributes Additional attributes for the row (optional).
     *
     * @return string
     */
    public function addRow(array $columns = [], $rowClass = '', $rowId = '', array $attributes = array())
    {
        $attrString = $this->buildAttributes($attributes);
     ...
     *
     * @param array<int,string|array<string,mixed>> $headers    Array of headers to display. Each header can be a string or an array with 'content', 'class', 'id', and additional attributes.
     ...
     * @return string
     */
    public function addHeaderRow(array $headers = [], $class = 'liste_titre', $rowspan = 1, $colspan = 1, $id = '', array $attributes = array())
    {
        $attrString = $this->buildAttributes($attributes);
     ...
     * @param array<string,string> $attributes Additional attributes for the column (optional).
     *
     * @return string
     */
