...
class SMTPs
{
     ...
     */
    public $_msgRecipients = null;

    /**
     * Message Subject
     */
    public $_msgSubject = null;

    /**
     * Message Content
     */
    public $_msgContent = null;

    /**
     * Custom X-Headers
     */
    public $_msgXheader = null;

    /**
     * Character set
     * Defaulted to 'iso-8859-1'
     */
    public $_smtpsCharSet = 'iso-8859-1';

    /**
     * Message Sensitivity
     * Defaults to ZERO - None
     */
    public $_msgSensitivity = 0;

    /**
     * Message Sensitivity
     */
    public $_arySensitivity = array ( false,
                                  'Personal',
                                  'Private',
     ...
     */
    public $_msgPriority = 3;

    /**
     * Message Priority
     */
    public $_aryPriority = array ( 'Bulk',
                                'Highest',
                                'High',
                                'Normal',
                                'Low',
     ...
     * Defaulted to 0 - 7bit
     */
    public $_smtpsTransEncodeType = 0;

    /**
     * Content-Transfer-Encoding
     */
    public $_smtpsTransEncodeTypes = array( '7bit',               // Simple 7-bit ASCII
     ...
     * Defaulted to '7bit'
     */
    public $_smtpsTransEncode = '7bit';

    /**
     * Boundary String for MIME seperation
     */
    public $_smtpsBoundary = null;

    /**
     * Related Boundary
     */
    public $_smtpsRelatedBoundary = null;

    /**
     * Alternative Boundary
     */
    public $_smtpsAlternativeBoundary = null;
     ...
     */
    public function _server_connect()
    {
     ...
     */
    public function _server_authenticate()
    {
     ...
     *
     */
    public function _buildAddrList( $_type, $_addrList )
    {
        // Pull existing list
     ...
     */
    public function _strip_email($_strAddr)
    {
        // Keep the orginal
     ...
     */
    public function _getBoundary($type='mixed')
    {
     ...
     * @return void
     */
    public function _setErr ( $_errNum, $_errMsg )
    {
