...
class Form
{
	 ...
	 * @param 	array<string|int,string|array{id:int|string,label:string,labelhtml:string,?color:string,?picto:string}>	$array 			Array(key=>value) or Array(key=>array('id'=>key, 'label'=>value, 'color'=> , 'picto'=> , 'labelhtml'=> ))
