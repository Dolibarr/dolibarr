...
abstract class CommonObject
{
     ...
     *    @return     int	>0 if OK, <0 if KO
     */
    public function delete_linked_contact()
    {
        $temp = array();
     ...
     */
    public function liste_contact($statut=-1,$source='external',$list=0)
    {
        global $langs;
     ...
     */
    public function liste_type_contact($source='internal', $order='code', $option=0)
    {
        global $langs;
     ...
     *		@return	int					<0 if KO, >0 if OK
     */
    public function fetchObjectFrom($table,$field,$key)
    {
        global $conf;
     ...
     *	@return	int					<0 if KO, >0 if OK
     */
    public function setValueFrom($field, $value, $table='', $id='', $format='text', $id_field='rowid')
    {
        global $conf;
     ...
     *	@return	int    			           	<0 if KO, >0 if OK
     */
    public function update_price($exclspec=0,$roundingadjust=-1,$nodatabaseupdate=0)
    {
     ...
     *	@return	void
     */
    public function fetchObjectLinked($sourceid='',$sourcetype='',$targetid='',$targettype='',$clause='OR')
    {
        global $conf;
     ...
     *	@return							int	>0 if OK, <0 if KO
     */
    public function updateObjectLinked($sourceid='', $sourcetype='', $targetid='', $targettype='')
    {
        $updatesource=false;
        $updatetarget=false;
     ...
     *	@return     int	>0 if OK, <0 if KO
     */
    public function deleteObjectLinked($sourceid='', $sourcetype='', $targetid='', $targettype='')
    {
        $deletesource=false;
        $deletetarget=false;
     ...
     *      @return int						<0 if KO, >0 if OK
     */
    public function setStatut($status,$elementId='',$elementType='')
    {
     ...
     *  @return	void
     */
    public function fetch_optionals($rowid,$optionsArray='')
    {
   ...
   /**
     ...
     * @return string
     */
    public function showOptionals($extrafields,$mode='view',$params=0)
    {
        global $_POST;
     ...
     */
    public function isObjectUsed($id)
    {
        // Check parameters
     ...
     *	@deprecated
     */
    public function formAddPredefinedProduct($dateSelector,$seller,$buyer)
    {
     ...
     *	@deprecated
     */
    public function formAddFreeProduct($dateSelector,$seller,$buyer)
    {
        global $conf,$langs,$object,$hookmanager;
        global $form,$bcnd,$var;
     ...
     *  @return	void
     */
    public function printOriginLinesList()
    {
     ...
     * 	@return	void
     */
    public function printOriginLine($line,$var)
    {
     ...
     */
    public function getMarginInfos($force_price=false)
    {
        global $conf;
     ...
     * @return void
     */
    public function displayMarginInfos($force_price=false)
    {
