...
function get_left_menu_projects($mainmenu, &$newmenu, $usemenuhider = 1, $leftmenu = 'none', $type_user = 0)
{
	...
	if ($mainmenu == 'project') {
		if (isModEnabled('projet')) {
			...
			} elseif (isset($conf->global->PROJECT_USE_OPPORTUNITIES) && getDolGlobalInt('PROJECT_USE_OPPORTUNITIES') == 1) {
			...
			} elseif (isset($conf->global->PROJECT_USE_OPPORTUNITIES) && getDolGlobalInt('PROJECT_USE_OPPORTUNITIES') == 2) {	// 2 = leads only
