...
function print_eldy_menu($db, $atarget, $type_user, &$tabMenu, &$menu, $noout = 0, $mode = '')
{
	...
	$menu_arr[] = array(
		...
		'id' => $id,
		'idsel' => 'home',
		'classname' =>  $classname = (!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "home") ? 'class="tmenusel"' : 'class="tmenu"',
		'prefix' => '<span class="fa fa-home fa-fw paddingright"></span>',
		'session' => ((!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "home") ? 0 : 1),
		'loadLangs' => array(),
		'submenus' => array(),
	);
	...
	$menu_arr[] = array(
		...
		'id' => $id,
		'idsel' => 'members',
		'classname' =>  $classname = (!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "members") ? 'class="tmenusel"' : 'class="tmenu"',
		'prefix' => img_picto('', 'member', 'class="fa-fw paddingright"'),
		'session' => ((!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "members") ? 0 : 1),
		'loadLangs' => array(),
		'submenus' => array(),
	);
	...
	$menu_arr[] = array(
		...
		'id' => $id,
		'idsel' => 'companies',
		'classname' =>  $classname = (!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "companies") ? 'class="tmenusel"' : 'class="tmenu"',
		'prefix' => img_picto('', 'company', 'class="fa-fw paddingright"'),
		'session' => ((!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "companies") ? 0 : 1),
	...
	$menu_arr[] = array(
		...
		'id' => $id,
		'idsel' => 'products',
		'classname' =>  $classname = (!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "products") ? 'class="tmenusel"' : 'class="tmenu"',
		'prefix' => img_picto('', 'product', 'class="fa-fw paddingright"'),
		'session' => ((!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "products") ? 0 : 1),
	...
	$menu_arr[] = array(
		...
		'id' => $id,
		'idsel' => 'mrp',
		'classname' =>  $classname = (!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "mrp") ? 'class="tmenusel"' : 'class="tmenu"',
		'prefix' => img_picto('', 'mrp', 'class="fa-fw paddingright"'),
		'session' => ((!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "mrp") ? 0 : 1),
		'loadLangs' => array("mrp"),
		'submenus' => array(),
	);
	...
	$menu_arr[] = array(
		...
		'id' => $id,
		'idsel' => 'project',
		'classname' =>  $classname = (!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "project") ? 'class="tmenusel"' : 'class="tmenu"',
		'prefix' => img_picto('', 'project', 'class="fa-fw paddingright"'),
		'session' => ((!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "project") ? 0 : 1),
	...
	$menu_arr[] = array(
		...
		'id' => $id,
		'idsel' => 'commercial',
		'classname' =>  $classname = (!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "commercial") ? 'class="tmenusel"' : 'class="tmenu"',
		'prefix' => img_picto('', 'contract', 'class="fa-fw paddingright"'),
		'session' => ((!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "commercial") ? 0 : 1),
	...
	$menu_arr[] = array(
		...
		'id' => $id,
		'idsel' => 'billing',
		'classname' =>  $classname = (!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "billing") ? 'class="tmenusel"' : 'class="tmenu"',
		'prefix' => img_picto('', 'bill', 'class="fa-fw paddingright"'),
		'session' => ((!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "billing") ? 0 : 1),
	...
	$menu_arr[] = array(
		...
		'id' => $id,
		'idsel' => 'bank',
		'classname' =>  $classname = (!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "bank") ? 'class="tmenusel"' : 'class="tmenu"',
		'prefix' => img_picto('', 'bank_account', 'class="fa-fw paddingright"'),
		'session' => ((!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "bank") ? 0 : 1),
	...
	$menu_arr[] = array(
		...
		'id' => $id,
		'idsel' => 'accountancy',
		'classname' =>  $classname = (!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "accountancy") ? 'class="tmenusel"' : 'class="tmenu"',
		'prefix' => img_picto('', 'accountancy', 'class="fa-fw paddingright"'),
		'session' => ((!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "accountancy") ? 0 : 1),
	...
	$menu_arr[] = array(
		...
		'id' => $id,
		'idsel' => 'hrm',
		'classname' =>  $classname = (!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "hrm") ? 'class="tmenusel"' : 'class="tmenu"',
		'prefix' => img_picto('', 'hrm', 'class="fa-fw paddingright"'),
		'session' => ((!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "hrm") ? 0 : 1),
	...
	$menu_arr[] = array(
		...
		'id' => $id,
		'idsel' => 'ticket',
		'classname' =>  $classname = (!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "ticket") ? 'class="tmenusel"' : 'class="tmenu"',
		'prefix' => img_picto('', 'ticket', 'class="fa-fw paddingright"'),
		'session' => ((!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "ticket") ? 0 : 1),
	...
	$menu_arr[] = array(
		...
		'id' => $id,
		'idsel' => 'tools',
		'classname' =>  $classname = (!isset($_SESSION["mainmenu"]) && $_SESSION["mainmenu"] == "tools") ? 'class="tmenusel"' : 'class="tmenu"',
