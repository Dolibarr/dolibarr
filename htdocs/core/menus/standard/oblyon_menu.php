...
/**
 *	\file       htdocs/core/menus/standard/oblyon_menu.php
...
class MenuManager
{
    ...
    function showmenu($mode)
    {
        ...
        require_once DOL_DOCUMENT_ROOT.'/core/menus/standard/oblyon.lib.php';
        ...
        //menus inversion//
        //now left menu 
        if ($mode == 'top')  $res=print_left_oblyon_menu($this->db,$this->menu_array,$this->menu_array_after,$this->tabMenu,$this->menu,0);
        //now top menu 
        if ($mode == 'left') $res=print_oblyon_menu($this->db,$this->atarget,$this->type_user,$this->tabMenu,$this->menu,0);
        if ($mode == 'jmobile')
        {
			// For jmobile menu, we do not invert menus
        	$res=print_oblyon_menu($this->db,$this->menu_array,$this->menu_array_after,$this->tabMenu,$this->menu,1);
        	...
        	foreach($this->menu->liste as $key => $val)		// $val['url','titre','level','enabled'=0|1|2,'target','mainmenu','leftmenu'
        	{
        		...
        		if ($val['enabled'] == 1)
        		{
	        		...
	        		$res=print_left_oblyon_menu($this->db,$this->menu_array,$this->menu_array_after,$this->tabMenu,$submenu,1,$tmpmainmenu,$tmpleftmenu);
