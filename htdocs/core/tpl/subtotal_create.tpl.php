...
if ($type == 'title') {
	...
	$formquestion = array_merge($formquestion, array(
		array('type' => 'other', 'name' => 'subtotallinedesc', 'label' => $langs->trans("SubtotalLineDesc"), 'value' => '<textarea class="width200" rows="3" name="subtotallinedesc" id="subtotallinedesc" placeholder="' . dol_escape_htmltag($langs->trans("Description")) . '"></textarea>'),
		array('type' => 'select', 'name' => 'subtotallinelevel', 'label' => $langs->trans("SubtotalLineLevel"), 'values' => $depth_array, 'default' => 1, 'select_show_empty' => 0, 'morecss' => 'minwidth100 marginbottomonly'),
