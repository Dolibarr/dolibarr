...
function commande_prepare_head(Commande $object)
{
	...
	if (isModEnabled('order') && $user->hasRight('commande', 'lire')) {
		$head[$h][0] = dolBuildUrl('/commande/card.php', ['id' => $object->id]);
	...
	if (!getDolGlobalString('MAIN_DISABLE_CONTACTS_TAB')) {
		...
		$head[$h][0] = dolBuildUrl('/commande/contact.php', ['id' => $object->id]);
	...
	if ((getDolGlobalInt('MAIN_SUBMODULE_EXPEDITION') && $user->hasRight('expedition', 'lire'))
		...
		$nbReceiption = 0;
		$head[$h][0] = dolBuildUrl('/expedition/shipment.php', ['id' => $object->id]);
		$text = '';
	...
	if (!getDolGlobalString('MAIN_DISABLE_NOTES_TAB')) {
		...
		$head[$h][0] = dolBuildUrl('/commande/note.php', ['id' => $object->id]);
	...
	$head[$h][0] = dolBuildUrl('/commande/document.php', ['id' => $object->id]);
	...
	$head[$h][0] = dolBuildUrl('/commande/agenda.php', ['id' => $object->id]);
...
function order_admin_prepare_head()
{
	...
	$head[$h][0] = dolBuildUrl('/admin/order.php');
	$head[$h][1] = $langs->trans("Miscellaneous");
	$head[$h][2] = 'general';
	$h++;

	$head[$h][0] = dolBuildUrl('/admin/order_pdf.php');
	...
	$head[$h][0] = dolBuildUrl('/admin/order_extrafields.php');
	...
	$head[$h][0] = dolBuildUrl('/admin/orderdet_extrafields.php');
