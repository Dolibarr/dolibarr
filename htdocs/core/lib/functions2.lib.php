...
function numero_semaine($time)
{
	...
	if ((int) date("w", dol_mktime(12, 0, 0, $mois, $jour, $annee)) == 0) { // Sunday
		$jeudiSemaine = dol_mktime(12, 0, 0, $mois, $jour, $annee) - 3 * 24 * 60 * 60;
	} elseif (date("w", dol_mktime(12, 0, 0, $mois, $jour, $annee)) < 4) { // Monday to Wednesday
		$jeudiSemaine = dol_mktime(12, 0, 0, $mois, $jour, $annee) + (4 - (int) date("w", dol_mktime(12, 0, 0, $mois, $jour, $annee))) * 24 * 60 * 60;
	} elseif ((int) date("w", dol_mktime(12, 0, 0, $mois, $jour, $annee)) > 4) { // Friday to Saturday
		$jeudiSemaine = dol_mktime(12, 0, 0, $mois, $jour, $annee) - ((int) date("w", dol_mktime(12, 0, 0, $mois, $jour, $annee)) - 4) * 24 * 60 * 60;
	} else { // Thursday
		$jeudiSemaine = dol_mktime(12, 0, 0, $mois, $jour, $annee);
	}

	// Definition of the first Thursday of the year
	if ((int) date("w", dol_mktime(12, 0, 0, 1, 1, (int) date("Y", $jeudiSemaine))) == 0) { // Sunday
		$premierJeudiAnnee = dol_mktime(12, 0, 0, 1, 1, (int) date("Y", $jeudiSemaine)) + 4 * 24 * 60 * 60;
	} elseif ((int) date("w", dol_mktime(12, 0, 0, 1, 1, (int) date("Y", $jeudiSemaine))) < 4) { // Monday to Wednesday
		$premierJeudiAnnee = dol_mktime(12, 0, 0, 1, 1, (int) date("Y", $jeudiSemaine)) + (4 - (int) date("w", dol_mktime(12, 0, 0, 1, 1, (int) date("Y", $jeudiSemaine)))) * 24 * 60 * 60;
	} elseif ((int) date("w", dol_mktime(12, 0, 0, 1, 1, (int) date("Y", $jeudiSemaine))) > 4) { // Friday to Saturday
		$premierJeudiAnnee = dol_mktime(12, 0, 0, 1, 1, (int) date("Y", $jeudiSemaine)) + (7 - ((int) date("w", dol_mktime(12, 0, 0, 1, 1, (int) date("Y", $jeudiSemaine))) - 4)) * 24 * 60 * 60;
	} else { // Thursday
		$premierJeudiAnnee = dol_mktime(12, 0, 0, 1, 1, (int) date("Y", $jeudiSemaine));
	}

	// Definition of the week number: nb of days between "first Thursday of the year" and "Thursday of the week"
	$numeroSemaine = (
		(
			(int) date("z", dol_mktime(12, 0, 0, (int) date("m", $jeudiSemaine), (int) date("d", $jeudiSemaine), (int) date("Y", $jeudiSemaine)))
		-
		(int) date("z", dol_mktime(12, 0, 0, (int) date("m", $premierJeudiAnnee), (int) date("d", $premierJeudiAnnee), (int) date("Y", $premierJeudiAnnee)))
		) / 7
	) + 1;
	...
	if ($numeroSemaine == 53) {
		...
		if (
			((int) date("w", dol_mktime(12, 0, 0, 1, 1, (int) date("Y", $jeudiSemaine))) == 4)
			|| (
				((int) date("w", dol_mktime(12, 0, 0, 1, 1, (int) date("Y", $jeudiSemaine))) == 3)
				&& ((int) date("z", dol_mktime(12, 0, 0, 12, 31, (int) date("Y", $jeudiSemaine))) == 365)
			)
		) {
			$numeroSemaine = 53;
		} else {
