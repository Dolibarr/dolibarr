...
function dol_get_fiche_head($links = array(), $active = '', $title = '', $notab = 0, $picto = '', $pictoisfullpath = 0, $morehtmlright = '', $morecss = '', $limittoshow = 0, $moretabssuffix = '')
{
	...
	if ($popuptab) {	// If there is some tabs not shown
		...
		$out .= '<div class="tab"><a href="#" class="tab moretab inline-block tabunactive"><span class="hideonsmartphone">'.$langs->trans("More").'</span><span class="badge marginleftonlyshort">'.$nbintab.'</span></a></div>'; // Do not use "reposition" class in the "More".
