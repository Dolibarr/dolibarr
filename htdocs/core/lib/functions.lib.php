...
function getElementProperties($element_type)
{
	...
	} elseif ($element_type == 'facturedet') {
		$classpath = 'compta/facture/class';
		$classfile = 'facture';
	...
	} elseif ($element_type == 'commandedet') {
		$classpath = 'commande/class';
		$classfile = 'commande';
		$classname = 'OrderLine';
		$module = 'commande';
	...
	} elseif ($element_type == 'shippingdet') {
		$classpath = 'expedition/class';
		$classfile = 'expedition';
	...
	} elseif ($element_type == 'facture_fourn_det') {
		$classpath = 'fourn/class';
		$module = 'fournisseur';
		$classfile = 'fournisseur.facture';
