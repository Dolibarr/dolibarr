...
function show_contacts($conf, $langs, $db, $object, $backtopage = '', $showuserlogin = 0)
{
	...
	$sql = "SELECT DISTINCT t.rowid, t.entity, t.lastname, t.firstname, t.fk_pays as country_id, t.civility, t.poste, t.phone as phone_pro, t.phone_mobile, t.phone_perso, t.fax, t.email, t.socialnetworks, t.statut, t.photo, t.fk_soc,";
