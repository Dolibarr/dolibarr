...
function contract_prepare_head(Contrat $object)
{
	...
	$head[$h][0] = dolBuildUrl('/contrat/card.php', ['id' => $object->id]);
	...
	if (!getDolGlobalString('MAIN_DISABLE_CONTACTS_TAB')) {
		...
		$head[$h][0] = dolBuildUrl('/contrat/contact.php', ['id' => $object->id]);
	...
	if (isModEnabled('ticket') && getDolGlobalString('TICKET_LINK_TO_CONTRACT_WITH_HARDLINK')) {
		$head[$h][0] = dolBuildUrl('/contrat/ticket.php', ['id' => $object->id]);
	...
	if (!getDolGlobalString('MAIN_DISABLE_NOTES_TAB')) {
		...
		$head[$h][0] = dolBuildUrl('/contrat/note.php', ['id' => $object->id]);
	...
	$head[$h][0] = dolBuildUrl('/contrat/document.php', ['id' => $object->id]);
...
function contract_admin_prepare_head()
{
	...
	$head[$h][0] = dolBuildUrl("/admin/contract.php");
	...
	$head[$h][0] = dolBuildUrl('/contrat/admin/contract_extrafields.php');
	...
	$head[$h][0] = dolBuildUrl('/contrat/admin/contractdet_extrafields.php');
