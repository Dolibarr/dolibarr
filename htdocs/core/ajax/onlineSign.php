...
if ($action == "importSignature") {
	...
	if ($issignatureok) {
		...
		if ($mode == "propale" || $mode == 'proposal') {
			...
			$upload_dir = !empty($conf->propal->multidir_output[$object->entity ?? 1]) ? $conf->propal->multidir_output[$object->entity ?? 1] : $conf->propal->dir_output;
			...
			$upload_dir = !empty($conf->contrat->multidir_output[$object->entity ?? 1]) ? $conf->contrat->multidir_output[$object->entity ?? 1] : $conf->contrat->dir_output;
			$upload_dir .= '/' . dol_sanitizeFileName($object->ref) . '/';
			...
			$upload_dir = !empty($conf->ficheinter->multidir_output[$object->entity ?? 1]) ? $conf->ficheinter->multidir_output[$object->entity ?? 1] : $conf->ficheinter->dir_output;
			$upload_dir .= '/'.dol_sanitizeFileName($object->ref).'/';
