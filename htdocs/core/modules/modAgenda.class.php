...
class modAgenda extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->cronjobs = array(
			...
			2 => array('label' => 'AutoCompleteElapsedEvents', 'jobtype' => 'method', 'class' => 'comm/action/class/actioncomm.class.php', 'objectname' => 'ActionComm', 'method' => 'autoCompleteElapsedEvents', 'parameters' => '', 'comment' => 'AutoCompleteElapsedEvents', 'frequency' => 5, 'unitfrequency' => 60, 'priority' => 10, 'status' => 1, 'test' => 'isModEnabled("agenda")', 'datestart' => $datestart),
		);
