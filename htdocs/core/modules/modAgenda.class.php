...
class modAgenda extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		$this->menu[$r]=array('fk_menu'=>'r=1',
													...
													'titre'=>'Agenda',
													'mainmenu'=>'agenda',
													'url'=>'/comm/action/index.php?action='.((empty($conf->global->AGENDA_DEFAULT_VIEW) || $conf->global->AGENDA_DEFAULT_VIEW!='show_list') ? $conf->global->AGENDA_DEFAULT_VIEW : 'show_month').'&amp;mainmenu=agenda&amp;leftmenu=agenda',
													'langs'=>'agenda',
													'position'=>140,
													'perms'=>'$user->rights->agenda->myactions->read',
													'enabled'=>'$conf->agenda->enabled',
		...
		$this->menu[$r]=array('fk_menu'=>'r=3',
													...
													'mainmenu'=>'agenda',
													'url'=>'/comm/action/index.php?action='.((empty($conf->global->AGENDA_DEFAULT_VIEW) || $conf->global->AGENDA_DEFAULT_VIEW!='show_list') ? $conf->global->AGENDA_DEFAULT_VIEW : 'show_month').'&amp;mainmenu=agenda&amp;leftmenu=agenda&amp;status=todo&amp;filter=mine',
													'langs'=>'agenda',
													'position'=>141,
													'perms'=>'$user->rights->agenda->myactions->read',
													'enabled'=>'$conf->agenda->enabled',
		...
		$this->menu[$r]=array('fk_menu'=>'r=3',
													...
													'mainmenu'=>'agenda',
													'url'=>'/comm/action/index.php?action='.((empty($conf->global->AGENDA_DEFAULT_VIEW) || $conf->global->AGENDA_DEFAULT_VIEW!='show_list') ? $conf->global->AGENDA_DEFAULT_VIEW : 'show_month').'&amp;mainmenu=agenda&amp;leftmenu=agenda&amp;status=done&amp;filter=mine',
													'langs'=>'agenda',
													'position'=>142,
													'perms'=>'$user->rights->agenda->myactions->read',
													'enabled'=>'$conf->agenda->enabled',
		...
		$this->menu[$r]=array('fk_menu'=>'r=3',
													...
													'mainmenu'=>'agenda',
													'url'=>'/comm/action/index.php?action='.((empty($conf->global->AGENDA_DEFAULT_VIEW) || $conf->global->AGENDA_DEFAULT_VIEW!='show_list') ? $conf->global->AGENDA_DEFAULT_VIEW : 'show_month').'&amp;mainmenu=agenda&amp;leftmenu=agenda&amp;status=todo&amp;filtert=-1',
													'langs'=>'agenda',
													'position'=>143,
		...
		$this->menu[$r]=array('fk_menu'=>'r=3',
													...
													'mainmenu'=>'agenda',
													'url'=>'/comm/action/index.php?action='.((empty($conf->global->AGENDA_DEFAULT_VIEW) || $conf->global->AGENDA_DEFAULT_VIEW!='show_list') ? $conf->global->AGENDA_DEFAULT_VIEW : 'show_month').'&amp;mainmenu=agenda&amp;leftmenu=agenda&amp;status=done&amp;filtert=-1',
													'langs'=>'agenda',
													'position'=>144,
													'perms'=>'$user->rights->agenda->allactions->read',
													'enabled'=>'$user->rights->agenda->allactions->read',
