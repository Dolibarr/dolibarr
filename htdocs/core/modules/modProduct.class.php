...
class modProduct extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		if (! empty($conf->productdluo->enabled)) $this->export_fields_array[$r]=array_merge($this->export_fields_array[$r],array('p.todluo'=>'OnDLUO'));
		...
		if (! empty($conf->productdluo->enabled)) $this->export_TypeFields_array[$r]=array_merge($this->export_TypeFields_array[$r],array('p.todluo'=>'Boolean'));
		...
		if (! empty($conf->productdluo->enabled)) $this->export_entities_array[$r]=array_merge($this->export_entities_array[$r],array('p.todluo'=>'product'));
		// Add extra fields
