...
class modAdherent extends DolibarrModules
{
    ...
    function __construct($db)
    {
        ...
        // $this->export_label[$r]         label par defaut si traduction de cle "ExportXXX" non trouvee (XXX = Code)
