...
class pdf_standardlabel
{
     ...
     * @return void
     */
    public function Add_PDF_card(&$pdf,$textleft,$header,$footer,$outputlangs,$textright='')
    {
     ...
     * @return void
     */
    public function _Pointille(&$pdf,$x1=0,$y1=0,$x2=210,$y2=297,$epaisseur=1,$nbPointilles=15)
    {
     ...
     * @return void
     */
    public function _Croix(&$pdf,$x1=0,$y1=0,$x2=210,$y2=297,$epaisseur=1,$taille=4)
    {
     ...
     * @return void
     */
    public function _Set_Format(&$pdf, $format)
    {
     ...
     */
    public function write_file($arrayofmembers,$outputlangs,$srctemplatepath,$outputdir='')
    {
