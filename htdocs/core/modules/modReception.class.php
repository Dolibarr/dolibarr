...
class modReception extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->export_fields_array[$r] = array(
			's.rowid'=>"IdCompany", 's.name'=>'ThirdParty', 's.address'=>'Address', 's.zip'=>'Zip', 's.town'=>'Town',
