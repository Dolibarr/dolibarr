 ...
 */
class pdf_couffignal extends ModelePDFPropales
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "couffignal";
		$this->description = "Module custom: Copie du modèle cyan, sans la référence client.";
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		*/
		...
		/* COUFFIGNAL SPECIAL - Pas de ref clients
