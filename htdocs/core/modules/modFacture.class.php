...
class modFacture extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->export_fields_array[$r] = array(
			's.rowid' => "IdCompany", 's.name' => 'CompanyName', 's.name_alias' => 'AliasNameShort', 'ps.name' => 'ParentCompany', 's.code_client' => 'CustomerCode', 's.address' => 'Address', 's.zip' => 'Zip', 's.town' => 'Town', 'c.code' => 'CountryCode', 'cd.nom' => 'State',
			's.phone' => 'Phone',
		...
		$this->export_TypeFields_array[$r] = array(
			's.rowid' => 'Numeric', 's.name' => 'Text', 's.name_alias' => 'Text', 'ps.name' => 'Text', 's.code_client' => 'Text', 's.address' => 'Text', 's.zip' => 'Text', 's.town' => 'Text', 'c.code' => 'Text', 'cd.nom' => 'Text', 's.phone' => 'Text', 's.siren' => 'Text',
		...
		$this->export_entities_array[$r] = array(
			's.rowid' => "company", 's.name' => 'company', 's.name_alias' => 'company', 'ps.name' => 'company', 's.code_client' => 'company', 's.address' => 'company', 's.zip' => 'company', 's.town' => 'company', 'c.code' => 'company', 'cd.nom' => 'company', 's.phone' => 'company',
		...
		$this->export_fields_array[$r] = array(
			's.rowid' => "IdCompany", 's.name' => 'CompanyName', 's.name_alias' => 'AliasNameShort', 's.code_client' => 'CustomerCode', 's.address' => 'Address', 's.zip' => 'Zip', 's.town' => 'Town', 'c.code' => 'CountryCode', 'cd.nom' => 'State',
			's.phone' => 'Phone',
		...
		$this->export_TypeFields_array[$r] = array(
			's.rowid' => 'Numeric', 's.name' => 'Text', 's.name_alias' => 'Text', 's.code_client' => 'Text', 's.address' => 'Text', 's.zip' => 'Text', 's.town' => 'Text', 'c.code' => 'Text', 'cd.nom' => 'Text', 's.phone' => 'Text', 's.siren' => 'Text',
			's.siret' => 'Text', 's.ape' => 'Text', 's.idprof4' => 'Text', 's.code_compta' => 'Text', 's.code_compta_fournisseur' => 'Text', 's.tva_intra' => 'Text',
			'f.rowid' => "Numeric", 'f.ref' => "Text", 'f.ref_client' => 'Text', 'f.fk_facture_source' => 'Numeric', 'f.type' => "Numeric", 'f.datec' => "Date", 'f.datef' => "Date", 'f.date_lim_reglement' => "Date",
			'f.fk_cond_reglement' => 'Numeric', 'f.fk_mode_reglement' => 'Numeric',
		...
		$this->export_entities_array[$r] = array(
			's.rowid' => "company", 's.name' => 'company', 's.name_alias' => 'company', 's.code_client' => 'company', 's.address' => 'company', 's.zip' => 'company', 's.town' => 'company', 'c.code' => 'company', 'cd.nom' => 'company', 's.phone' => 'company',
