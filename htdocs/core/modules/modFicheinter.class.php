...
class modFicheinter extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		$this->boxes = array();
		$r=0;
		$this->boxes[$r][1] = "box_fichinter.php";
		...
		$this->export_fields_array[$r]=array('s.rowid'=>"IdCompany",'s.nom'=>'CompanyName','s.address'=>'Address','s.zip'=>'Zip','s.town'=>'Town','s.fk_pays'=>'Country','s.phone'=>'Phone','s.siren'=>'ProfId1','s.siret'=>'ProfId2','s.ape'=>'ProfId3','s.idprof4'=>'ProfId4','s.code_compta'=>'CustomerAccountancyCode','s.code_compta_fournisseur'=>'SupplierAccountancyCode','f.fk_contrat'=>"ContratId",'f.fk_projet'=>"ProjetId",'f.rowid'=>"InterId",'f.ref'=>"InterRef",'f.datec'=>"InterDateCreation",'f.duree'=>"InterDuration",'f.fk_statut'=>'InterStatus','f.description'=>"InterNote",'f.datee'=>"DateEnd",'f.dateo'=>"DateOpen",'f.fulldayevent'=>"FullDayEvent",'f.total_ht'=>"InterTotalHT",'fd.rowid'=>'InterLineId','fd.date'=>"InterLineDate",'fd.duree'=>"InterLineDuration",'fd.description'=>"InterLineDesc",'fd.subprice'=>"InterLineSubprice");
	
		/// type de champs possible
		// Text / Numeric / Date / List:NomTable:ChampLib / Duree  / Boolean
		$this->export_TypeFields_array[$r]=array('s.rowid'=>"List:societe:nom",'s.nom'=>'Text','s.address'=>'Text','s.zip'=>'Text','s.town'=>'Text','s.fk_pays'=>'List:c_pays:libelle','s.phone'=>'Text','s.siren'=>'Text',
		's.siret'=>'Text','s.ape'=>'Text','s.idprof4'=>'Text','s.code_compta'=>'Text','s.code_compta_fournisseur'=>'Text',
		'f.fk_contrat'=>"List:contrat:ref",'f.fk_projet'=>"List:projet:title",
		'f.ref'=>"Text",'f.datec'=>"Date",'f.duree'=>"Duree",'f.fk_statut'=>'Statut','f.description'=>"Text",'f.datee'=>"Date",'f.dateo'=>"Date",'f.fulldayevent'=>"Boolean",'f.total_ht'=>"Numeric",
		'fd.date'=>"Date",'fd.duree'=>"Duree",'fd.description'=>"Text",'fd.subprice'=>"Numeric");

		$this->export_entities_array[$r]=array('s.rowid'=>"company",'s.nom'=>'company','s.address'=>'company','s.zip'=>'company','s.town'=>'company','s.fk_pays'=>'company','s.phone'=>'company','s.siren'=>'company','s.siret'=>'company','s.ape'=>'company','s.idprof4'=>'company','s.code_compta'=>'company','s.code_compta_fournisseur'=>'company',
		'f.rowid'=>"intervention",'f.ref'=>"intervention",'f.datec'=>"intervention",'f.duree'=>"intervention",'f.fk_statut'=>"intervention",'f.description'=>"intervention",'f.datee'=>"intervention",'f.dateo'=>"intervention",'f.fulldayevent'=>"intervention",'f.total_ht'=>"intervention",
		'fd.rowid'=>"inter_line",'fd.date'=>"inter_line",'fd.duree'=>'inter_line','fd.description'=>'inter_line','fd.subprice'=>'inter_line');
