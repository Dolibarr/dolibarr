...
class pdf_standard
{
     ...
     * @return void
     */
    public function Add_PDF_card(&$pdf,$textleft,$header,$footer,$outputlangs,$textright='',$idmember=0,$photomember='')
    {
     ...
     */
    public function write_file($arrayofmembers,$outputlangs,$srctemplatepath)
    {
