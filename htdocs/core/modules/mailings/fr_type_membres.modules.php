 ...
 * Copyright (C) 2015 Alain Rihs               <alainr@artisan-du-web.ch>
 *
...
/**
 *	\file       htdocs/core/modules/mailings/fr_type_membres.modules.php
 *	\ingroup    mailing
 ...
 */
class mailing_fr_type_membres extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='MembersTypes';
	// CHANGE THIS: Put here a description of your selector module.
	// This label is used if no translation found for key MailingModuleDescXXX where XXX=name is found
	var $desc="Adhérents avec email (par type de membre)";	// CHANGE THIS
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		$sql.= " FROM ".MAIN_DB_PREFIX."adherent_type as ta, ".MAIN_DB_PREFIX."adherent as a";
		$sql.= " WHERE a.email != '' AND a.fk_adherent_type = ta.rowid";
			...
			while ($i < $num)
			{
				...
				if ($old <> $obj->email)
				{
					$cibles[$j] = array(
								...
								($obj->libelle?$langs->transnoentities("MemberType").'='.$obj->libelle:''),
