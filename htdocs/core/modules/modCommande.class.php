...
class modCommande extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->export_fields_array[$r] = array(
			...
			'c.total_ttc'=>"TotalTTC", 'c.facture'=>"Billed", 'c.fk_statut'=>'Status', 'c.note_public'=>"Note", 'c.date_livraison'=>'DeliveryDate', 'sm.code'=>'SendingMethod',
		...
		$this->export_TypeFields_array[$r] = array(
			...
			'c.date_commande'=>"Date", 'c.date_livraison'=>"Date", 'sm.code'=>'Text', 'c.amount_ht'=>"Numeric", 'c.remise_percent'=>"Numeric", 'c.total_ht'=>"Numeric",
		...
		$this->export_entities_array[$r] = array(
			...
			'c.date_livraison'=>"order", 'sm.code'=>"order", 'pj.ref'=>'project', 'cd.rowid'=>'order_line', 'cd.label'=>"order_line", 'cd.description'=>"order_line",
