...
class modCommande extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->import_convertvalue_array[$r] = array(
			'c.ref' => array(
				'rule' => 'getrefifauto',
				'class' => (!getDolGlobalString('COMMANDE_ADDON') ? 'mod_bookkeepingargon' : $conf->global->COMMANDE_ADDON),
				'path' => "/core/modules/commande/".(!getDolGlobalString('COMMANDE_ADDON') ? 'mod_bookkeepingargon' : $conf->global->COMMANDE_ADDON).'.php',
