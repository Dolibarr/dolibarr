...
class modBookmark extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		$this->rights[$r][1] = 'Lire les bookmarks'; // label de la permission
		...
		$this->rights[$r][1] = 'Creer/modifier les bookmarks'; // label de la permission
		$this->rights[$r][2] = 'r'; // type de la permission (deprecie a ce jour)
		$this->rights[$r][3] = 1; // La permission est-elle une permission par defaut
		...
		$this->rights[$r][1] = 'Supprimer les bookmarks'; // label de la permission
