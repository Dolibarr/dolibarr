	...
	function __construct($db)
	{
        ...
        */
        ...
        $this->import_convertvalue_array[$r]=array(
            'aa.fk_accounting_category'=>array('rule'=>'fetchidfromcodeorlabel','classfile'=>'/core/class/caccountingcategory.class.php','class'=>'Caccountingcategory','method'=>'fetch','dict'=>'DictionaryAccountancyCategory'),
            'aa.account_parent'=>array('rule'=>'zeroifnull'),
		);
        $this->import_examplevalues_array[$r]=array('aa.fk_pcg_version'=>"PCG99-ABREGE",'aa.account_number'=>"707",'aa.label'=>"Ventes de marchandises",'aa.account_parent'=>"1407","aa.fk_accounting_category"=>"VENTES","aa.pcg_type"=>"PROD",'aa.pcg_subtype'=>'PRODUCT','aa.active'=>'1','aa.datec'=>"2017-04-28");
	}
}
