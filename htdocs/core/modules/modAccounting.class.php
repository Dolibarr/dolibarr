...
class modAccounting extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->import_convertvalue_array[$r]=array(
			'b.piece_num' => array('rule' => 'compute', 'classfile' => '/accountancy/class/accountancyimport.class.php', 'class' => 'AccountancyImport', 'method' => 'computePieceNum', 'element' => 'Accountancy'),
			'b.numero_compte'=>array('rule'=>'accountingaccount'),
			'b.subledger_account'=>array('rule'=>'accountingaccount'),
