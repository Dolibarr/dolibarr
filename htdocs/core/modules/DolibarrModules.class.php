...
abstract class DolibarrModules
{
     ...
     *  @return     int      		       	1 if OK, 0 if KO
     */
    public function _remove($array_sql, $options='')
    {
        global $langs;
        $err=0;
     ...
     */
    public function _load_tables($reldir)
    {
        global $db,$conf;
     ...
     */
    public function insert_permissions($reinitadminperms=0, $force_entity=null)
    {
        global $conf,$user;
