...
class modPaypal extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		/*$this->menu[$r]=array(
			...
			'position'=>501,
			'enabled'=>'isModEnabled("paypal")  && isModEnabled("bank") && $conf->global->MAIN_FEATURES_LEVEL >= 2',  // Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
