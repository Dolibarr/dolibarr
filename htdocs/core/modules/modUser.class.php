...
class modUser extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->export_TypeFields_array[$r] = array(
			...
			'u.email'=>'Text', 'u.datec'=>"Date", 'u.tms'=>"Date", 'u.admin'=>"Boolean", 'u.statut'=>'Status', 'u.note_private'=>"Text", 'u.signature'=>"Text", 'u.datelastlogin'=>'Date',
		...
		$this->export_entities_array[$r] = array(
			...
			'u.email'=>'user', 'u.note_private'=>"user", 'u.signature'=>'user',
		...
		$this->import_examplevalues_array[$r] = array(
			...
			'u.email'=>"test@mycompany.com", 'u.salary'=>"10000", 'u.note_private'=>"This is an example of note for record", 'u.datec'=>"2015-01-01 or 2015-01-01 12:30:00",
