...
class modUser extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->import_examplevalues_array[$r] = array(
			...
			'u.email'=>"test@mycompany.com", 'u.salary'=>"10000", 'u.note_public'=>"This is an example of a public note for record", 'u.note_private'=>"This is an example of a private note for record", 'u.datec'=>"2015-01-01 or 2015-01-01 12:30:00",
