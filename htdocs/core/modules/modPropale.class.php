...
class modPropale extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->export_fields_array[$r] = array(
			's.rowid'=>"IdCompany", 's.name'=>'CompanyName', 'ps.name'=>'ParentCompany', 's.code_client'=>'CustomerCode', 's.address'=>'Address', 's.zip'=>'Zip', 's.town'=>'Town', 'co.code'=>'CountryCode', 's.phone'=>'Phone',
		...
		//	's.rowid'=>"Numeric",'s.name'=>'Text','s.address'=>'Text','s.zip'=>'Text','s.town'=>'Text','co.code'=>'Text','s.phone'=>'Text',
		...
		//);
		$this->export_TypeFields_array[$r] = array(
			's.name'=>'Text', 'ps.name'=>'Text', 's.code_client'=>'Text', 's.address'=>'Text', 's.zip'=>'Text', 's.town'=>'Text', 'co.code'=>'Text', 's.phone'=>'Text', 's.siren'=>'Text', 's.siret'=>'Text',
		...
		$this->export_entities_array[$r] = array(
			's.rowid'=>"company", 's.name'=>'company', 'ps.name'=>'company', 's.code_client'=>'company', 's.address'=>'company', 's.zip'=>'company', 's.town'=>'company', 'co.code'=>'company', 's.phone'=>'company',
