...
class mod_facture_mercure extends ModeleNumRefFactures
{
	...
	public function info()
	{
		...
		$texte .= '<td class="right">'.$form->textwithpicto('<input type="text" class="flat minwidth175" name="maskinvoice" value="FACTURE_MERCURE_MASK_INVOICE">', $tooltip, 1, 1).'</td>';
		...
		$texte .= '<td class="right">'.$form->textwithpicto('<input type="text" class="flat minwidth175" name="maskreplacement" value="FACTURE_MERCURE_MASK_REPLACEMENT">', $tooltip, 1, 1).'</td>';
		$texte .= '</tr>';
