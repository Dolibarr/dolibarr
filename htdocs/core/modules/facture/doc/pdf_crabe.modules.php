	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		if ($conf->facture->dir_output) {
			...
			if (file_exists($dir)) {
				...
				// Add terms to sale
            	if (getDolGlobalString('MAIN_INFO_SOCIETE_TERMSOFSALE') && getDolGlobalInt('MAIN_PDF_ADD_TERMSOFSALE_INVOICE')) {
                    ...
                    if (!empty($conf->mycompany->multidir_output[$object->entity])) {
                    	$termsofsale = $conf->mycompany->multidir_output[$object->entity].'/'.$termsofsalefilename;
                    }
