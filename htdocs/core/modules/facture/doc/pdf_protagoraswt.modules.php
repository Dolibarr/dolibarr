...
/**
 *	\file       htdocs/core/modules/facture/doc/pdf_protagoraswt.modules.php
 *	\ingroup    facture
 *	\brief      File of class to generate customers invoices from protagoraswt model
 */
...
/**
 *	Class to generate the customer invoice PDF with template protagoraswt
 */
class pdf_protagoraswt extends ModelePDFFactures
{
    /**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "protagoraswt";
		$this->description = $langs->trans('PDFprotagoraswtDescription');
