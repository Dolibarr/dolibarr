...
/**
 *	\file       htdocs/core/modules/facture/doc/pdf_anaxagoras.modules.php
 *	\ingroup    facture
 *	\brief      File of class to generate customers invoices from anaxagoras model
 */
...
/**
 *	Class to generate the customer invoice PDF with template anaxagoras
 */
class pdf_anaxagoras extends ModelePDFFactures
{
    /**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "anaxagoras";
		$this->description = $langs->trans('PDFanaxagorasDescription');
