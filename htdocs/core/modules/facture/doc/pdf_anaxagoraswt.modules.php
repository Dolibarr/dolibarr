...
/**
 *	\file       htdocs/core/modules/facture/doc/pdf_anaxagoraswt.modules.php
 *	\ingroup    facture
 *	\brief      File of class to generate customers invoices from anaxagoraswt model
 */
...
/**
 *	Class to generate the customer invoice PDF with template anaxagoraswt
 */
class pdf_anaxagoraswt extends ModelePDFFactures
{
    /**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "anaxagoraswt";
		$this->description = $langs->trans('PDFanaxagoraswtDescription');
				...
				for ($i = 0; $i < $nblines; $i++)
				{
					...
					if (empty($conf->global->MAIN_GENERATE_DOCUMENTS_WITHOUT_VAT) && empty($conf->global->MAIN_GENERATE_DOCUMENTS_WITHOUT_VAT_COLUMN))
					{
					    ...
					    $pdf->SetXY($this->posxtva - 5, $curY);
                                            $pdf->MultiCell($this->posxdiscount - $this->posxtva + 4.9, 3, $vat_rate, 0, 'R');
					}
