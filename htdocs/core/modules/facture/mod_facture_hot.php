...
class mod_facture_hot extends ModeleNumRefFactures
{
	...
	public function info()
	{
		global $langs;
		$langs->load("bills");
		return $langs->trans('HandsOnNumRefModel', $this->prefixinvoice, $this->prefixcreditnote, $this->prefixdeposit);
	}
	...
	{
		return "RE2021-".$this->prefixinvoice."-0001";
	}
