	...
	public function __construct($db)
	{
		...
		$this->dictionaries = array(
			...
			'tabsql' => array(
				...
				'SELECT f.rowid as rowid, f.entity, f.code, f.pos, f.label, f.active, f.use_default, f.public, f.fk_parent,entity FROM '.MAIN_DB_PREFIX.'c_ticket_category as f',
			...
			'tabfieldinsert' => array("code,label,pos,use_default", "code,label,pos,use_default", "entity, code,label,pos,use_default,public,fk_parent,entity", "code,label,pos,use_default"),
