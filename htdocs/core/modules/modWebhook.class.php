...
class modWebhook extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		*/
		...
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'Read Trigger History'; // Permission label
		$this->rights[$r][4] = 'webhook_triggerhistory';
		$this->rights[$r][5] = 'read'; // In php code, permission will be checked by test if ($user->rights->webhook->webhook_triggerhistory->read)
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'Create/Update Trigger History'; // Permission label
		$this->rights[$r][4] = 'webhook_triggerhistory';
		$this->rights[$r][5] = 'write'; // In php code, permission will be checked by test if ($user->rights->webhook->webhook_triggerhistory->write)
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'Delete Trigger History'; // Permission label
		$this->rights[$r][4] = 'webhook_triggerhistory';
		$this->rights[$r][5] = 'delete'; // In php code, permission will be checked by test if ($user->rights->webhook->webhook_triggerhistory->delete)
		$r++;
