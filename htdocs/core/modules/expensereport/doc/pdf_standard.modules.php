...
class pdf_standard extends ModeleExpenseReport
{
	 ...
	 * @return  void
	 */
	public function printLine(&$pdf, $object, $linenumber, $curY, $default_font_size, $outputlangs, $hidedetails = 0)
	{
        global $conf;
        $pdf->SetFont('', '', $default_font_size - 1);
	 ...
	 */
	public function tablePayments(&$pdf, $object, $posy, $outputlangs)
	{
		global $conf;
