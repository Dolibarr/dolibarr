...
class modProjet extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		'p.rowid'=>"List:projet:ref",'p.ref'=>"Text",'p.label'=>"Text",'p.datec'=>"Date",'p.dateo'=>"Date",'p.datee'=>"Date",'p.fk_statut'=>'Status','cls.code'=>"Text",'p.opp_percent'=>'Numeric','p.description'=>"Text",
		...
		'p.rowid'=>"ProjectId",'p.ref'=>"RefProject",'p.label'=>'ProjectLabel', 'p.datec'=>"DateCreation",'p.dateo'=>"DateStart",'p.datee'=>"DateEnd",'p.fk_statut'=>'ProjectStatus','cls.code'=>'OpportunityStatus','p.opp_percent'=>'OpportunityProbability','p.description'=>"Description");
