...
/**
 *  \file       htdocs/core/modules/inventory/mod_inventory_standard.php
 *  \ingroup    stock
 *  \brief      File of class to manage Inventory numbering rules standard
 */
 ...
 */
class mod_inventory_standard extends ModeleNumRefInventory
{
	/**
	...
	public function canBeActivated($object)
	{
		...
		$sql .= " FROM ".MAIN_DB_PREFIX."inventory";
	...
	public function getNextValue($object)
	{
		...
		if ($resql) {
			...
			dol_syslog("mod_inventory_standard::getNextValue", LOG_DEBUG);
			return -1;
		}
		...
		dol_syslog("mod_inventory_standard::getNextValue return ".$this->prefix.$yymm."-".$num);
