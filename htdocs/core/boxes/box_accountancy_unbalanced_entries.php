...
/**
 *		\file       htdocs/core/boxes/box_accountancy_unbalanced_entries.php
 *		\ingroup    Accountancy
 *		\brief      Module to generated widget of unbalanced entries
 */
...
/**
 * Class to manage the box to show unbalanced entries
 */
class box_accountancy_unbalanced_entries extends ModeleBoxes
{
	public $boxcode = "accountancy_unbalanced_entries";
	public $boximg = "accounting";
	public $boxlabel = "BoxUnbalancedEntries";
		...
		if ($user->rights->accounting->mouvements->lire) {
			...
			if ($result) {
				...
				if ($num == 0) {
					...
					'td' => 'class="center"',
					'text'=> '<span class="opacitymedium">'.$langs->trans("NoRecordedUnbalancedEntries").'</span>'
					);
				}
