...
class box_contracts extends ModeleBoxes
{
	...
	public function loadBox($max = 5)
	{
		...
		$this->info_box_head = array(
			'text' => $langs->trans("BoxTitleLastContracts", $max).'<a class="paddingleft" href="'.DOL_URL_ROOT.'/contrat/list.php?sortfield=c.tms&sortorder=DESC"><span class="badge">...</span></a>'
		);
