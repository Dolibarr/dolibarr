...
class box_services_expired extends ModeleBoxes
{
	...
	public function loadBox($max = 5)
	{
		...
		if ($user->hasRight('contrat', 'lire')) {
			...
			$sql .= " s.name, s.rowid as socid, s.email, s.client, s.fournisseur, s.code_client, s.code_fournisseur, s.code_compta, s.code_compta_fournisseur,";
			...
			$sql .= " GROUP BY c.rowid, c.ref, c.statut, c.date_contrat, c.ref_customer, c.ref_supplier, s.name, s.rowid";
