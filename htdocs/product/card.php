...
else
{
    ...
    if ($action == 'create' && ($user->rights->produit->creer || $user->rights->service->creer))
    {
        ...
        // Label
        print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td colspan="3"><input name="label" size="60" maxlength="255" value="'.dol_escape_htmltag(GETPOST('label')).'"></td></tr>';
    ...
    else if ($object->id > 0)
    {
        ...
        if ($action == 'edit' &&  ((($object->type == Product::TYPE_PRODUCT && $user->rights->produit->creer) ||  ($object->type == Product::TYPE_SERVICE && $user->rights->service->creer))))
        {
            ...
            // Label
            print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td colspan="3"><input name="label" size="60" maxlength="255" value="'.dol_escape_htmltag($object->label).'"></td></tr>';
