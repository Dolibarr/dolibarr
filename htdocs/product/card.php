    ...
    else if ($object->id > 0)
    {
        ...
        else
		{
            ...
            if ($showbarcode)
            {
                ...
                print '<td>';
                if (($action != 'editbarcodetype') && ! empty($user->rights->barcode->creer_advance)) print '<td align="right"><a href="'.$_SERVER["PHP_SELF"].'?action=editbarcodetype&amp;id='.$object->id.'">'.img_edit($langs->trans('Edit'),1).'</a></td>';
                print '</tr></table>';
                ...
                print '<td>';
                if (($action != 'editbarcode') && ! empty($user->rights->barcode->creer_advance)) print '<td align="right"><a href="'.$_SERVER["PHP_SELF"].'?action=editbarcode&amp;id='.$object->id.'">'.img_edit($langs->trans('Edit'),1).'</a></td>';
                print '</tr></table>';
                print '</td><td colspan="2">';
