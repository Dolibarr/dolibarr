...
class StockMovements extends DolibarrApi
{
	 ...
	 * { "fk_product": 1, "warehouse_id": 1, "qty": 1, "lot": "", "movementcode": "INV123", "movementlabel": "Inventory 123", "price": 0 }
	 ...
	 *
	 * @param int $fk_product Id product id {@min 1} {@from body} {@required true}
	 ...
	 * @throws RestException
	 */
	public function post($fk_product, $warehouse_id, $qty, $type = 2, $lot = '', $movementcode = '', $movementlabel = '', $price = '', $datem = '', $dlc = '', $dluo = '', $origin_type = '', $origin_id = 0)
	{
		...
		if ($this->stockmovement->_create(DolibarrApiAccess::$user, $fk_product, $warehouse_id, $qty, $type, (float) $price, $movementlabel, $movementcode, $dateMvt, $eatBy, $sellBy, $lot) <= 0) {
