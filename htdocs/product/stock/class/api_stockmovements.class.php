...
class StockMovements extends DolibarrApi
{
	 ...
	 * @param	string	$movement_label	Movement label {@from body}
	 ...
	 * @throws RestException
	 */
	public function post($product_id, $warehouse_id, $qty, $type = 2, $batch = '', $movement_code = '', $movement_label = '', $price = '', $datem = '', $sellBy = '', $eatBy = '', $origin_type = '', $origin_id = 0)
	{
		...
		if ($this->stockmovement->_create(DolibarrApiAccess::$user, $product_id, $warehouse_id, $qty, $type, (float) $price, $movement_label, $movement_code, $dateMvt, $dluo, $dlc, $batch) <= 0) {
