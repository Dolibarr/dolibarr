...
class StockMovements extends DolibarrApi
{
	 ...
	 *
	 * { "product_id": 1, "warehouse_id": 1, "qty": 1, "batch": "", "inventorycode": "INV123", "label": "Inventory 123", "price": 0 }
	 ...
	 * @param	string	$inventorycode	Movement code {@from body}
	 ...
	 * @throws RestException
	 */
	public function post($product_id, $warehouse_id, $qty, $type = 2, $batch = '', $inventorycode = '', $label = '', $price = '', $datem = '', $sellBy = '', $eatBy = '', $origin_type = '', $origin_id = 0)
	{
		...
		if ($this->stockmovement->_create(DolibarrApiAccess::$user, $product_id, $warehouse_id, $qty, $type, (float) $price, $label, $inventorycode, $dateMvt, $dluo, $dlc, $batch) <= 0) {
