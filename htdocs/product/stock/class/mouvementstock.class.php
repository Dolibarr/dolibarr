...
class MouvementStock
{
     ...
     */
    public function _create($user, $fk_product, $entrepot_id, $qty, $type, $price=0, $label='', $datem='')
    {
        global $conf, $langs;
     ...
     */
    public function _createSubProduct($user, $idProduct, $entrepot_id, $qty, $type, $price=0, $label='')
    {
        $error = 0;
        $pids = array();
        $pqtys = array();
     ...
     * 	@return		int						<0 if KO, >0 if OK
     */
    public function livraison($user, $fk_product, $entrepot_id, $qty, $price=0, $label='', $datem='')
    {
     ...
     *	@return		int						<0 if KO, >0 if OK
     */
    public function reception($user, $fk_product, $entrepot_id, $qty, $price=0, $label='')
    {
     ...
     */
    public function nbOfSubProdcuts($id)
    {
        $nbSP=0;
