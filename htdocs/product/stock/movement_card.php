...
$usercandelete = (($user->rights->stock->movement->delete));
...
if (empty($reshook) && $action != 'remove_file')
{
    ...
    $permissiontodelete = $user->rights->stock->movement->delete;
...
if ($resql)
{
	...
	//if ($user->rights->stock->delete) $arrayofmassactions['predelete']='<span class="fa fa-trash paddingrightonly"></span>'.$langs->trans("Delete");
