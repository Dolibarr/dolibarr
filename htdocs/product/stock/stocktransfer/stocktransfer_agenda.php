...
if ($id > 0 || !empty($ref)) {
	$upload_dir = (!empty($conf->stocktransfer->multidir_output[$object->entity ?? 1]) ? $conf->stocktransfer->multidir_output[$object->entity ?? 1] : $conf->stocktransfer->dir_output)."/".$object->id;
}
