...
class FormProduct
{
     ...
     */
    public function loadWarehouses($fk_product=0)
    {
        global $conf, $langs;
     ...
     */
    public function selectWarehouses($selected='',$htmlname='idwarehouse',$filtertype='',$empty=0,$disabled=0,$fk_product=0,$empty_label='')
    {
        global $langs,$user;
