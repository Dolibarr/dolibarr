...
class Product extends CommonObject
{
	...
	public static function replaceThirdparty(DoliDB $dbs, $origin_id, $dest_id)
	{
		...
		$sql = ' DELETE FROM '.$dbs->prefix().'product_customer_price as p_old';
		$sql .= ' WHERE p_old.fk_soc = '.(int) $origin_id;
		$sql .= ' AND EXISTS (SELECT 1 FROM '.$dbs->prefix().'product_customer_price as p_new WHERE p_new.fk_product = p_old.fk_product AND p_new.fk_soc = '.(int) $dest_id.')';
