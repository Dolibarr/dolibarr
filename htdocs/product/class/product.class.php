...
class Product extends CommonObject
{
	...
	private function _log_price($user, $level = 0)
	{
		...
		// Add new price
		$sql = "INSERT INTO ".$this->db->prefix()."product_price(price_level,date_creation, fk_product, fk_user_author, price_label, price, price_ttc, price_base_type,tosell, tva_tx, default_vat_code, recuperableonly,";
