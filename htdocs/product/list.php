...
else
{
    ...
    if ($resql)
    {
    	...
    	else
    	{
    		...
    		if ($type == 0 && $user->rights->fournisseur->lire) print '<td class="liste_titre" align="right">'.$langs->trans("BuyingPriceMinShort").'</td>';
    		...
    		if ($type == 0 && $user->rights->fournisseur->lire) {
    			print '<td class="liste_titre">';
    			print '&nbsp;';
    			print '</td>';
    		}
