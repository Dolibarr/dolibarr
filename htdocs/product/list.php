...
if ($resql)
{
	...
	if ($massactionbutton)	print_liste_field_titre($form->showCheckAddButtons('checkforselect', 1), $_SERVER['PHP_SERVER'], '', '', '', 'align="center"', $sortfield, $sortorder); else	print '<td></td>';
	if (! empty($arrayfields['p.ref']['checked'])) {
