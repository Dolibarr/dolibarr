 ...
 *
 * @phpstan-param array{login:string,password:string,entity:?int,dolibarrkey:string} $authentication
 ...
 * @phpstan-return array{result:array{result_code:string,result_label:string}}
 */
