 ...
 * Copyright (C) 2025      Charlene Benke       <frederic.france@free.fr>
 *
...
if (!$mesg) {
	...
	$px1->SetYLabel($langs->trans("NbOfContract"));
	$px1->SetShading(3);
...
if (!$mesg) {
	...
	$px2->SetYLabel($langs->trans("NumberOfServices"));
	$px2->SetShading(3);
	$px2->SetHorizTickIncrement(1);
	$px2->mode = 'depth';
	$px2->SetTitle($langs->trans("NumberOfServicesByMonthHT"));
...
print '<table class="nobcontrat centpercent">';
