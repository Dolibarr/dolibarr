...
class Contrat extends CommonObject
{
     ...
     *  @return int             				<0 si erreur, >0 si ok
     */
    public function addline($desc, $pu_ht, $qty, $txtva, $txlocaltax1, $txlocaltax2, $fk_product, $remise_percent, $date_start, $date_end, $price_base_type='HT', $pu_ttc=0, $info_bits=0, $fk_fournprice=null, $pa_ht = 0)
    {
     ...
     *  @return int              				< 0 si erreur, > 0 si ok
     */
    public function updateline($rowid, $desc, $pu, $qty, $remise_percent, $date_start, $date_end, $tvatx, $localtax1tx=0, $localtax2tx=0, $date_debut_reel='', $date_fin_reel='', $price_base_type='HT', $info_bits=0, $fk_fournprice=null, $pa_ht = 0)
    {
     ...
     */
    public function deleteline($idline,$user)
    {
        global $conf, $langs;
...
class ContratLigne
{
     ...
     *  @return string      		Libelle
     */
    public function LibStatut($statut,$mode,$expired=-1)
    {
        global $langs;
        $langs->load("contracts");
        if ($mode == 0) {
