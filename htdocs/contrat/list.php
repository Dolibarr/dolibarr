...
$arrayfields = array(
	...
	'c.note_public' => array('label' => $langs->trans("NotePublic"), 'checked' => 0, 'position' => 520, 'enabled' => (!getDolGlobalInt('MAIN_LIST_HIDE_PUBLIC_NOTES'))),
	'c.note_private' => array('label' => $langs->trans("NotePrivate"), 'checked' => 0, 'position' => 521, 'enabled' => (!getDolGlobalInt('MAIN_LIST_HIDE_PRIVATE_NOTES'))),
