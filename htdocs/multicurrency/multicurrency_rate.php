...
if ($action!= "updateRate" && $action!= "deleteRate" ) {
	...
	print '<input type="submit" class="button" name="btnCreateCurrencyRate" value="' . $langs->trans('CreateRate') . '">';
	print '</td>';
...
if ($action == "updateRate"){
	...
	if ($current_rate) {
		...
		print '<input type="submit" class="button" name="btnupdateCurrencyRate" value="' . $langs->trans('UpdateRate') . '">';
