...
/**
 * API class for paymentsalaries
 *
 * @property DoliDB db
 * @access protected
 * @class DolibarrApiAccess {@requires user,external}
 */
class PaymentSalaries extends DolibarrApi
{
	/**
	...
	/**
	 * Get the list of paymentsalaries.
	 *
	...
	public function index($sortfield = "t.rowid", $sortorder = 'ASC', $limit = 100, $page = 0)
	{
		...
		$sql = "SELECT rowid FROM " . MAIN_DB_PREFIX . "payment_salary as t";
	...
	public function post($request_data = null)
	{
		...
		if (isModEnabled("banque")) $paymentsalary->addPaymentToBank(
