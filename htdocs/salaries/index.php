...
/**
 *  \file       htdocs/salaries/index.php
 *  \ingroup    salaries
...
if ($result)
{
	...
	{
		$newcardbutton='<a class="butActionNew" href="'.DOL_URL_ROOT.'/salaries/card.php?action=create"><span class="valignmiddle">'.$langs->trans('NewSalaryPayment').'</span>';
