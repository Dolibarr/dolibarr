...
$langs->loadLangs(array('companies', 'admin', 'salaries'));
...
$elementtype='salaries'; //Must be the $table_element of the class that manage extrafield
...
dol_fiche_head($head, 'attributes', $langs->trans("Salaries"), -1, 'payment');
