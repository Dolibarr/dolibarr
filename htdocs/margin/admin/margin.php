...
if (isset($conf->global->MARGIN_TYPE) && getDolGlobalString('MARGIN_TYPE') == '1') {
	print 'checked ';
}
print '/> ';
...
if (isset($conf->global->MARGIN_TYPE) && getDolGlobalString('MARGIN_TYPE') == 'pmp') {
	print 'checked ';
}
print '/> ';
...
if (isset($conf->global->MARGIN_TYPE) && getDolGlobalString('MARGIN_TYPE') == 'costprice') {
	print 'checked ';
}
print '/> ';
