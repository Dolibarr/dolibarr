...
/**
 *    \file       htdocs/employees/admin/public.php
 *		\ingroup    employee
 *		\brief      File of main public page for employee module
 */
...
if ($action == 'update')
{
	$public=GETPOST('EMPLOYEE_ENABLE_PUBLIC');

    $res=dolibarr_set_const($db, "EMPLOYEE_ENABLE_PUBLIC",$public,'chaine',0,'',$conf->entity);
...
dol_fiche_head($head, 'public', $langs->trans("Employee"), 0, 'user');
