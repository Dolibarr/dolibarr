...
if ($action == 'create') {
	...
	print '<td>';
	if (($action != 'editcurrency') && $user->rights->propal->creer) print '<td align="right"><a href="'.$_SERVER["PHP_SELF"].'?action=editcurrency&amp;id='.$object->id.'">'.img_edit($langs->trans('SetCurrency'),1).'</a></td>';
	print '</tr></table>';
	print '</td><td colspan="3">';
