...
if ($search_sale && $search_sale != '-1') {
	if ($search_sale == -2) {
		...
		$sql .= " AND EXISTS (SELECT sc.fk_soc FROM ".MAIN_DB_PREFIX."societe_commerciaux as sc WHERE a.fk_soc IS NULL OR ( sc.fk_soc = a.fk_soc AND sc.fk_user = ".((int) $search_sale)."))";
	}
}
// Search on socid
if ($socid > 0) {
