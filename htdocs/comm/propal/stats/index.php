...
if ($propal_commercial != '' && $propal_commercial >= 0) {
	$stats->join .= " INNER JOIN ".MAIN_DB_PREFIX.'societe_commerciaux AS scatgp ON scatgp.fk_soc=p.fk_soc';
	$stats->where .= " AND scatgp.fk_user=" . $propal_commercial;
}
