	...
	if ($resql)
	{
		...
		if ($num)
		{
			...
			while ($i < $num)
			{
				...
				print '<td class="nowrap">'.$propalstatic->getObjectUrl(1).'</td>';

				$companystatic->id=$obj->socid;
				$companystatic->name=$obj->socname;
				$companystatic->client=$obj->client;
				$companystatic->canvas=$obj->canvas;
				print '<td>'.$companystatic->getObjectUrl(1,'customer',24).'</td>';
	...
	if ($result)
	{
		...
		if ($num > 0)
		{
			...
			while ($i < $nbofloop)
			{
				...
				$companystatic->client=$obj->client;
				$companystatic->canvas=$obj->canvas;
				print '<td align="left">'.$companystatic->getObjectUrl(1,'customer',44).'</td>'."\n";
