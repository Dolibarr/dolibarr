...
class User extends CommonObject
{
	...
	var $pass;
	//! Mot de passe en clair en base (renseign� si DATABASE_PWD_ENCRYPTED=0)
	var $pass_indatabase;
	//! Mot de passe crypte en base (toujours renseign�)
	...
	var $tab_loaded=array();		// Tableau pour signaler les permissions deja charg�es
