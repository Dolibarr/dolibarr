...
} elseif ($action == 'setnote_public' && $user->rights->commande->creer) {
...
} elseif ($action == 'updateligne' && $user->rights->commande->creer && GETPOST('cancel') == $langs->trans('Cancel')) {
    header('Location: '.$_SERVER['PHP_SELF'].'?id='.$object->id);   // Pour reaffichage de la fiche en cours d'edition
    exit;
} elseif ($action == 'confirm_validate' && $confirm == 'yes' && $user->rights->commande->valider) {
...
} elseif ($action == 'confirm_cancel' && $confirm == 'yes' && $user->rights->commande->valider) {
    $idwarehouse=GETPOST('idwarehouse');
...
*/
    ...
    exit;
} elseif ($action == 'down' && $user->rights->commande->creer) {
    ...
    header('Location: '.$_SERVER["PHP_SELF"].'?id='.$object->id.'#'.GETPOST('rowid'));
    exit;
} elseif ($action == 'builddoc') {	// In get or post
    /*
