...
if ($action=='create')
{
	...
	print '<td>';
	$doleditor = new DolEditor('note_public', isset($note_public) ? $note_public : GETPOST('note_public','none'), '', 80, 'dolibarr_notes', 'In', 0, true, true, ROWS_3, '90%');
	...
	print '<td>';
	$doleditor = new DolEditor('note_private', isset($note_private) ? $note_private : GETPOST('note_private','none'), '', 80, 'dolibarr_notes', 'In', 0, true, true, ROWS_3, '90%');
	print $doleditor->Create(1);
	print '</td>';
