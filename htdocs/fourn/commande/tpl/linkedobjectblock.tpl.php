...
foreach ($linkedObjectBlock as $key => $objectlink) {
	...
	<tr class="<?php echo $trclass; ?>">
		...
		<td class="center">
			...
			<?php if (!empty($objectlink->delivery_date)) { ?>
			<br>
			<?php echo img_picto($langs->trans("DateDeliveryPlanned"), 'reception', 'class="pictofixedwidth"').dol_print_date($objectlink->delivery_date, 'day'); ?>
			<?php } ?>
		</td>
		<td class="right"><?php
