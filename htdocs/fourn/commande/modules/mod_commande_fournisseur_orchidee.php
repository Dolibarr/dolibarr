...
function info()
	...
	*/
    function getNextValue($objsoc=0,$commande='')
    {
        ...
        else if ($conf->global->COMMANDE_FOURNISSEUR_NUM_DELTA != '' && !eregi('^'.$this->searchLastWithPreviousYear.'',$previousyy))
        {
 ...
 /**		\brief      Construction de la matrice de numérotation
	...
	*/
    function buildMatrice($objsoc=0,$commande='')
    {
        ...
        $this->prefix  = $conf->global->COMMANDE_FOURNISSEUR_NUM_PREFIX;
        $this->matrice = $conf->global->COMMANDE_FOURNISSEUR_NUM_MATRICE;
        $this->searchLast = '';
