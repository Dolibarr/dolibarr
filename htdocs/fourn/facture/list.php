...
$search_paymentmode = GETPOST('search_paymentmode', 'int') ? GETPOST('search_paymentmode', 'int') : -1;
$search_paymentcond = GETPOST('search_paymentcond', 'int') ? GETPOST('search_paymentcond', 'int') : -1;
...
if (empty($reshook)) {
	...
	if (GETPOST('button_removefilter_x', 'alpha') || GETPOST('button_removefilter', 'alpha') || GETPOST('button_removefilter.x', 'alpha')) {		// All tests must be present to be compatible with all browsers
		...
		$search_status = '';
		$search_paymentmode = -1;
		$search_paymentcond = -1;
		$search_town = '';
		$search_zip = "";
		$search_state = "";
		$search_type = '';
