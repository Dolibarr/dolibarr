...
class FactureFournisseur extends CommonInvoice
{
	 ...
	 *	@param      string      $origin_type            type of origin object ('supplier_order', 'supplier_order_line', ...)
