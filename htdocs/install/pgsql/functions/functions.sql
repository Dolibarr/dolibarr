...
CREATE TRIGGER update_customer_modtime BEFORE UPDATE ON llx_expensereport_det_extrafields FOR EACH ROW EXECUTE PROCEDURE update_modified_column_tms();
...
CREATE TRIGGER update_customer_modtime BEFORE UPDATE ON llx_reception FOR EACH ROW EXECUTE PROCEDURE update_modified_column_tms();
