...
-- Use foreign key contraints for extrafields
...
ALTER TABLE llx_adherent_extrafields ADD CONSTRAINT fk_adherent FOREIGN KEY (fk_object) REFERENCES llx_adherent (rowid);
...
ALTER TABLE llx_asset_model_extrafields ADD CONSTRAINT fk_asset_model FOREIGN KEY (fk_object) REFERENCES llx_asset_model (rowid);
...
ALTER TABLE llx_bank_extrafields ADD CONSTRAINT fk_bank FOREIGN KEY (fk_object) REFERENCES llx_bank (rowid);
...
ALTER TABLE llx_commande_extrafields ADD CONSTRAINT fk_commande FOREIGN KEY (fk_object) REFERENCES llx_commande (rowid);
...
ALTER TABLE llx_commande_fournisseurdet_extrafields ADD CONSTRAINT fk_commande_fournisseurdet FOREIGN KEY (fk_object) REFERENCES llx_commande_fournisseurdet (rowid);
...
ALTER TABLE llx_contratdet_extrafields ADD CONSTRAINT fk_contratdet FOREIGN KEY (fk_object) REFERENCES llx_contratdet (rowid);
...
ALTER TABLE llx_delivery_extrafields ADD CONSTRAINT fk_delivery FOREIGN KEY (fk_object) REFERENCES llx_delivery (rowid);
...
ALTER TABLE llx_deliverydet_extrafields ADD CONSTRAINT fk_deliverydet FOREIGN KEY (fk_object) REFERENCES llx_deliverydet (rowid);
...
ALTER TABLE llx_ecm_directories_extrafields ADD CONSTRAINT fk_ecm_directories FOREIGN KEY (fk_object) REFERENCES llx_ecm_directories (rowid);
...
ALTER TABLE llx_eventorganization_conferenceorboothattendee_extrafields ADD CONSTRAINT fk_conferenceorboothattendee FOREIGN KEY (fk_object) REFERENCES llx_eventorganization_conferenceorboothattendee (rowid);
...
ALTER TABLE llx_expedition_extrafields ADD CONSTRAINT fk_expedition FOREIGN KEY (fk_object) REFERENCES llx_expedition (rowid);
...
ALTER TABLE llx_facture_extrafields ADD CONSTRAINT fk_facture FOREIGN KEY (fk_object) REFERENCES llx_facture (rowid);
...
ALTER TABLE llx_facture_fourn_det_extrafields ADD CONSTRAINT fk_facture_fourn_det FOREIGN KEY (fk_object) REFERENCES llx_facture_fourn_det (rowid);
...
ALTER TABLE llx_facture_fourn_det_rec_extrafields ADD CONSTRAINT fk_facture_fourn_det_rec FOREIGN KEY (fk_object) REFERENCES llx_facture_fourn_det_rec (rowid);
...
ALTER TABLE llx_facture_fourn_extrafields ADD CONSTRAINT fk_facture_fourn FOREIGN KEY (fk_object) REFERENCES llx_facture_fourn (rowid);
...
ALTER TABLE llx_facture_fourn_rec_extrafields ADD CONSTRAINT fk_facture_fourn_rec FOREIGN KEY (fk_object) REFERENCES llx_facture_fourn_rec (rowid);
...
ALTER TABLE llx_facture_rec_extrafields ADD CONSTRAINT fk_facture_rec FOREIGN KEY (fk_object) REFERENCES llx_facture_rec (rowid);
...
ALTER TABLE llx_facturedet_extrafields ADD CONSTRAINT fk_facturedet FOREIGN KEY (fk_object) REFERENCES llx_facturedet (rowid);
...
ALTER TABLE llx_hrm_evaluation_extrafields ADD CONSTRAINT fk_evaluation FOREIGN KEY (fk_object) REFERENCES llx_hrm_evaluation (rowid);
...
ALTER TABLE llx_hrm_skill_extrafields ADD CONSTRAINT fk_skill FOREIGN KEY (fk_object) REFERENCES llx_hrm_skill (rowid);
...
ALTER TABLE llx_inventory_extrafields ADD CONSTRAINT fk_inventory FOREIGN KEY (fk_object) REFERENCES llx_inventory (rowid);
...
ALTER TABLE llx_partnership_extrafields ADD CONSTRAINT fk_partnership FOREIGN KEY (fk_object) REFERENCES llx_partnership (rowid);
...
ALTER TABLE llx_product_extrafields ADD CONSTRAINT fk_product FOREIGN KEY (fk_object) REFERENCES llx_product (rowid);
...
ALTER TABLE llx_projet_task_extrafields ADD CONSTRAINT fk_projet_task FOREIGN KEY (fk_object) REFERENCES llx_projet_task (rowid);
...
ALTER TABLE llx_propal_extrafields ADD CONSTRAINT fk_propal FOREIGN KEY (fk_object) REFERENCES llx_propal (rowid);
...
ALTER TABLE llx_salary_extrafields ADD CONSTRAINT fk_salary FOREIGN KEY (fk_object) REFERENCES llx_salary (rowid);
...
ALTER TABLE llx_socpeople_extrafields ADD CONSTRAINT fk_socpeople FOREIGN KEY (fk_object) REFERENCES llx_socpeople (rowid);
...
ALTER TABLE llx_supplier_proposaldet_extrafields ADD CONSTRAINT fk_supplier_proposaldet FOREIGN KEY (fk_object) REFERENCES llx_supplier_proposaldet (rowid);
...
ALTER TABLE llx_ticket_extrafields ADD CONSTRAINT fk_ticket FOREIGN KEY (fk_object) REFERENCES llx_ticket (rowid);
...
ALTER TABLE llx_usergroup_extrafields ADD CONSTRAINT fk_usergroup FOREIGN KEY (fk_object) REFERENCES llx_usergroup (rowid);
