...
insert into llx_c_action_trigger (code,label,description,elementtype,rang) values ('USER_IBANMODIFY','User update','Executed when a user modify user IBAN','user',306);
