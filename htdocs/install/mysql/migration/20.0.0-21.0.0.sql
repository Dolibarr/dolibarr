...
UPDATE llx_c_units SET active=0 WHERE code='MO' AND short_label='m' AND unit_type='time';
UPDATE llx_c_units SET active=0 WHERE code='Y' AND short_label='y' AND unit_type='time';
