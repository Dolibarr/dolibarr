...
INSERT INTO llx_c_email_templates (entity, module, type_template, lang, private, fk_user, datec, label, position, enabled, active, topic, content, content_lines, joinfiles) VALUES (0, 'salaries', 'salary', '', 0, null, null, '(SalariesRhInformationsPreviousMonth)', 100,'isModEnabled("salaries")', 1, '__(SalariesRhInformationsPreviousMonthTopic)__', '__(SalariesRhInformationsPreviousMonthContent)__:<br>__ARRAY_EMPLOYEE_STARTDAY_ENDDAY_DAYS__', null, 0)
