...
ALTER TABLE llx_accounting_transaction_template_det ADD CONSTRAINT llx_accounting_transaction_template_det_fk_tt FOREIGN KEY (fk_transaction_template) REFERENCES llx_accounting_transaction_template(rowid);
