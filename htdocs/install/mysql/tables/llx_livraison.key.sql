...
-- obsolete ALTER TABLE llx_livraison ADD INDEX idx_livraison_fk_adresse_livraison (fk_adresse_livraison);
...
-- obsolete ALTER TABLE llx_livraison ADD CONSTRAINT fk_livraison_fk_adresse_livraison	FOREIGN KEY (fk_adresse_livraison)	REFERENCES llx_societe_address (rowid);
