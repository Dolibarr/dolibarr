...
-- Copyright (C) 2021-2022 Udo Tammm            <dev@dolibit.de>
--
...
(
  ...
  login            varchar(50),                 -- login / username
  ...
  fk_soc           integer NULL,                -- Third-party linked to member
  address          text,
  zip              varchar(30),
  town             varchar(50),
  state_id         integer,
  ...
  statut           smallint NOT NULL DEFAULT 0,   -- status / status / state of membership:  1 valid, 0 canceled, -1 draft, -2 excluded
  ...
  ip               varchar(250),                  -- IP-address used to create the record (for public membership submission page)
