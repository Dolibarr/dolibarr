...
(
  ...
  ref_client			varchar(255),							-- reference of invoice on customer side

  type					smallint DEFAULT 0 NOT NULL,			-- type of invoice (standard, credit note, ...)
  subtype				smallint DEFAULT NULL,					-- subtype of invoice (some countries need a subtype to classify invoices)
  fk_soc				integer            NOT NULL,			-- ID of thirdparty (customer)
  ...
  pos_print_counter     integer DEFAULT 0,						-- counter used to track how many times the invoice/receipt was downloaded or printed.
