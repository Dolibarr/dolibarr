...
--ALTER TABLE llx_webhook_history ADD UNIQUE INDEX uk_webhook_history_fieldxy(fieldx, fieldy);

--ALTER TABLE llx_webhook_history ADD CONSTRAINT llx_webhook_history_fk_field FOREIGN KEY (fk_field) REFERENCES llx_webhook_myotherobject(rowid);
