...
ALTER TABLE llx_societe ADD INDEX idx_societe_departement(fk_departement);
...
ALTER TABLE llx_societe ADD INDEX idx_societe_incoterms(fk_incoterms);
ALTER TABLE llx_societe ADD INDEX idx_societe_effectif(fk_effectif);
...
ALTER TABLE llx_societe ADD INDEX idx_societe_currency(fk_currency);
ALTER TABLE llx_societe ADD INDEX idx_societe_shipping_method(fk_shipping_method);
ALTER TABLE llx_societe ADD INDEX idx_societe_barcode_type(fk_barcode_type);
ALTER TABLE llx_societe ADD INDEX idx_societe_entrepot(fk_entrepot);
ALTER TABLE llx_societe ADD INDEX idx_societe_multicurrency(fk_multicurrency);
