...
(
  ...
  uid				char(36),						-- stable unique identifier (UUID) of the event, generated by dolibarr and kept even after the event is deleted (see llx_deletion_log). Not to be confused with ref_ext which is an id from an external system.
  ...
  registration_enabled smallint NOT NULL DEFAULT 0, -- Allow public registrations for this action
