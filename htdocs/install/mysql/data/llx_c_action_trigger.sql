...
insert into llx_c_action_trigger (code,label,description,elementtype,rang) values ('FICHINTER_SIGN','Intervention signed','Executed when a intervention is signed','ficheinter',31);
