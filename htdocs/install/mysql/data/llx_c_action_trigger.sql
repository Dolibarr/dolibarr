...
insert into llx_c_action_trigger (code,label,description,elementtype,rang) values ('ORDER_POST_VALIDATE','Post customer order validate','Executed after a customer order is validated','commande',4);
