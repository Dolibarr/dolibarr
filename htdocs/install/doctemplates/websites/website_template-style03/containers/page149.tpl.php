...
<meta name="dolibarr:pageid" content="149" />
...
<head>
	...
	<!-- Font Awesome -->
		...
		<link href="https://fonts.googleapis.com/css2?family=Anton&family=Inria+Sans:wght@700&display=swap" rel="stylesheet">
		<link href="https://fonts.googleapis.com/css2?family=Anton&family=Gulzar&family=Inria+Sans:wght@700&display=swap" rel="stylesheet"> 
				<script
			...
			<div class="container text-white">
				<div class="row flex text-center article">
					<div class="col-md-6">
						...
						<img
							src="/image/template03/article.png"
							width="50%"
							alt="article"
						/>
					</div>
...
<?php // BEGIN PHP
$tmp = ob_get_contents(); ob_end_clean(); dolWebsiteOutput($tmp, "html", 149);
// END PHP ?>
