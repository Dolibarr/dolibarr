...
<link href="/footer.php" rel="canonical" />
                  ...
                  <div class="col-md-6 col-lg-4 col-xl-4">
                    ...
                    <div class="group-sm group-middle">
                      ...
                      <ul class="list-inline">
                        <li><a class="icon icon-xxs-smallest" href="https://www.twitter.com/dolibarr/"><span class="fa fa-twitter" style="font-size: 1.6em"></span></a></li>
                        <li><a class="icon icon-xxs-smallest" href="https://www.facebook.com/dolibarr/"><span class="fa fa-facebook-f" style="margin-left: 5px; font-size: 1.6em"></span></a></li>
                      </ul>
                    </div>
                  </div>
                </div>
