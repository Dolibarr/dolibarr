...
<meta name="dolibarr:pageid" content="151" />
		...
		<main>
			<section class="hero">
								...
								<div class="carousel-inner">
									<div class="carousel-item active">
										<div class="carousel-image-wrap">
											<img
												src="image/template04/slide/jay-wennington-N_Y88TWmGwA-unsplash.jpg"
									...
									<div class="carousel-item">
										<div class="carousel-image-wrap">
											<img
												src="image/template04/slide/jason-leung-O67LZfeyYBk-unsplash.jpg"
												class="img-fluid carousel-image"
												alt=""
											/>
										</div>
									...
									<div class="carousel-item">
										<div class="carousel-image-wrap">
											<img
												src="image/template04/slide/ivan-torres-MQUqbmszGGM-unsplash.jpg"
												class="img-fluid carousel-image"
												alt=""
											/>
										</div>
				...
				<div class="video-wrap">
					...
					>
						<source
							src="image/template04/video/production_ID_3769033.mp4"
							type="video/mp4"
						/>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6 col-12">
							<div class="menu-thumb">
								<div class="menu-image-wrap">
									<img
										src="image/template04/lunch/farhad-ibrahimzade-MGKqxm6u2bc-unsplash.jpg"
										class="img-fluid menu-image"
										alt=""
									/>
						...
						<div class="col-lg-4 col-md-6 col-12">
							<div class="menu-thumb">
								<div class="menu-image-wrap">
									<img
										src="image/template04/lunch/farhad-ibrahimzade-D5c9ZciQy_I-unsplash.jpg"
										class="img-fluid menu-image"
										alt=""
									/>
						...
						<div class="booking">
							...
							>
								...
								<div class="col-lg-4 col-12 ms-auto">
									<button type="submit" class="form-control" onclick="() => 'define what reservation does'">
										Submit Request
									</button>
								</div>
							</form>
...
<?php // BEGIN PHP
$tmp = ob_get_contents(); ob_end_clean(); dolWebsiteOutput($tmp, "html", 151);
// END PHP ?>
