...
if ($_GET["socid"] && $_GET["action"] != 'edit')
{
    if (!$account->verif())
    {
        print '<div class="error"><b>Le contr�le de la cl� indique que les informations de ce compte bancaire sont incompl�tes ou incorrectes.</b></div><br>';
    }
    ...
    print '<tr><td>'.$langs->trans("RIB").'</td><td align="center">Code Banque</td><td align="center">Code Guichet</td><td align="center">Num�ro</td><td align="center">Cl� RIB</td></tr>';
    ...
    print '<tr><td valign="top">Nom propri�taire du compte</td><td colspan="4">';
    print $account->proprio;
    print "</td></tr>\n";

    print '<tr><td valign="top">Adresse propri�taire du compte</td><td colspan="4">';
...
if ($_GET["socid"] && $_GET["action"] == 'edit' && $user->rights->societe->creer)
{
    ...
    print '<tr><td>'.$langs->trans("RIB").'</td><td>Code Banque</td><td>Code Guichet</td><td>Num�ro</td><td>Cl� RIB</td></tr>';
