...
class Address
{
     ...
     */
    public function create($socid, $user='')
    {
        global $langs,$conf;
     ...
     */
    public function update($id, $socid, $user='')
    {
        global $langs;
     ...
     */
    public function fetch_lines($socid, $user=0)
    {
        global $langs, $conf;
     ...
     *  @return int 				>0 si ok, <0 si ko
     */
    public function fetch_address($id, $user=0)
    {
        global $langs;
        global $conf;
     ...
     *  @return	void
     */
    public function delete($id,$socid)
    {
