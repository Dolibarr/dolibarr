...
class Societe extends CommonObject
{
	 ...
	 */
	public function create(User $user, $call_trigger = 1)
	{
	 ...
	 */
	public function create_individual(User $user, $no_email = 0, $tags = array(), $call_trigger = 1)
	{
		global $conf;
		...
		$contactId = $contact->create($user, $call_trigger);
		if ($contactId < 0) {
			$error++;
