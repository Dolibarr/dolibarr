...
class Societe extends CommonObject
{
	...
	public $fields = array(
		...
		'date_birth' => array('type' => 'date', 'label' => 'CompnanyBirthDate', 'enabled' => 1, 'visible' => -1, 'position' => 182),
	...
	public function update($id, User $user, $call_trigger = 1, $allowmodcodeclient = 0, $allowmodcodefournisseur = 0, $action = 'update', $nosyncmember = 1)
	{
		...
		if ($result >= 0) {
			...
			$sql .= ",date_birth = ".(!empty($this->date_birth) ? "'".$this->db->idate($this->date_birth)."'" : "null");
