...
/**
 *  \file       htdocs/eventorganization/conferenceorboothattendee_agenda.php
...
if (isset($attendeestatic->fk_project)) {
	...
	if ($projectfetchresult < 0) {
		dol_syslog('Can not find attendeestatic->fk_project='.$attendeestatic->fk_project, LOG_ERR);
		// Not sure this is the best way
		accessforbidden($langs->trans("ErrorObjectNotFound", $langs->trans("Project")));
	}
}
