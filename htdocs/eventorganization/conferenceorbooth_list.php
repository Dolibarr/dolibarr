...
if ($projectid > 0) {
	...
	$message .= "&project=".$projectid.'&module='.urlencode('project@eventorganization').'&status='.ConferenceOrBooth::STATUS_CONFIRMED.'">'.$langs->trans('DownloadICSLink').img_picto('', 'download', 'class="paddingleft"').'</a>';
	print $message;
	print "</td></tr>";
