...
class ConferenceOrBoothAttendee extends CommonObject
{
	...
	// idea with STATUS_BOARDINGPASS is to at that generation ask them when they arrive and use that to door staffing
	...
	public function use($user, $notrigger = 0)
	{
		...
		return $this->setStatusCommon($user, self::STATUS_USED, $notrigger, 'CONFERENCEORBOOTHATTENDEE_USED');
	}
