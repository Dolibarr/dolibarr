...
class ConferenceOrBooth extends ActionComm
{
	...
	public $fields = array(
		...
		'fk_action' => array('type'=>"sellist:c_actioncomm:libelle:id::module LIKE '%@eventorganization'", 'label'=>'Format', 'enabled'=>'1', 'position'=>60, 'notnull'=>1, 'visible'=>1, 'css'=>'width100', 'csslist'=>'tdoverflowmax100 maxwidth75'),
