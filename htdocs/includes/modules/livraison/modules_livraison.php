...
/**
 ...
 \brief      Classe mï¿½re des modï¿½les de bon de livraison
 */
class ModelePDFDeliveryOrder extends FPDF
{
	...
	/**
	 \brief Renvoi le dernier message d'erreur de crï¿½ation de PDF de bon de livraison
	 */
	function pdferror()
	{
		return $this->error;
...
/**
 ...
 \brief      Classe mï¿½re des modï¿½les de numï¿½rotation des rï¿½fï¿½rences de bon de livraison
 */
