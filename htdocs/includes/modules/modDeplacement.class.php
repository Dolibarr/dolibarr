...
class modDeplacement extends DolibarrModules
{
  ...
  function modDeplacement($DB)
  {
    ...
    $this->name = "D�placement et frais";                        			// Si traduction Module75Name non trouv�e
    $this->description = "Gestion des notes de frais et d�placements";		// Si traduction Module75Desc non trouv�e
