...
$cryptwidth  = 110;  // Largeur du cryptogramme (en pixels)
...
$charanglemax  = 8;     // Angle maximum de rotation des caracteres (0-360)
...
$noisepxmin = 400;      // Bruit: Nb minimum de pixels aléatoires
$noisepxmax = 400;      // Bruit: Nb maximum de pixels aléatoires
...
$cryptusetimer = 1;        // Temps (en seconde) avant d'avoir le droit de regénérer un cryptogramme
