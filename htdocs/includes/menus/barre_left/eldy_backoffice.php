			...
			*/
			if ($mainmenu == 'home')
			{
				...
				if ($user->admin)
				{
					...
					if ($leftmenu=="admintools") $newmenu->add_submenu(DOL_URL_ROOT."/support/index.php", $langs->trans("HelpCenter"),1,1,'targethelp');
				}
			...
			*/
			if ($mainmenu == 'agenda')
			{
				...
				if ($conf->agenda->enabled)
				{
					...
					$newmenu->add_submenu(DOL_URL_ROOT."/comm/action/fiche.php?mainmenu=agenda&amp;leftmenu=agenda&amp;action=create", $langs->trans("NewAction"), 1, ($user->rights->agenda->myactions->create||$user->rights->agenda->allactions->create));
					// Calendar
					...
					// Reports
					$newmenu->add_submenu(DOL_URL_ROOT."/comm/action/rapport/index.php?mainmenu=agenda&amp;leftmenu=agenda", $langs->trans("Reportings"), 1, $user->rights->agenda->allactions->read);
				}
			}
