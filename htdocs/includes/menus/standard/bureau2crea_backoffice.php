...
/**
 *	\file       htdocs/includes/menus/standard/bureau2crea_backoffice.php
...
class MenuLeft {
    ...
    var $require_top=array("bureau2crea_backoffice");     // Si doit etre en phase avec un gestionnaire de menu du haut particulier
