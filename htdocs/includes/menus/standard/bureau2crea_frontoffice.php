...
/**
 *	\file       htdocs/includes/menus/standard/bureau2crea_frontoffice.php
...
class MenuTop {
	...
	var $require_left=array("bureau2crea_backoffice");	// Si doit etre en phase avec un gestionnaire de menu gauche particulier
	...
	function showmenu()
	{
		require_once(DOL_DOCUMENT_ROOT.'/includes/menus/standard/bureau2crea.lib.php');

		print_bureau2crea_menu($this->db,$this->atarget,$this->hideifnotallowed);
	}
...
class MenuLeft {
    ...
    var $require_top=array("bureau2crea_frontoffice");     // Si doit etre en phase avec un gestionnaire de menu du haut particulier
    ...
    function showmenu()
    {
        ...
        $res=print_left_bureau2crea_menu($this->db,$this->menu_array,$this->menu_array_after);
