...
/**
 * \file    test/phpunit/DocumentsFunctionalityFunctionalTest.php
...
/**
 * Class DocumentsFunctionalityFunctionalTest
 *
 ...
 *
 * @package Testdocumentsfunctionality
 */
class DocumentsFunctionalityFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modDocumentsFunctionality')->click();
		} else {
			// Disable the module
			$this->byHref('modDocumentsFunctionality')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/documentsfunctionality/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('documentsfunctionality/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/documentsfunctionality/admin/about.php');
		$this->authenticate();
		return $this->assertContains('documentsfunctionality/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('documentsfunctionalitywidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDocumentsFunctionality_DocumentsFunctionalityTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDocumentsFunctionality_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
