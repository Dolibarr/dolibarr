...
/**
 * \file    leavelist/lib/leavelist_myobject.lib.php
 * \ingroup leavelist
...
function myobjectPrepareHead($object)
{
	...
	$head[$h][0] = dol_buildpath("/leavelist/myobject_card.php", 1).'?id='.$object->id;
	...
	if (isset($object->fields['note_public']) || isset($object->fields['note_private'])) {
		...
		$head[$h][0] = dol_buildpath('/leavelist/myobject_note.php', 1).'?id='.$object->id;
	...
	$head[$h][0] = dol_buildpath("/leavelist/myobject_agenda.php", 1).'?id='.$object->id;
	...
	//	'entity:-tabname:Title:@leavelist:/leavelist/mypage.php?id=__ID__'
	//); // to remove a tab
	complete_head_from_modules($conf, $langs, $object, $head, $h, 'myobject@leavelist');
