...
/**
 * \file    modulebuilder/template/core/boxes/leavelistwidget1.php
 * \ingroup leavelist
 * \brief   Widget provided by LeaveList
 *
 ...
 */
class leavelistwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "leavelistbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "leavelist@leavelist";
	 ...
	 */
	public $depends = array('leavelist');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->leavelist->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/leavelist/class/leavelist.class.php";

		// Populate the head at runtime
		$text = $langs->trans("LeaveListBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_leavelist@leavelist',
