...
class Form
{
  ...
  */
  ...
  /**
		...
		\param	tooltipon			1=tooltip sur texte, 2=tooltip sur picto, 3=tooltip sur les 2, 4=tooltip sur les 2 et forc� en Ajaxa
  ...
  */
  ...
  return $s;
	...
	/**
     ...
     \param		direction			1=Le picto est apr�s, -1=le picto est avant
  ...
  function select_region($selected='',$htmlname='region_id')
  {
	...
	*/
	 ...
	 *    \param     selected         Id ou code pays pr�-s�lectionn�
	 *    \param     htmlname         Nom de la liste deroulante
	...
	function select_societes($selected='',$htmlname='socid',$filter='',$showempty=0)
  {
     ...
     *    \param      htmlname        Nom champ formulaire
     *    \param      show_empty      0=liste sans valeur nulle, 1=ajoute valeur inconnue
     *    \param      exclude         Liste des id utilisateurs � exclure
     */
  ...
  */
  function select_produits($selected='',$htmlname='productid',$filtretype='',$limit=20,$price_level=0)
  {
	...
	*/
	function select_produits_do($selected='',$htmlname='productid',$filtretype='',$limit=20,$price_level=0,$ajaxkeysearch='')
	{
		...
		// Multilang : on construit une liste des traductions des produits list�s
	...
	*/
    ...
    function load_cache_conditions_paiements()
    {
        ...
        if (sizeof($this->cache_conditions_paiements_code)) return 0;    // Cache d�ja charg�
    ...
    function load_cache_types_paiements()
    {
        ...
        if (sizeof($this->cache_types_paiements_code)) return 0;    // Cache d�ja charg�
     ...
     *		\param		addempty		Ajoute entr�e vide
     */
    ...
    /**
     *    \brief      Retourne la liste d�roulante des diff�rents �tats d'une propal.
     *                Les valeurs de la liste sont les id de la table c_propalst
     *    \param      selected    etat pre-s�l�ctionn�
     */
     ...
     *    \param      selected          Id compte pr�s�lectionn�
     *    \param      htmlname          Nom de la zone select
     *    \param      statut            Statut des comptes recherch�s
    ...
    /**
     *    \brief      Retourne le nom traduit de la civilit�
     *    \param      code        Code de la civilit�
   ...
   function currency_name($code_iso,$withcode=0)
    {
        ...
        // Si il existe une traduction, on peut renvoyer de suite le libell�
        if ($langs->trans("Currency".$code_iso)!="Currency".$code_iso)
        {
            return $langs->trans("Currency".$code_iso);
        }
        
        // Si pas de traduction, on consulte libell� par d�faut en table
  ...
  function form_confirm($page, $title, $question, $action, $formquestion='')
  {
     ...
     *    \param      page        Page
     *    \param      selected    Id mode pr�s�lectionn�
     *    \param      htmlname    Nom du formulaire select
     */
     ...
     *    	\param      selected    	Id condition pr�s�lectionn�e
     *    	\param      htmlname    	Nom du formulaire select
     *		\param		origin        	Origine de l'appel pour pouvoir cr�er un retour
     ...
     *    \param     selected    code devise pr�-s�lectionn�e
     *    \param     htmlname    nom de la liste deroulante
     *    \todo      trier liste sur noms apr�s traduction plutot que avant
     */
    ...
    /**
     *      \brief      Selection du taux de tva appliqu� par vendeur
      ...
      else
	{
      ...
      // D�finition du taux � pr�s�lectionner
      if ($defaulttx == '') $defaulttx=get_default_tva($societe_vendeuse,$societe_acheteuse,$taux_produit);
      // Si taux par defaut n'a pu etre trouv�, on prend dernier.
      // Comme ils sont tri�s par ordre croissant, dernier = plus �lev� = taux courant
    ...
    */
    ...
    /**
     *    \brief  Renvoie la cha�ne de caract�re d�crivant l'erreur
     */
    function error()
    {
        return $this->error;
  ...
  /**
   *    \brief      Affiche la cartouche g�n�rique d'un rapport
   ...
   *    \param      builddate       Date g�n�ration 
  ...
  function report_header($nom,$variante='',$period,$periodlink,$description,$builddate,$exportlink)
  {
    ...
    function show_documents($modulepart,$filename,$filedir,$urlsource,$genallowed,$delallowed=0,$modelselected='',$modelliste=array(),$forcenomultilang=0,$iconPDF=0)
    {
      ...
      if (eregi('\-detail\.pdf',$file["name"])) $mimetype='PDF D�taill�';
	 ...
	 *    Todo : ajouter une v�rification de d�sactivation du code barre si il est d�j� utilis� dans un module
	 */
