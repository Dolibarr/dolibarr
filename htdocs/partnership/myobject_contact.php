...
/**
 *  \file       partnership/myobject_contact.php
 *  \ingroup    partnership
...
dol_include_once('/partnership/class/myobject.class.php');
dol_include_once('/partnership/lib/partnership_myobject.lib.php');
...
$permission = $user->rights->partnership->myobject->write;
...
if ($object->id) {
	...
	$linkback = '<a href="'.dol_buildpath('/partnership/myobject_list.php', 1).'?restore_lastsearch_values=1'.(!empty($socid) ? '&socid='.$socid : '').'">'.$langs->trans("BackToList").'</a>';
