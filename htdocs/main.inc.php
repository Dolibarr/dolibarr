...
function top_httphead($contenttype = 'text/html', $forcenocache = 0)
{
	...
	// Default browser are 'strict-origin-when-cross-origin' (only domain is sent on other domain switching), we want more so we use 'same-origin' so borwser doesn't send any referrer when going into another web site domain.
