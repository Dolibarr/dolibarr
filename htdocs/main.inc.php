	...
	if (empty($disablehead)) {
		...
		if (!defined('DISABLE_JQUERY') && !$disablejs && !empty($conf->use_javascript_ajax)) {
			...
			if (getDolGlobalString('MAIN_USE_JQUERY_JEDITABLE') && !defined('DISABLE_JQUERY_JEDITABLE')) {
				...
				print '<script nonce="'.getNonce().'" src="'.DOL_URL_ROOT.'/includes/jquery/plugins/jeditable/dist/jquery.jeditable.min.js'.($ext ? '?'.$ext : '').'"></script>'."\n";
				print '<script nonce="'.getNonce().'" src="'.DOL_URL_ROOT.'/includes/jquery/plugins/jeditable/dist/jquery.jeditable.datepicker.min.js'.($ext ? '?'.$ext : '').'"></script>'."\n";
				...
				print '<script nonce="'.getNonce().'" src="'.DOL_URL_ROOT.'/core/js/editinplace.js.php'.($ext ? '?'.$ext : '').'"></script>'."\n";
