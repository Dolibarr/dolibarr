...
function top_menu_user($hideloginname = 0, $urllogout = '')
{
	...
	if (!empty($user->photo)) {
		...
		if (isModEnabled('gravatar')) {
			...
			$userDropDownImage = '<img class="photo photouserphoto userphoto" alt="" src="https://www.gravatar.com/avatar/' . $hash . '?d=404" onerror="this.onerror=null;this.src=\''.DOL_URL_ROOT.$nophoto.'\';" aria-hidden="true">';
		} else {
