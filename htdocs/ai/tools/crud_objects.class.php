...
class ToolCrudObjects extends McpTool
{
    ...
    public function getDefinitions(): array
    {
        return [
            ...
            [
                ...
                "description" => "Create a CUSTOMER SALES ORDER. This is specifically for creating ORDERS that customers place with you. " .
                    "USE THIS TOOL whenever user mentions: 'order', 'sales order', 'customer order', 'new order'. " .
                    "This is NOT for invoices or supplier orders. " .
            ...
            [
                ...
                "description" => "Create a customer invoice (bill)." .
                    "Do NOT use this for orders - use create_sales_order instead. " .
                    "Do NOT use this for payments - use pay_invoice instead. " .
                    "Examples: 'create invoice for customer X', 'bill customer Y'",
                "inputSchema" => [
                    "type" => "object",
                    "properties" => [
                        "object_type" => [
            ...
            [
                ...
                "description" => "Create documents other than orders and invoices. " .
                    "Use this for: 'proposal', 'supplier_order', 'supplier_invoice', 'supplier_proposal'. " .
                    "DO NOT use for 'order' or 'invoice' - they have dedicated tools.",
                "inputSchema" => [
                    "type" => "object",
                    "properties" => [
                        "object_type" => [
    ...
    /**
     * Entry point for the 'add_line_item' tool. Adds line to already existing object.
     ...
     *          } $args   Tool arguments.
     *
     * @return  array{success: bool, line_id?: int, error?: string} Result.
     */
