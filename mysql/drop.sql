...
drop table if exists llx_cash_account;
drop table if exists llx_contrat_service;
drop table if exists llx_telephonie_client_statistique;
drop table if exists llx_telephonie_client_stats;
drop table if exists llx_telephonie_client_stats_mensuel;
drop table if exists llx_telephonie_commande;
drop table if exists llx_telephonie_commande_retour;
drop table if exists llx_telephonie_communications_details;
drop table if exists llx_telephonie_concurrents;
drop table if exists llx_telephonie_contact_facture;
drop table if exists llx_telephonie_contrat;
drop table if exists llx_telephonie_contrat_contact_facture;
drop table if exists llx_telephonie_facture;
drop table if exists llx_telephonie_fournisseur;
drop table if exists llx_telephonie_groupe_ligne;
drop table if exists llx_telephonie_groupeligne;
drop table if exists llx_telephonie_import_cdr;
drop table if exists llx_telephonie_ligne_statistique;
drop table if exists llx_telephonie_prefix;
drop table if exists llx_telephonie_service;
drop table if exists llx_telephonie_simul;
drop table if exists llx_telephonie_simul_comm;
drop table if exists llx_telephonie_societe_ligne;
drop table if exists llx_telephonie_societe_ligne_remise;
drop table if exists llx_telephonie_societe_ligne_statut;
