...
-- Comment? car semble d?j? pr?sent dans la base 1.1.0
...
update llx_cond_reglement set code='RECEP' where libelle='A r?ception' and code IS NULL;
...
-- pour virer les doublons de llx_bank_url (dus ? un ancien bug)
