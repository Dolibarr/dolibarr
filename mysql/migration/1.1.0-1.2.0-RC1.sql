...
insert into llx_c_pays (rowid,lang,libelle,code) values (1,  'fr_FR', 'France',          'FR');
insert into llx_c_pays (rowid,lang,libelle,code) values (2,  'fr_FR', 'Belgique',        'BE');
insert into llx_c_pays (rowid,lang,libelle,code) values (3,  'fr_FR', 'Italie',          'IT');
insert into llx_c_pays (rowid,lang,libelle,code) values (4,  'fr_FR', 'Espagne',         'ES');
insert into llx_c_pays (rowid,lang,libelle,code) values (5,  'fr_FR', 'Allemagne',       'DE');
insert into llx_c_pays (rowid,lang,libelle,code) values (6,  'fr_FR', 'Suisse',          'CH');
insert into llx_c_pays (rowid,lang,libelle,code) values (7,  'fr_FR', 'Royaume uni',     'GB');
insert into llx_c_pays (rowid,lang,libelle,code) values (8,  'fr_FR', 'Irlande',         'IE');
insert into llx_c_pays (rowid,lang,libelle,code) values (9,  'fr_FR', 'Chine',           'CN');
insert into llx_c_pays (rowid,lang,libelle,code) values (10, 'fr_FR', 'Tunisie',         'TN');
insert into llx_c_pays (rowid,lang,libelle,code) values (11, 'fr_FR', 'Etats Unis',      'US');
insert into llx_c_pays (rowid,lang,libelle,code) values (12, 'fr_FR', 'Maroc',           'MA');
insert into llx_c_pays (rowid,lang,libelle,code) values (13, 'fr_FR', 'Algérie',         'DZ');
insert into llx_c_pays (rowid,lang,libelle,code) values (14, 'fr_FR', 'Canada',          'CA');
insert into llx_c_pays (rowid,lang,libelle,code) values (15, 'fr_FR', 'Togo',            'TG');
insert into llx_c_pays (rowid,lang,libelle,code) values (16, 'fr_FR', 'Gabon',           'GA');
insert into llx_c_pays (rowid,lang,libelle,code) values (17, 'fr_FR', 'Pays Bas',        'NL');
insert into llx_c_pays (rowid,lang,libelle,code) values (18, 'fr_FR', 'Hongrie',         'HU');
insert into llx_c_pays (rowid,lang,libelle,code) values (19, 'fr_FR', 'Russie',          'RU');
insert into llx_c_pays (rowid,lang,libelle,code) values (20, 'fr_FR', 'Suède',           'SE');
insert into llx_c_pays (rowid,lang,libelle,code) values (21, 'fr_FR', 'Côte d\'Ivoire',  'CI');
insert into llx_c_pays (rowid,lang,libelle,code) values (23, 'fr_FR', 'Sénégal',         'SN');
insert into llx_c_pays (rowid,lang,libelle,code) values (24, 'fr_FR', 'Argentine',       'AR');
insert into llx_c_pays (rowid,lang,libelle,code) values (25, 'fr_FR', 'Cameroun',        'CM');
