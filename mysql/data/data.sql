...
insert into llx_c_pays (rowid,libelle,code) values (3, 'Belgie',          'BE');
insert into llx_c_pays (rowid,libelle,code) values (4, 'Italie',          'IT');
insert into llx_c_pays (rowid,libelle,code) values (5, 'Espagne',         'ES');
insert into llx_c_pays (rowid,libelle,code) values (6, 'Allemagne',       'DE');
insert into llx_c_pays (rowid,libelle,code) values (7, 'Suisse',          'CH');
insert into llx_c_pays (rowid,libelle,code) values (8, 'Royaume uni',     'GB');
insert into llx_c_pays (rowid,libelle,code) values (9, 'Irlande',         'IE');
insert into llx_c_pays (rowid,libelle,code) values (10, 'Chine',          'CN');
insert into llx_c_pays (rowid,libelle,code) values (11, 'Tunisie',        'TN');
insert into llx_c_pays (rowid,libelle,code) values (12, 'Etats Unis',     'US');
insert into llx_c_pays (rowid,libelle,code) values (13, 'Maroc',          'MA');
insert into llx_c_pays (rowid,libelle,code) values (14, 'Algérie',        'DZ');
insert into llx_c_pays (rowid,libelle,code) values (15, 'Canada',         'CA');
insert into llx_c_pays (rowid,libelle,code) values (16, 'Togo',           'TG');
insert into llx_c_pays (rowid,libelle,code) values (17, 'Gabon',          'GA');
insert into llx_c_pays (rowid,libelle,code) values (18, 'Pays Bas',       'NL');
insert into llx_c_pays (rowid,libelle,code) values (19, 'Hongrie',        'HU');
insert into llx_c_pays (rowid,libelle,code) values (20, 'Russie',         'RU');
insert into llx_c_pays (rowid,libelle,code) values (21, 'Suède',          'SE');
insert into llx_c_pays (rowid,libelle,code) values (22, 'Côte d\'Ivoire', 'CI');
