...
insert into llx_c_pays (rowid,code,libelle) values (34, 'AS', 'Samoa américaines');
...
insert into llx_c_pays (rowid,code,libelle) values (40, 'AM', 'Arménie'        );
...
insert into llx_c_pays (rowid,code,libelle) values (43, 'AZ', 'Azerbaïdjan'    );
insert into llx_c_pays (rowid,code,libelle) values (44, 'BS', 'Bahamas'        );
insert into llx_c_pays (rowid,code,libelle) values (45, 'BH', 'Bahreïn'        );
...
insert into llx_c_pays (rowid,code,libelle) values (48, 'BY', 'Biélorussie'    );
insert into llx_c_pays (rowid,code,libelle) values (49, 'BZ', 'Belize'         );
insert into llx_c_pays (rowid,code,libelle) values (50, 'BJ', 'Bénin'          );
...
insert into llx_c_pays (rowid,code,libelle) values (54, 'BA', 'Bosnie-Herzégovine');
...
insert into llx_c_pays (rowid,code,libelle) values (57, 'BR', 'Brésil'         );
insert into llx_c_pays (rowid,code,libelle) values (58, 'IO', 'Territoire britannique de l\'Océan Indien');
...
insert into llx_c_pays (rowid,code,libelle) values (66, 'CF', 'République centrafricaine');
...
insert into llx_c_pays (rowid,code,libelle) values (74, 'CD', 'République démocratique du Congo');
...
insert into llx_c_pays (rowid,code,libelle) values (80, 'CZ', 'République Tchèque');
...
insert into llx_c_pays (rowid,code,libelle) values (84, 'DO', 'République Dominicaine');
...
insert into llx_c_pays (rowid,code,libelle) values (88, 'GQ', 'Guinée Equatoriale');
insert into llx_c_pays (rowid,code,libelle) values (89, 'ER', 'Erythrée'       );
...
insert into llx_c_pays (rowid,code,libelle) values (93, 'FO', 'Iles Féroé'     );
...
insert into llx_c_pays (rowid,code,libelle) values (96, 'GF', 'Guyane française');
insert into llx_c_pays (rowid,code,libelle) values (97, 'PF', 'Polynésie française');
insert into llx_c_pays (rowid,code,libelle) values (98, 'TF', 'Terres australes françaises');
insert into llx_c_pays (rowid,code,libelle) values (99, 'GM', 'Gambie'         );
insert into llx_c_pays (rowid,code,libelle) values (100, 'GE', 'Géorgie'       );
...
insert into llx_c_pays (rowid,code,libelle) values (103, 'GR', 'Grèce'         );
...
insert into llx_c_pays (rowid,code,libelle) values (109, 'GN', 'Guinée'        );
insert into llx_c_pays (rowid,code,libelle) values (110, 'GW', 'Guinée-Bissao' );
insert into llx_c_pays (rowid,code,libelle) values (111, 'GQ', 'Guinée équatoriale');
insert into llx_c_pays (rowid,code,libelle) values (112, 'GY', 'Guyana'        );
insert into llx_c_pays (rowid,code,libelle) values (113, 'GF', 'Guyane française');
insert into llx_c_pays (rowid,code,libelle) values (114, 'HT', 'Haïti'         );
insert into llx_c_pays (rowid,code,libelle) values (115, 'HM', 'Iles Heard et McDonald');
insert into llx_c_pays (rowid,code,libelle) values (116, 'VA', 'Saint-Siège (Vatican)');
...
insert into llx_c_pays (rowid,code,libelle) values (121, 'ID', 'Indonésie'     );
insert into llx_c_pays (rowid,code,libelle) values (122, 'IR', 'Iran'          );
insert into llx_c_pays (rowid,code,libelle) values (123, 'IQ', 'Iraq'          );
insert into llx_c_pays (rowid,code,libelle) values (124, 'IL', 'Israël'        );
insert into llx_c_pays (rowid,code,libelle) values (125, 'JM', 'Jamaïque'      );
