...
insert into llx_const (name, value, type, note, visible) values ('ADHERENT_MAIL_NEW_SUBJECT','Bienvenue','chaine','Sujet du mail de nouvelle adhesion',0);
insert into llx_const (name, value, type, note, visible) values ('ADHERENT_MAIL_EDIT_SUBJECT','Votre fiche a ete editee','chaine','Sujet du mail d\'edition',0);
...
insert into llx_c_pays (rowid,code,libelle) values (176, 'PW', 'Belau'         );
...
insert into llx_c_pays (rowid,code,libelle) values (198, 'CS', 'Serbie-Monténégro');
...
INSERT INTO `llx_menu` (`rowid`, `mainmenu`, `leftmenu`, `fk_menu`, `url`, `titre`, `level`, `langs`, `right`, `target`, `user`, `order`) VALUES (107, 'home', '$leftmenu=="setup"', 100, '/admin/perms.php', 'DefaultRights', 1, 'admin', '', '', 2, 7);
...
insert into `llx_menu` (`rowid`, `mainmenu`, `leftmenu`, `fk_menu`, `url`, `titre`, `level`, `langs`, `right`, `target`, `user`, `order`) values (110, 'home', '$leftmenu=="setup"', 100, '/admin/menus.php', 'Menus', 1, 'admin', '', '', 2, 4);
insert into `llx_menu` (`rowid`, `mainmenu`, `leftmenu`, `fk_menu`, `url`, `titre`, `level`, `langs`, `right`, `target`, `user`, `order`) values (111, 'home', '$leftmenu=="setup"', 100, '/admin/menus/index.php', 'MenuConf', 1, 'admin', '$user->rights->menudb->creer', '', 2, 4);
...
INSERT INTO `llx_menu` (`rowid`, `mainmenu`, `leftmenu`, `fk_menu`, `url`, `titre`, `level`, `langs`, `right`, `target`, `user`, `order`) VALUES (1711, 'accountancy', 'eregi("customers_bills",$leftmenu)', 1704, '/compta/paiement/cheque/index.php?leftmenu=customers_bills_checks', 'CheckReceipt', 2, 'bills', '$user->rights->facture->lire', '', 2, 7);
INSERT INTO `llx_menu` (`rowid`, `mainmenu`, `leftmenu`, `fk_menu`, `url`, `titre`, `level`, `langs`, `right`, `target`, `user`, `order`) VALUES (1712, 'accountancy', 'eregi("customers_bills_checks",$leftmenu)', 1711, '/compta/paiement/cheque/fiche.php?leftmenu=customers_bills_checks&action=new', 'NewCheckDeposit', 3, 'bills', '$user->rights->facture->lire', '', 2, 0);
INSERT INTO `llx_menu` (`rowid`, `mainmenu`, `leftmenu`, `fk_menu`, `url`, `titre`, `level`, `langs`, `right`, `target`, `user`, `order`) VALUES (1713, 'accountancy', 'eregi("customers_bills_checks",$leftmenu)', 1711, '/compta/paiement/cheque/fiche.php?leftmenu=customers_bills_checks', 'List', 3, 'bills', '$user->rights->facture->lire', '', 2, 1);
