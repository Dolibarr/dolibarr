...
insert into `llx_menu` (`rowid`, `mainmenu`, `leftmenu`, `fk_menu`, `url`, `titre`, `level`, `langs`, `right`, `target`, `user`, `order`) values (110, 'home', '$leftmenu=="setup"', 100, '/admin/menus/index.php', 'MenuConf', 1, 'admin', '$user->rights->menudb->creer', '', 2, 4);
