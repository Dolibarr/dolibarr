...
INSERT INTO `llx_menu` (`rowid`, `mainmenu`, `leftmenu`, `fk_menu`, `url`, `titre`, `level`, `langs`, `right`, `target`, `user`, `order`) VALUES (110, 'home', '$leftmenu=="setup"', 100, '/admin/menus/index.php', 'Menus', 1, 'admin', '$user->rights->menudb->creer', '', 2, 4);
