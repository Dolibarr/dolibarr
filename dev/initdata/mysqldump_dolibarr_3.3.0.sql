...
--
-- Table structure for table `llx_abonne`
--

DROP TABLE IF EXISTS `llx_abonne`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `llx_abonne` (
  ...
  `fk_abonne_type` int(11) NOT NULL,
  ...
  `fk_method_list` int(11) DEFAULT NULL,
  `fk_dnd_list` int(11) DEFAULT NULL,
  `fk_contact_list` int(11) DEFAULT NULL,
  PRIMARY KEY (`rowid`),
  UNIQUE KEY `uk_abonne_login` (`login`,`entity`),
  UNIQUE KEY `uk_abonne_fk_soc` (`fk_soc`),
  KEY `idx_abonne_fk_abonne_type` (`fk_abonne_type`),
  KEY `idx_abonne_fk_method_list` (`fk_method_list`),
  KEY `idx_abonne_fk_dnd_list` (`fk_dnd_list`),
  KEY `idx_abonne_fk_contact_list` (`fk_contact_list`),
  CONSTRAINT `abonne_fk_soc` FOREIGN KEY (`fk_soc`) REFERENCES `llx_societe` (`rowid`),
  CONSTRAINT `fk_abonne_abonne_type` FOREIGN KEY (`fk_abonne_type`) REFERENCES `llx_abonne_type` (`rowid`),
  CONSTRAINT `fk_abonne_fk_contact_list` FOREIGN KEY (`fk_contact_list`) REFERENCES `llx_publi_c_contact_list` (`rowid`),
  CONSTRAINT `fk_abonne_fk_dnd_list` FOREIGN KEY (`fk_dnd_list`) REFERENCES `llx_publi_c_dnd_list` (`rowid`),
  CONSTRAINT `fk_abonne_fk_method_list` FOREIGN KEY (`fk_method_list`) REFERENCES `llx_publi_c_method_list` (`rowid`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `llx_abonne`
--

LOCK TABLES `llx_abonne` WRITE;
/*!40000 ALTER TABLE `llx_abonne` DISABLE KEYS */;
INSERT INTO `llx_abonne` VALUES (1,1,NULL,NULL,'hhh','hhhh',NULL,NULL,1,'phy',NULL,'',NULL,NULL,NULL,NULL,NULL,1,'','','',NULL,NULL,NULL,NULL,NULL,NULL,-1,0,NULL,NULL,NULL,'2012-10-17 17:03:05','2012-10-17 15:03:05',1,1,NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `llx_abonne` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `llx_abonne_extrafields`
--

DROP TABLE IF EXISTS `llx_abonne_extrafields`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `llx_abonne_extrafields` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) DEFAULT NULL,
  PRIMARY KEY (`rowid`),
  KEY `idx_abonne_extrafields` (`fk_object`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `llx_abonne_extrafields`
--

LOCK TABLES `llx_abonne_extrafields` WRITE;
/*!40000 ALTER TABLE `llx_abonne_extrafields` DISABLE KEYS */;
/*!40000 ALTER TABLE `llx_abonne_extrafields` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `llx_abonne_type`
--

DROP TABLE IF EXISTS `llx_abonne_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `llx_abonne_type` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `entity` int(11) NOT NULL DEFAULT '1',
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `statut` smallint(6) NOT NULL DEFAULT '0',
  `libelle` varchar(50) NOT NULL,
  `abonnement` varchar(3) NOT NULL DEFAULT 'yes',
  `vote` varchar(3) NOT NULL DEFAULT 'yes',
  `note` text,
  `mail_valid` text,
  PRIMARY KEY (`rowid`),
  UNIQUE KEY `uk_abonne_type_libelle` (`libelle`,`entity`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `llx_abonne_type`
--

LOCK TABLES `llx_abonne_type` WRITE;
/*!40000 ALTER TABLE `llx_abonne_type` DISABLE KEYS */;
INSERT INTO `llx_abonne_type` VALUES (1,1,'2012-10-17 15:02:58',1,'tttt','1','0','','');
/*!40000 ALTER TABLE `llx_abonne_type` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `llx_abonnement`
--

DROP TABLE IF EXISTS `llx_abonnement`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `llx_abonnement` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `datec` datetime DEFAULT NULL,
  `fk_abonne` int(11) DEFAULT NULL,
  `dateadh` datetime DEFAULT NULL,
  `datef` date DEFAULT NULL,
  `abonnement` double DEFAULT NULL,
  `publication` varchar(255) DEFAULT NULL,
  `total_review` int(11) DEFAULT NULL,
  `last_review` int(11) DEFAULT NULL,
  `fk_bank` int(11) DEFAULT NULL,
  `note` text,
  PRIMARY KEY (`rowid`),
  UNIQUE KEY `uk_abonnement` (`fk_abonne`,`dateadh`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `llx_abonnement`
--

LOCK TABLES `llx_abonnement` WRITE;
/*!40000 ALTER TABLE `llx_abonnement` DISABLE KEYS */;
/*!40000 ALTER TABLE `llx_abonnement` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `llx_accountingsystem` VALUES (1,'PCG99-ABREGE',1,'The simple accountancy french plan',1),(2,'PCG99-BASE',1,'The base accountancy french plan',1);
...
INSERT INTO `llx_boxes` VALUES (12,1,20,0,'A03',0,NULL),(73,1,21,0,'A01',0,NULL),(80,1,21,0,'A01',1,NULL),(81,1,20,0,'B01',1,NULL),(100,1,193,0,'A01',1,NULL),(101,1,193,0,'A01',0,NULL),(102,1,87,0,'A01',1,NULL),(103,1,87,0,'A01',0,NULL),(104,1,199,0,'A01',1,NULL),(105,1,199,0,'A01',0,NULL),(106,1,192,0,'A01',1,NULL),(107,1,192,0,'A01',0,NULL);
...
INSERT INTO `llx_c_actioncomm` VALUES (1,'AC_TEL','system','Phone call',NULL,1,NULL,2),(2,'AC_FAX','system','Send Fax',NULL,1,NULL,3),(3,'AC_PROP','systemauto','Send commercial proposal by email','propal',1,NULL,10),(4,'AC_EMAIL','system','Send Email',NULL,1,NULL,4),(5,'AC_RDV','system','Rendez-vous',NULL,1,NULL,1),(8,'AC_COM','systemauto','Send customer order by email','order',1,NULL,8),(9,'AC_FAC','systemauto','Send customer invoice by email','invoice',1,NULL,6),(10,'AC_SHIP','systemauto','Send shipping by email','shipping',1,NULL,11),(30,'AC_SUP_ORD','systemauto','Send supplier order by email','order_supplier',1,NULL,9),(31,'AC_SUP_INV','systemauto','Send supplier invoice by email','invoice_supplier',1,NULL,7),(50,'AC_OTH','system','Other',NULL,1,NULL,5);
...
--
-- Table structure for table `llx_c_dolicloud_plans`
--

DROP TABLE IF EXISTS `llx_c_dolicloud_plans`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `llx_c_dolicloud_plans` (
  ...
  `price_instance` int(11) DEFAULT NULL,
  `price_user` int(11) DEFAULT NULL,
  `price_gb` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `llx_c_dolicloud_plans`
--

LOCK TABLES `llx_c_dolicloud_plans` WRITE;
/*!40000 ALTER TABLE `llx_c_dolicloud_plans` DISABLE KEYS */;
/*!40000 ALTER TABLE `llx_c_dolicloud_plans` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `llx_document_model` VALUES (9,'merou',1,'shipping',NULL,NULL),(15,'html_cefafr.php',1,'donation',NULL,NULL),(21,'baleine',1,'project',NULL,NULL),(27,'typhon',1,'delivery',NULL,NULL),(101,'azur',1,'propal',NULL,NULL),(102,'rouget',1,'shipping',NULL,NULL),(103,'elevement',1,'delivery',NULL,NULL),(105,'soleil',1,'ficheinter',NULL,NULL),(140,'einstein',1,'order',NULL,NULL),(141,'crabe',1,'invoice',NULL,NULL),(142,'muscadet',1,'order_supplier',NULL,NULL),(143,'html_cerfafr',1,'donation',NULL,NULL);
/*!40000 ALTER TABLE `llx_document_model` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `llx_dolicloud_customers`
--

DROP TABLE IF EXISTS `llx_dolicloud_customers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `llx_dolicloud_customers` (
  ...
  `date_endfreeperiod` datetime DEFAULT NULL,
  `status` varchar(16) DEFAULT NULL,
  `partner` varchar(128) DEFAULT NULL,
  `total_invoiced` double(6,3) DEFAULT NULL,
  `total_payed` double(6,3) DEFAULT NULL,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `hostname_web` varchar(128) DEFAULT NULL,
  `username_web` varchar(128) DEFAULT NULL,
  `password_web` varchar(128) DEFAULT NULL,
  `hostname_db` varchar(128) DEFAULT NULL,
  `database_db` varchar(128) DEFAULT NULL,
  `port_db` int(11) DEFAULT NULL,
  `username_db` varchar(128) DEFAULT NULL,
  `password_db` varchar(128) DEFAULT NULL,
  `lastcheck` datetime DEFAULT NULL,
  `nbofusers` int(11) DEFAULT NULL,
  `lastlogin` varchar(128) DEFAULT NULL,
  `lastpass` varchar(128) DEFAULT NULL,
  `date_lastlogin` datetime DEFAULT NULL,
  `modulesenabled` varchar(10000) DEFAULT NULL,
  PRIMARY KEY (`rowid`),
  UNIQUE KEY `uk_dolicloud_customers` (`instance`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `llx_dolicloud_customers`
--

LOCK TABLES `llx_dolicloud_customers` WRITE;
/*!40000 ALTER TABLE `llx_dolicloud_customers` DISABLE KEYS */;
INSERT INTO `llx_dolicloud_customers` VALUES (1,'aaa','aaa','aaa@aaa.com','Basic',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'1970-02-01 01:00:00','ACTIVE',NULL,NULL,NULL,'2012-09-23 19:21:26','aaa.on.dolicloud.com','','','aaa.on.dolicloud.com','',NULL,'','','2012-08-06 02:50:58',NULL,NULL,NULL,NULL,''),(4,'bbb','bbb','testldr1@dolicloud.com','Basic','','','','','',1,0,'',NULL,NULL,'ACTIVE',NULL,NULL,NULL,'2012-09-23 19:21:26','bbb.on.dolicloud.com','','','bbb.on.dolicloud.com','',NULL,'','','2012-07-29 18:37:14',NULL,NULL,NULL,NULL,''),(5,'cbbbc','bbbc','testldr1@dolicloud.com','Basic','b','tt','a','c','d',1,0,'',NULL,NULL,'ACTIVE',NULL,NULL,NULL,'2012-09-23 19:21:26','cbbbc.on.dolicloud.com','','','cbbbc.on.dolicloud.com','',NULL,'','',NULL,NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `llx_dolicloud_customers` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=66420 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `llx_publi_c_contact_list`
--

DROP TABLE IF EXISTS `llx_publi_c_contact_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `llx_publi_c_contact_list` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `entity` int(11) NOT NULL DEFAULT '1',
  `code` varchar(64) NOT NULL,
  `label` varchar(128) NOT NULL,
...
--
-- Dumping data for table `llx_publi_c_contact_list`
--

LOCK TABLES `llx_publi_c_contact_list` WRITE;
/*!40000 ALTER TABLE `llx_publi_c_contact_list` DISABLE KEYS */;
INSERT INTO `llx_publi_c_contact_list` VALUES (1,1,'CT_01','Responsable P?dagogique','Responsable P?dagogique',1),(2,1,'CT_02','Ancien abonn','Ancien abonn',1);
/*!40000 ALTER TABLE `llx_publi_c_contact_list` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `llx_publi_c_dnd_list`
--

DROP TABLE IF EXISTS `llx_publi_c_dnd_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `llx_publi_c_dnd_list` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `entity` int(11) NOT NULL DEFAULT '1',
  `code` varchar(64) NOT NULL,
  `label` varchar(128) NOT NULL,
...
--
-- Dumping data for table `llx_publi_c_dnd_list`
--

LOCK TABLES `llx_publi_c_dnd_list` WRITE;
/*!40000 ALTER TABLE `llx_publi_c_dnd_list` DISABLE KEYS */;
INSERT INTO `llx_publi_c_dnd_list` VALUES (1,1,'DND_01','01','01',1),(2,1,'DND_02','02','02',1),(3,1,'DND_03','03','03',1),(4,1,'DND_04','04','04',1),(5,1,'DND_05','05','05',1);
/*!40000 ALTER TABLE `llx_publi_c_dnd_list` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `llx_publi_c_method_list`
--

DROP TABLE IF EXISTS `llx_publi_c_method_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `llx_publi_c_method_list` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `entity` int(11) NOT NULL DEFAULT '1',
  `code` varchar(64) NOT NULL,
  `label` varchar(128) NOT NULL,
...
--
-- Dumping data for table `llx_publi_c_method_list`
--

LOCK TABLES `llx_publi_c_method_list` WRITE;
/*!40000 ALTER TABLE `llx_publi_c_method_list` DISABLE KEYS */;
INSERT INTO `llx_publi_c_method_list` VALUES (1,1,'MTH_01','01','Fax',1),(2,1,'MTH_02','02','Email',1);
/*!40000 ALTER TABLE `llx_publi_c_method_list` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2012-11-11 14:34:06
