...
class ProjectTest extends CommonClassTest
{
	...
	private function createProjectForOpportunityStats($db, $user, $usageopportunity, $oppstatus)
	{
		...
		// ProjectStats::buildWhere() restricts on getProjectsAuthorizedForUser() as soon as the user
		// lacks projet->all->lire: a public project with no thirdparty is in scope for any user.
		$project->public = 1;
		$project->socid = 0;
