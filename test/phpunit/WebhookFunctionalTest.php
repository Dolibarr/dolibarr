...
/**
 * \file    test/phpunit/WebhookFunctionalTest.php
 * \ingroup webhook
 ...
 * @package Testwebhook
 */
class WebhookFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/webhook/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('webhook/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/webhook/admin/about.php');
		$this->authenticate();
		return $this->assertContains('webhook/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modWebhook_WebhookTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modWebhook_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
