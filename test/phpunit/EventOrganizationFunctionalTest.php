...
/**
 * \file    test/phpunit/EventOrganizationFunctionalTest.php
...
/**
 * Class EventOrganizationFunctionalTest
 *
 ...
 *
 * @package Testeventorganization
 */
class EventOrganizationFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	/**
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modEventOrganization')->click();
		} else {
			// Disable the module
			$this->byHref('modEventOrganization')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/eventorganization/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('eventorganization/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/eventorganization/admin/about.php');
		$this->authenticate();
		return $this->assertContains('eventorganization/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('eventorganizationwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modEventOrganization_EventOrganizationTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modEventOrganization_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
