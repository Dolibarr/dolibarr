...
class StockTransferTest extends CommonClassTest
{
	...
	public function testStockTransferFetch($id)
	{
		...
		$this->assertSame(1, preg_match('/^\(?PROV/i', (string) $localobject->ref), 'A not yet validated stock transfer must have a provisional ref');	// Not assertMatchesRegularExpression(), only available since PHPUnit 9.1
