...
CREATE INDEX idx_societe_remise_except_fk_user ON llx_societe_remise_except(fk_user);
CREATE INDEX idx_societe_remise_except_fk_soc ON llx_societe_remise_except(fk_soc);
CREATE INDEX idx_societe_remise_except_fk_facture ON llx_societe_remise_except(fk_facture);
CREATE INDEX idx_societe_remise_except_fk_facture_source ON llx_societe_remise_except(fk_facture_source);
