...
CREATE INDEX idx_paiement_facture_fk_facture ON llx_paiement_facture(fk_facture);
...
CREATE INDEX idx_paiement_facture_fk_paiement ON llx_paiement_facture(fk_paiement);
