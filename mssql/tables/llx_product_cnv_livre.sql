...
(
  ...
  px_feuillet        float(12),       -- prix au feuillet
  px_reliure         float(12),       -- prix de la reliure
  px_couverture      float(12),       -- prix de la couverture
  px_revient         float(12),       -- prix de revient
