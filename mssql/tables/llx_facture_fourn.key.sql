...
CREATE INDEX uk_facture_fourn_ref ON llx_facture_fourn(facnumber, fk_soc);

CREATE INDEX idx_facture_fourn_date_lim_reglement ON llx_facture_fourn(date_lim_reglement);

CREATE INDEX idx_facture_fourn_fk_soc ON llx_facture_fourn(fk_soc);
CREATE INDEX idx_facture_fourn_fk_user_author ON llx_facture_fourn(fk_user_author);
