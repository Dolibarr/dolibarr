...
CREATE INDEX idx_facture_fk_soc ON llx_facture(fk_soc);
CREATE INDEX idx_facture_fk_user_author ON llx_facture(fk_user_author);
CREATE INDEX idx_facture_fk_user_valid ON llx_facture(fk_user_valid);
...
CREATE UNIQUE INDEX idx_facture_uk_facnumber ON llx_facture(facnumber);
