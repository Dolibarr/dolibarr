...
SET IDENTITY_INSERT dbo.llx_c_methode_commande_fournisseur ON
...
SET IDENTITY_INSERT dbo.llx_c_methode_commande_fournisseur OFF
...
insert into llx_accountingsystem (pcg_version, fk_pays, label, datec, fk_author, active) VALUES ('PCG99-ABREGE', 1, 'Plan de compte standard français abrégé', getdate(), null, 0);

SET IDENTITY_INSERT dbo.llx_accountingaccount ON
...
SET IDENTITY_INSERT dbo.llx_accountingaccount OFF
...
SET IDENTITY_INSERT dbo.llx_c_chargesociales ON
...
SET IDENTITY_INSERT dbo.llx_c_chargesociales OFF
...
SET IDENTITY_INSERT dbo.llx_c_regions ON
...
SET IDENTITY_INSERT dbo.llx_c_regions OFF

--
-- Departements/Cantons/Provinces
--

SET IDENTITY_INSERT dbo.llx_c_departements ON

insert into llx_c_departements (rowid, fk_region, code_departement,cheflieu,tncc,ncc,nom) values (0,0,'0','0',0,'-','-');

SET IDENTITY_INSERT dbo.llx_c_departements OFF
...
SET IDENTITY_INSERT dbo.llx_c_tva ON
...
SET IDENTITY_INSERT dbo.llx_c_tva OFF
...
-- 
SET IDENTITY_INSERT dbo.llx_menu_const ON
...
SET IDENTITY_INSERT dbo.llx_menu_const OFF

--
-- Eco-Taxes
--

SET IDENTITY_INSERT dbo.llx_c_ecotaxe ON
...
SET IDENTITY_INSERT dbo.llx_c_ecotaxe OFF
